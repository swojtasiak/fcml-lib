...
#define _IRA_OPERAND_MODRM_RM_MMX_32	_IRA_OPERAND_RM(IRA_REG_SIMD, _IRA_EOS_MMWORD, _IRA_EOS_DWORD, _IRA_RMF_RM )
...
#define _IRA_OPERAND_MODRM_RM_YMM_256	_IRA_OPERAND_RM(IRA_REG_SIMD, _IRA_EOS_YMMWORD, _IRA_EOS_YMMWORD, _IRA_RMF_RM )
...
#define _IRA_OPERAND_MODRM_RM_XMM_16	_IRA_OPERAND_RM(IRA_REG_SIMD, _IRA_EOS_XMMWORD, _IRA_EOS_WORD, _IRA_RMF_RM )
