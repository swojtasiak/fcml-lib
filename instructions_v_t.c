...
int fcml_tf_instructions_v_suite_init(void) {
	return 0;
}

int fcml_tf_instructions_v_suite_cleanup(void) {
	return 0;
}
...
void fcml_tf_instruction_VBROADCASTSS(void) {
    ...
    FCML_I32( "vbroadcastsd ymm2,qword ptr [ecx+eax]", 0xC4, 0xE2, 0x7D, 0x19, 0x14, 0x01 );
...
void fcml_tf_instruction_VPBROADCASTB(void) {
    ...
    FCML_I64( "vpbroadcastb ymm0,ymm1", 0xC4, 0xE2, 0x7D, 0x78, 0xC1 );
    ...
    FCML_I64( "vpbroadcastw ymm0,ymm1", 0xC4, 0xE2, 0x7D, 0x79, 0xC1 );
    ...
    FCML_I64( "vpbroadcastd ymm0,ymm1", 0xC4, 0xE2, 0x7D, 0x58, 0xC1 );
    ...
    FCML_I64( "vpbroadcastq ymm0,ymm1", 0xC4, 0xE2, 0x7D, 0x59, 0xC1 );
}
...
void fcml_tf_instruction_VPMASKMOVD_VPMASKMOVQ(void) {
    ...
    FCML_I32( "vpmaskmovq ymm3,ymm2,ymmword ptr [eax]", 0xC4, 0xE2, 0xED, 0x8C, 0x18 );
    ...
    FCML_I32( "vpmaskmovq ymmword ptr [eax],ymm2,ymm3", 0xC4, 0xE2, 0xED, 0x8E, 0x18 );
}
...
void fcml_tf_instruction_VPSLLVD(void) {
    ...
    FCML_I32( "vpsllvq xmm0,xmm6,xmmword ptr [eax]", 0xC4, 0xE2, 0xC9, 0x47, 0x00 );
    FCML_I32( "vpsllvq ymm0,ymm6,ymmword ptr [eax]", 0xC4, 0xE2, 0xCD, 0x47, 0x00 );
    FCML_I32( "vpsllvq ymm0,ymm6,ymm0", 0xC4, 0xE2, 0xCD, 0x47, 0xC0 );
}
...
void fcml_tf_instruction_VPSRLVD(void) {
    ...
    FCML_I32( "vpsrlvq xmm0,xmm6,xmmword ptr [eax]", 0xC4, 0xE2, 0xC9, 0x45, 0x00 );
    FCML_I32( "vpsrlvq ymm0,ymm6,ymmword ptr [eax]", 0xC4, 0xE2, 0xCD, 0x45, 0x00 );
    FCML_I32( "vpsrlvq ymm0,ymm6,ymm0", 0xC4, 0xE2, 0xCD, 0x45, 0xC0 );
}
...
void fcml_tf_instruction_VPERMPD(void) {
    ...
    FCML_I32( "vpermpd ymm0,ymmword ptr [eax],0ffh", 0xC4, 0xE3, 0xFD, 0x01, 0x00, 0xFF );
    FCML_I32( "vpermpd ymm0,ymm0,0ffh", 0xC4, 0xE3, 0xFD, 0x01, 0xC0, 0xFF );
}

void fcml_tf_instruction_VPERMQ(void) {
    // VEX.256.66.0F3A.W1 00 /r ib VPERMQ ymm1,ymm2/m256,imm8
    FCML_I32( "vpermq ymm0,ymmword ptr [eax],0ffh", 0xC4, 0xE3, 0xFD, 0x00, 0x00, 0xFF );
    FCML_I32( "vpermq ymm0,ymm0,0ffh", 0xC4, 0xE3, 0xFD, 0x00, 0xC0, 0xFF );
}
...
void fcml_tf_instruction_VINSERTI128(void) {
    ...
    FCML_I32( "vinserti128 ymm0,ymm6,ymmword ptr [eax],0ffh", 0xC4, 0xE3, 0x4D, 0x38, 0x00, 0xFF );
    FCML_I32( "vinserti128 ymm0,ymm6,ymm0,0ffh", 0xC4, 0xE3, 0x4D, 0x38, 0xC0, 0xFF );
    FCML_I64( "vinserti128 ymm0,ymm6,ymmword ptr [rax],0ffh", 0xC4, 0xE3, 0x4D, 0x38, 0x00, 0xFF );
}
...
void fcml_tf_instruction_VGATHERDPD(void) {
    ...
    FCML_I32( "vgatherdpd xmm0,dword ptr [eax+xmm5],xmm0", 0xC4, 0xE2, 0xF9, 0x92, 0x04, 0x28 );
    // Check if VSIB index register size is appropriately checked.
    FCML_I32_D_FAILED( "vgatherdpd xmm0,dword ptr [eax+ymm5],xmm0", 0xC4, 0xE2, 0xF9, 0x92, 0x04, 0x28 );
    FCML_I32_A_FAILED( "vgatherdpd xmm0,dword ptr [eax+ymm5],xmm0", 0xC4, 0xE2, 0xF9, 0x92, 0x04, 0x28 );
    FCML_I32( "vgatherdpd ymm0,dword ptr [eax+xmm5],ymm0", 0xC4, 0xE2, 0xFD, 0x92, 0x04, 0x28 );
    // VEX.DDS.128.66.0F38.W1 93 /r VGATHERQPD xmm1, vm64x, xmm2
    // VEX.DDS.256.66.0F38.W1 93 /r VGATHERQPD ymm1, vm64y, ymm2
    FCML_I32( "vgatherqpd xmm0,qword ptr [eax+xmm5],xmm0", 0xC4, 0xE2, 0xF9, 0x93, 0x04, 0x28 );
    FCML_I32( "vgatherqpd ymm0,qword ptr [eax+ymm5],ymm0", 0xC4, 0xE2, 0xFD, 0x93, 0x04, 0x28 );
}
...
void fcml_tf_instruction_VGATHERDPS(void) {
    ...
    FCML_I32( "vgatherqps ymm0,qword ptr [eax+ymm5],ymm0", 0xC4, 0xE2, 0x7D, 0x93, 0x04, 0x28 );
}
...
void fcml_tf_instruction_VPGATHERDD(void) {
    ...
    FCML_I32( "vpgatherqd ymm0,qword ptr [eax+ymm5],ymm0", 0xC4, 0xE2, 0x7D, 0x91, 0x04, 0x28 );
}
...
void fcml_tf_instruction_VPGATHERDQ(void) {
    ...
    FCML_I32( "vpgatherdq xmm0,dword ptr [eax+xmm5],xmm0", 0xC4, 0xE2, 0xF9, 0x90, 0x04, 0x28 );
    FCML_I32( "vpgatherdq ymm0,dword ptr [eax+xmm5],ymm0", 0xC4, 0xE2, 0xFD, 0x90, 0x04, 0x28 );
    // VEX.DDS.128.66.0F38.W1 91 /r VPGATHERQQ xmm1,vm64x,xmm2
    // VEX.DDS.256.66.0F38.W1 91 /r VPGATHERQQ ymm1,vm64y,ymm2
    FCML_I32( "vpgatherqq xmm0,qword ptr [eax+xmm5],xmm0", 0xC4, 0xE2, 0xF9, 0x91, 0x04, 0x28 );
    FCML_I32( "vpgatherqq ymm0,qword ptr [eax+ymm5],ymm0", 0xC4, 0xE2, 0xFD, 0x91, 0x04, 0x28 );
}
...
void fcml_tf_instruction_VFMADDPD(void) {
    ...
    FCML_I64( "vfmaddpd xmm2,xmm5,xmmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x69, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFMADDSD(void) {
    ...
    FCML_I32( "vfmadd132sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0x99, 0x00 );
    ...
    FCML_I32( "vfmadd213sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xA9, 0x00 );
    ...
    FCML_I32( "vfmadd231sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xB9, 0x00 );
...
void fcml_tf_instruction_VFMADDSUBPD(void) {
    ...
    FCML_I32( "vfmaddsub132pd xmm0,xmm3,xmmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0x96, 0x00 );
    FCML_I64( "vfmaddsub132pd ymm0,ymm3,ymmword ptr [rax]", 0xC4, 0xE2, 0xE5, 0x96, 0x00 );
    FCML_I32( "vfmaddsub132pd ymm0,ymm3,ymm0", 0xC4, 0xE2, 0xE5, 0x96, 0xC0 );
    ...
    FCML_I32( "vfmaddsub213pd xmm0,xmm3,xmmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xA6, 0x00 );
    FCML_I64( "vfmaddsub213pd ymm0,ymm3,ymmword ptr [rax]", 0xC4, 0xE2, 0xE5, 0xA6, 0x00 );
    FCML_I32( "vfmaddsub213pd ymm0,ymm3,ymm0", 0xC4, 0xE2, 0xE5, 0xA6, 0xC0 );
    ...
    FCML_I32( "vfmaddsub231pd xmm0,xmm3,xmmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xB6, 0x00 );
    FCML_I64( "vfmaddsub231pd ymm0,ymm3,ymmword ptr [rax]", 0xC4, 0xE2, 0xE5, 0xB6, 0x00 );
    FCML_I32( "vfmaddsub231pd ymm0,ymm3,ymm0", 0xC4, 0xE2, 0xE5, 0xB6, 0xC0 );
    ...
    FCML_I64( "vfmaddsubpd xmm2,xmm5,xmmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x5D, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFMSUBADDPD(void) {
    ...
    FCML_I32( "vfmsubadd132pd xmm0,xmm3,xmmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0x97, 0x00 );
    FCML_I64( "vfmsubadd132pd ymm0,ymm3,ymmword ptr [rax]", 0xC4, 0xE2, 0xE5, 0x97, 0x00 );
    FCML_I32( "vfmsubadd132pd ymm0,ymm3,ymm0", 0xC4, 0xE2, 0xE5, 0x97, 0xC0 );
    ...
    FCML_I32( "vfmsubadd213pd xmm0,xmm3,xmmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xA7, 0x00 );
    FCML_I64( "vfmsubadd213pd ymm0,ymm3,ymmword ptr [rax]", 0xC4, 0xE2, 0xE5, 0xA7, 0x00 );
    FCML_I32( "vfmsubadd213pd ymm0,ymm3,ymm0", 0xC4, 0xE2, 0xE5, 0xA7, 0xC0 );
    ...
    FCML_I32( "vfmsubadd231pd xmm0,xmm3,xmmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xB7, 0x00 );
    FCML_I64( "vfmsubadd231pd ymm0,ymm3,ymmword ptr [rax]", 0xC4, 0xE2, 0xE5, 0xB7, 0x00 );
    FCML_I32( "vfmsubadd231pd ymm0,ymm3,ymm0", 0xC4, 0xE2, 0xE5, 0xB7, 0xC0 );
    ...
    FCML_I64( "vfmsubaddpd xmm2,xmm5,xmmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x5F, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFMSUBPD(void) {
    ...
    FCML_I64( "vfmsubpd xmm2,xmm5,xmmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x6D, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFMSUBSD(void) {
    ...
    FCML_I32( "vfmsub132sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0x9B, 0x00 );
    ...
    FCML_I32( "vfmsub213sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xAB, 0x00 );
    ...
    FCML_I32( "vfmsub231sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xBB, 0x00 );
    ...
    FCML_I64( "vfmsubsd xmm2,xmm5,mmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x6F, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFNMADDPD(void) {
    ...
    FCML_I64( "vfnmaddpd xmm2,xmm5,xmmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x79, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFNMADDSD(void) {
    ...
    FCML_I32( "vfnmadd132sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0x9D, 0x00 );
    ...
    FCML_I32( "vfnmadd213sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xAD, 0x00 );
    ...
    FCML_I32( "vfnmadd231sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xBD, 0x00 );
    ...
    FCML_I64( "vfnmaddsd xmm2,xmm5,mmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x7B, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFNMSUBPD(void) {
    ...
    FCML_I64( "vfnmsubpd xmm2,xmm5,xmmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x7D, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VFNMSUBSD(void) {
    ...
    FCML_I32( "vfnmsub132sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0x9F, 0x00 );
    ...
    FCML_I32( "vfnmsub213sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xAF, 0x00 );
    ...
    FCML_I32( "vfnmsub231sd xmm0,xmm3,mmword ptr [eax]", 0xC4, 0xE2, 0xE1, 0xBF, 0x00 );
    ...
    FCML_I64( "vfnmsubsd xmm2,xmm5,mmword ptr [rcx+rax],xmm2", 0xC4, 0xE3, 0x51, 0x7F, 0x14, 0x01, 0x20 );
...
void fcml_tf_instruction_VPHADDUBWD(void) {
    // VPHADDUBWD xmm1, xmm2/mem128 8F RXB.01001 0.1111.0.00 D1 /r
    FCML_I32( "vphaddubwd xmm0,xmmword ptr [eax]", 0x8F, 0xE9, 0x78, 0xD1, 0x00 );
    FCML_I32( "vphaddubwd xmm0,xmm1", 0x8F, 0xE9, 0x78, 0xD1, 0xC1 );
}
...
void fcml_tf_instruction_VPROTD(void) {
    ...
    FCML_I32( "vprotd xmm2,xmmword ptr [ecx+eax],xmm5", 0x8F, 0xE9, 0x50, 0x92, 0x14, 0x01 );
    ...
    FCML_I32( "vprotd xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x92, 0x14, 0x01 );
...
void fcml_tf_instruction_VPROTB(void) {
    ...
    FCML_I32( "vprotb xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x90, 0x14, 0x01 );
...
void fcml_tf_instruction_VPROTQ(void) {
    ...
    FCML_I32( "vprotq xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x93, 0x14, 0x01 );
...
void fcml_tf_instruction_VPROTW(void) {
    ...
    FCML_I32( "vprotw xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x91, 0x14, 0x01 );
...
void fcml_tf_instruction_VPSHAB(void) {
    ...
    FCML_I32( "vpshab xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x98, 0x14, 0x01 );
...
void fcml_tf_instruction_VPSHAD(void) {
    ...
    FCML_I32( "vpshad xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x9a, 0x14, 0x01 );
...
void fcml_tf_instruction_VPSHAQ(void) {
    ...
    FCML_I32( "vpshaq xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x9B, 0x14, 0x01 );
...
void fcml_tf_instruction_VPSHLD(void) {
    ...
    FCML_I32( "vpshld xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x96, 0x14, 0x01 );
...
void fcml_tf_instruction_VPSHLQ(void) {
    ...
    FCML_I32( "vpshlq xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x97, 0x14, 0x01 );
...
void fcml_tf_instruction_VPSHLW(void) {
    ...
    FCML_I32( "vpshlw xmm2,xmm5,xmmword ptr [ecx+eax]", 0x8F, 0xE9, 0xD0, 0x95, 0x14, 0x01 );
...
CU_TestInfo fctl_ti_instructions_v[] = {
    ...
    { "fcml_tf_instruction_VPHADDUBWD", fcml_tf_instruction_VPHADDUBWD },
...
CU_SuiteInfo fctl_si_instructions_v[] = {
