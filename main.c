...
void test(void) {
	...
	_TEST32_VEX( "c4e34941140120 vdppd xmm2,xmm6,qword ptr [ecx+eax],20h", 0xC4, 0xE3, 0x49, 0x41, 0x14, 0x01, 0x20 );
	_TEST64_VEX( "c4e34941140120 vdppd xmm2,xmm6,qword ptr [rcx+rax],20h", 0xC4, 0xE3, 0x49, 0x41, 0x14, 0x01, 0x20 );
