...
int main(int argc, char **argv) {
	...
	//FCML_I64_P( "add rbp,0ffffffffffffffffh", 0x48, 0x81, 0xc5, 0xff, 0xff, 0xff, 0xff );
	//return 0;
//	FCML_I64_P( "add rax,0000000042806521h", 0x48, 0x05, 0x21, 0x65, 0x80, 0x42 );
		//FCML_I64_P( "add rax,0ffffffffffffffffh", 0x48, 0x05, 0xff, 0xff, 0xff, 0xff );
		//return 0;
	//FCML_I32_P( "add ax,8042h", 0x66, 0x05, 0x42, 0x80 );
	//FCML_I32_P( "add eax,42806521h", 0x05, 0x21, 0x65, 0x80, 0x42 );
	//FCML_I64_P( "add eax,42806521h", 0x05, 0x21, 0x65, 0x80, 0x42 );
	//FCML_I64_P( "add ax,6521h", 0x66, 0x05, 0x21, 0x65 );
	//return 0;

	//FCML_I32_P( "add al,42h", 0x04, 0x42 );
	//return 0;

	//FCML_I32_P( "adc dword ptr [esi],00000001h", 0x83, 0x16, 0x01 );
	//FCML_I64_P( "adc word ptr [rsi],0001h", 0x66, 0x83, 0x16, 0x01 );
	//FCML_I32_P( "adc word ptr [esi],0001h", 0x66, 0x83, 0x16, 0x01 );
	...
	//FCML_I64_P( "adc qword ptr [rdi+0000000004030201h],0000000000000005h", 0x48, 0x83, 0x97, 0x01, 0x02, 0x03, 0x4, 0x05 );
	//FCML_I64_P( "adc qword ptr [rdi+0000000004030201h],0ffffffffffffffffh", 0x48, 0x83, 0x97, 0x01, 0x02, 0x03, 0x4, 0xff );
	/*
*/
	//return 0;
	...
	//return 0;
	//FCML_I32_P( "adc eax,42806521h", 0x15, 0x21, 0x65, 0x80, 0x42 );
	//return 0;
	//FCML_I32_P( "adc ax,8042h",  0x66, 0x15, 0x42, 0x80 );
	//return 0;
	//FCML_I32_P( "adc al,42h", 0x14, 0x42  );
	//return 0;
	//FCML_I32_P( "and edi,edx", 0x21, 0xD7 );
	//FCML_I32_P( "and di,dx", 0x66, 0x21, 0xD7 );
	//FCML_I32_P( "and edi,edx", 0x67, 0x21, 0xD7 );

	//FCML_I64_P( "and qword ptr [rdi+0000000004030201h],0000000000000005h", 0x48, 0x83, 0xA7, 0x01, 0x02, 0x03, 0x4, 0x05 );
	//FCML_I64_P( "and qword ptr [rdi+0000000004030201h],0ffffffffffffffffh", 0x48, 0x83, 0xA7, 0x01, 0x02, 0x03, 0x4, 0xff );
	//return 0;

	//FCML_I64_M( "and rbp,0ffffffffffffffffh", 2, FCML_MI( 0x48, 0x81, 0xe5, 0xff, 0xff, 0xff, 0xff ), FCML_MI( 0x48, 0x83, 0xe5, 0xff ) );
	//FCML_I64_P( "and rbp,0ffffffffffffffffh", 0x48, 0x81, 0xe5, 0xff, 0xff, 0xff, 0xff );
	//return 0;
	//FCML_I32_P( "vandpd xmm2,xmm2,oword ptr [ecx+eax]", 0xC4, 0xC1, 0x69, 0x54, 0x14, 0x01 );
	//return 0;
