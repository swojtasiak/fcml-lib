...
int main(int argc, char **argv) {
	...
	//FCML_A64_D_P( "adcl $0x00000003,0x00000000(%rip)", 0x83, 0x15, 0x00, 0x00, 0x00, 0x00, 0x03 );
	//FCML_I64_D_P( "adcl $0x00000003,0x00000000(%rip)", 0x83, 0x15, 0x00, 0x00, 0x00, 0x00, 0x03 );
