...
void fcml_tf_instruction_DIVPD(void) {
    FCML_I32( "divpd xmm2,oword ptr [ecx+eax]", 0x66, 0x0F, 0x5E, 0x14, 0x01 );
    FCML_I64( "divpd xmm2,oword ptr [rcx+rax]", 0x66, 0x0F, 0x5E, 0x14, 0x01 );
    ...
    FCML_I32_D( "vdivpd xmm2,xmm7,oword ptr [ecx+eax]", 0xC4, 0xC1, 0x41, 0x5E, 0x14, 0x01 );
    FCML_I32_D( "vdivpd xmm2,xmm2,oword ptr [ecx+eax]", 0xC4, 0xC1, 0x69, 0x5E, 0x14, 0x01 );
    FCML_I32( "vdivpd xmm2,xmm7,oword ptr [ecx+eax]", 0xc5, 0xc1, 0x5e, 0x14, 0x01 );
    FCML_I32( "vdivpd xmm2,xmm2,oword ptr [ecx+eax]", 0xc5, 0xe9, 0x5e, 0x14, 0x01 );
}

void fcml_tf_instruction_DIVPS(void) {
    FCML_I32( "divps xmm2,oword ptr [ecx+eax]", 0x0F, 0x5E, 0x14, 0x01 );
    FCML_I64( "divps xmm2,oword ptr [rcx+rax]", 0x0F, 0x5E, 0x14, 0x01 );
    ...
    FCML_I32_D( "vdivps xmm2,xmm7,oword ptr [ecx+eax]", 0xC4, 0xC1, 0x40, 0x5E, 0x14, 0x01 );
    FCML_I32_D( "vdivps xmm2,xmm2,oword ptr [ecx+eax]", 0xC4, 0xC1, 0x68, 0x5E, 0x14, 0x01 );
    FCML_I32( "vdivps xmm2,xmm7,oword ptr [ecx+eax]", 0xc5, 0xc0, 0x5e, 0x14, 0x01 );
    FCML_I32( "vdivps xmm2,xmm2,oword ptr [ecx+eax]", 0xc5, 0xe8, 0x5e, 0x14, 0x01 );
}

void fcml_tf_instruction_DIVSD(void) {
    FCML_I64( "divsd xmm0,qword ptr [rax+0000000000000020h]", 0xF2, 0x0F, 0x5E, 0x40, 0x20 );
    FCML_I32( "divsd xmm0,xmm2", 0xF2, 0x0F, 0x5E, 0xC2 );
    FCML_I32( "divsd xmm0,qword ptr [eax+00000020h]", 0xF2, 0x0F, 0x5E, 0x40, 0x20 );
    // VEX.NDS.128.F2.0F 5E /r VDIVSD xmm1, xmm2, xmm3/m64
    FCML_I32_D( "vdivsd xmm2,xmm6,qword ptr [ecx+eax]", 0xC4, 0xE1, 0x4B, 0x5E, 0x14, 0x01 );
    FCML_I64_D( "vdivsd xmm2,xmm6,qword ptr [rcx+rax]", 0xC4, 0xE1, 0x4B, 0x5E, 0x14, 0x01 );
    FCML_I32( "vdivsd xmm2,xmm6,qword ptr [ecx+eax]", 0xc5, 0xcb, 0x5e, 0x14, 0x01 );
    FCML_I64( "vdivsd xmm2,xmm6,qword ptr [rcx+rax]", 0xc5, 0xcb, 0x5e, 0x14, 0x01 );
}
...
void fcml_tf_instruction_DPPD(void) {
    FCML_I32( "dppd xmm2,oword ptr [ecx+eax],0ffh", 0x66, 0x0F, 0x3A, 0x41, 0x14, 0x01, 0xFF );
    FCML_I64( "dppd xmm2,oword ptr [rcx+rax],0ffh", 0x66, 0x0F, 0x3A, 0x41, 0x14, 0x01, 0xFF );
    // VEX.NDS.128.66.0F3A 41 /r ib VDPPD xmm1,xmm2,xmm3/m128,imm8
    FCML_I32( "vdppd xmm2,xmm6,oword ptr [ecx+eax],20h", 0xC4, 0xE3, 0x49, 0x41, 0x14, 0x01, 0x20 );
    FCML_I64( "vdppd xmm2,xmm6,oword ptr [rcx+rax],20h", 0xC4, 0xE3, 0x49, 0x41, 0x14, 0x01, 0x20 );
}
void fcml_tf_instruction_DPPS(void) {
    FCML_I32( "dpps xmm2,oword ptr [ecx+eax],0ffh", 0x66, 0x0F, 0x3A, 0x40, 0x14, 0x01, 0xFF );
    FCML_I64( "dpps xmm2,oword ptr [rcx+rax],0ffh", 0x66, 0x0F, 0x3A, 0x40, 0x14, 0x01, 0xFF );
    // VEX.NDS.128.66.0F3A 40 /r ib VDPPS xmm1,xmm2,xmm3/m128,imm8
    // VEX.NDS.256.66.0F3A 40 /r ib VDPPS ymm1,ymm2,ymm3/m256,imm8
    FCML_I32( "vdpps xmm2,xmm6,oword ptr [ecx+eax],20h", 0xC4, 0xE3, 0x49, 0x40, 0x14, 0x01, 0x20 );
    FCML_I64( "vdpps xmm2,xmm6,oword ptr [rcx+rax],20h", 0xC4, 0xE3, 0x49, 0x40, 0x14, 0x01, 0x20 );
}
