...
#define M_CMOVE   FCML_TEXT("cmove");
#define M_CMOVNE  FCML_TEXT("cmovne");
...
#define M_JE   FCML_TEXT("je");
#define M_JNE  FCML_TEXT("jne");
...
#define M_SETE   FCML_TEXT("sete");
#define M_SETNE  FCML_TEXT("setne");
