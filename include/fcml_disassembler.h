...
typedef struct fcml_st_dasm_disassembler_configuration {
	...
	fcml_bool carry_flag_conditional_mnemonic;
...
typedef struct fcml_st_dasm_prefixes_details {
...
typedef struct fcml_st_dasm_instruction_details {
	...
	fcml_st_dasm_prefixes_details prefixes_details;
