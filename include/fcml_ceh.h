...
#define FCML_CEH_GEC_INDEX_OUT_OF_BOUND			12

/* Assembler error codes */

#define FCML_CEH_AEC_ILLEGAL_SEG_REG_OVERRIDE		100
#define FCML_CEH_AEC_INVALID_PSEUDO_OPCODE_VALUE	101
#define FCML_CEH_AEC_HLE_PREFIX_NOT_ALLOWED			102
#define FCML_CEH_AEC_HLE_MORE_THAN_ONE_PREFIX		103
