...
fcml_ceh_error LIB_EXPORT fcml_fn_gas_dialect_init( fcml_uint32_t config_flags, fcml_st_dialect **dialect );
void LIB_EXPORT fcml_fn_gas_dialect_free(fcml_st_dialect *dialect);
