...
fcml_st_dialect_mnemonic fcml_arr_dialect_intel_mnemonics[] = {
	...
	{ FCML_TEXT("movs;movsb[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_MOVS, FCML_M8_M8 ), 0 },
	{ FCML_TEXT("movs;movsw[ts,ow,a*];movsd[ts,od,a*];movsq[ts,oq,a*]"), FCML_ASM_DIALECT_INSTRUCTION( F_MOVS, FCML_MO_MO ), 0 },
	...
	{ FCML_TEXT("outs;outsb[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_OUTS, FCML_M8 ), 0 },
	{ FCML_TEXT("outs;outsw[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_OUTS, FCML_M16 ), 0 },
	{ FCML_TEXT("outs;outsd[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_OUTS, FCML_M32 ), 0 },
	...
	{ FCML_TEXT("scas;scasb[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_SCAS, FCML_RM8 ), 0 },
	{ FCML_TEXT("scas;scasw[ts,ow,a*];scasd[ts,od,a*];scasq[ts,oq,a*]"), FCML_ASM_DIALECT_INSTRUCTION( F_SCAS, FCML_RMO ), 0 },
	{ FCML_TEXT("set"), FCML_ASM_DIALECT_INSTRUCTION( F_SET, FCML_AM_ALL ), 0 },
	{ FCML_TEXT("stos;stosb[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_STOS, FCML_RM8 ), 0 },
	{ FCML_TEXT("stos;stosw[ts,ow,a*];stosd[ts,od,a*];stosq[ts,oq,a*]"), FCML_ASM_DIALECT_INSTRUCTION( F_STOS, FCML_RMO ), 0 },
...
fcml_ceh_error fcml_fn_asm_dialect_get_parsed_mnemonics_intel( const fcml_st_dialect *dialect, fcml_st_def_instruction_desc *instruction, fcml_st_def_addr_mode_desc *addr_mode, fcml_st_mp_mnemonic_set **mnemonics ) {
...
fcml_ceh_error fcml_fnp_asm_dialect_get_mnemonic_intel( const fcml_st_dialect *dialect, fcml_st_def_instruction_desc *instruction, fcml_st_def_addr_mode_desc *addr_mode, fcml_st_condition *condition, fcml_st_mp_mnemonic **mnemonics, int *mnemonics_counter ) {
    ...
    error = fcml_fn_asm_dialect_get_parsed_mnemonics_intel( dialect, instruction, addr_mode, &mnemonic_set );
    if( error ) {
        return error;
    }
