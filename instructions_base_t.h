...
#define FCML_A32_M_A(x,...)			{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test( code, sizeof( code ), FCML_AF_32_BIT, x, FCML_TSF_MULTI_ASM_RESULTS | FCML_TSF_ASM_ONLY | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A64_M_A(x,...)			{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test( code, sizeof( code ), FCML_AF_64_BIT, x, FCML_TSF_MULTI_ASM_RESULTS | FCML_TSF_ASM_ONLY | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A32_D_FAILED(x,...)	{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test_diss( code, sizeof( code ), FCML_AF_32_BIT, x, FCML_TSF_SHOULD_FAIL | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A64_D_FAILED(x,...)	{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test_diss( code, sizeof( code ), FCML_AF_64_BIT, x, FCML_TSF_SHOULD_FAIL | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A32_D_SHORT(x,...)		{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test_diss( code, sizeof( code ), FCML_AF_32_BIT, x, FCML_TSF_SHORT | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A64_D_SHORT(x,...)		{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test_diss( code, sizeof( code ), FCML_AF_64_BIT, x, FCML_TSF_SHORT | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A32_A(x,...)			{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test( code, sizeof( code ), FCML_AF_32_BIT, x, FCML_TSF_ASM_ONLY | FCML_TSF_GAS_DIALECT, 0)); }
...
#define FCML_A64_A_FAILED(x,...)	{ fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(fcml_fn_ts_instruction_test( code, sizeof( code ), FCML_AF_64_BIT, x, FCML_TSF_SHOULD_FAIL | FCML_TSF_ASM_ONLY | FCML_TSF_GAS_DIALECT, 0)); }
