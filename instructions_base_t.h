...
#define FCML_I32_D(x,...) { fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(IA3264_instruction_diss_test( code, sizeof( code ), FCML_FALSE, x, FCML_FALSE)); }
#define FCML_I64_D(x,...) { fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(IA3264_instruction_diss_test( code, sizeof( code ), FCML_TRUE, x, FCML_FALSE)); }
#define FCML_I32_D_FAILED(x,...) { fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(IA3264_instruction_diss_test( code, sizeof( code ), FCML_FALSE, x, FCML_TRUE, FCML_EN_OP_DEFAULT_ADDRESSING_MODE_OPTIMIZER, 0)); }
#define FCML_I64_D_FAILED(x,...) { fcml_uint8_t code[] = {__VA_ARGS__}; CU_ASSERT(IA3264_instruction_diss_test( code, sizeof( code ), FCML_TRUE, x, FCML_TRUE, FCML_EN_OP_DEFAULT_ADDRESSING_MODE_OPTIMIZER, 0)); }
