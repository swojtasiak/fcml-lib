...
void fcml_tf_instruction_BSWAP(void) {
	...
	// only REX.R
	FCML_I64( "bswap r8", 0x4c, 0x0f, 0xc8 );
	FCML_I64( "bswap r9", 0x4c, 0x0f, 0xc9 );
	FCML_I64( "bswap r10", 0x4c, 0x0f, 0xca );
	FCML_I64( "bswap r11", 0x4c, 0x0f, 0xcb );
	FCML_I64( "bswap r12", 0x4c, 0x0f, 0xcc );
	FCML_I64( "bswap r13", 0x4c, 0x0f, 0xcd );
	FCML_I64( "bswap r14", 0x4c, 0x0f, 0xce );
	FCML_I64( "bswap r15", 0x4c, 0x0f, 0xcf );
}
