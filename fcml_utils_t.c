...
void fcml_fn_utils_test_sign_convert_imm_to_int8(void) {
	...
	imm.imm8 = 0xFF;
	imm.is_signed = FCML_FALSE;
	CU_ASSERT_EQUAL( fcml_fn_utils_convert_imm_to_int8( &imm, &value ), FCML_CEH_GEC_NO_ERROR );
	...
	imm.imm16 = 0xFFFF;
	imm.is_signed = FCML_FALSE;
	CU_ASSERT_EQUAL( fcml_fn_utils_convert_imm_to_int8( &imm, &value ), FCML_CEH_GEC_VALUE_OUT_OF_RANGE );
...
void fcml_fn_utils_test_sign_convert_imm_to_int16(void) {
	...
	imm.imm8 = 0xFF;
	imm.is_signed = FCML_TRUE;
	CU_ASSERT_EQUAL( fcml_fn_utils_convert_imm_to_int16( &imm, &value ), FCML_CEH_GEC_NO_ERROR );
	...
	imm.imm32 = 0x00FFFFFF;
	imm.is_signed = FCML_TRUE;
	CU_ASSERT_EQUAL( fcml_fn_utils_convert_imm_to_int16( &imm, &value ), FCML_CEH_GEC_VALUE_OUT_OF_RANGE );
...
void fcml_fn_utils_test_sign_convert_imm_to_int32(void) {
	...
	imm.imm_size = FCML_DS_8;
	imm.imm8 = 0xFF;
	CU_ASSERT_EQUAL( fcml_fn_utils_convert_imm_to_int32( &imm, &value ), FCML_CEH_GEC_NO_ERROR );
