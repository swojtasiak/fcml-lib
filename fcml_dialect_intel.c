...
fcml_st_dialect_mnemonic fcml_arr_dialect_intel_mnemonics[] = {
	...
	{ FCML_TEXT("ins;insb[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_INS, FCML_M8 ), 0 },
	{ FCML_TEXT("ins;insw[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_INS, FCML_M16 ), 0 },
	{ FCML_TEXT("ins;insd[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_INS, FCML_M32 ), 0 },
	...
	{ FCML_TEXT("lods;lodsb[ts]"), FCML_ASM_DIALECT_INSTRUCTION( F_LODS, FCML_RM8 ), 0 },
	{ FCML_TEXT("lods;lodsw[ts,ow,a*];lodsd[ts,od,a*];lodsq[ts,oq,a*]"), FCML_ASM_DIALECT_INSTRUCTION( F_LODS, FCML_RMO ), 0 },
