...
struct ira_opcode_desc _ira_opcode_desc_CMPS[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA6, 0x00, 0x00 },
			_IRA_EXPLICIT_GPS_REG_ASA_ADDRESSING( _IRA_REG_SI, _IRA_SD_BYTE_PTR, _IRA_SEG_ENCODE_REGISTER( _IRA_SEG_REG_DS, _IRA_SEG_ALLOW_OVERRIDE ) ),
			_IRA_EXPLICIT_GPS_REG_ASA_ADDRESSING( _IRA_REG_DI, _IRA_SD_BYTE_PTR, _IRA_SEG_ENCODE_REGISTER( _IRA_SEG_REG_ES, _IRA_SEG_DENY_OVERRIDE ) ),
			_IRA_NA, _IRA_NA },
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA7, 0x00, 0x00 },
			_IRA_EXPLICIT_GPS_REG_ASA_ADDRESSING( _IRA_REG_SI, _IRA_DEFAULT_SIZE_DIRECTIVE,_IRA_SEG_ENCODE_REGISTER( _IRA_SEG_REG_DS, _IRA_SEG_ALLOW_OVERRIDE ) ),
			_IRA_EXPLICIT_GPS_REG_ASA_ADDRESSING( _IRA_REG_DI, _IRA_DEFAULT_SIZE_DIRECTIVE,_IRA_SEG_ENCODE_REGISTER( _IRA_SEG_REG_ES, _IRA_SEG_DENY_OVERRIDE ) ),
			_IRA_NA, _IRA_NA }
};
