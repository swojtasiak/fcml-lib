...
struct ira_opcode_desc _ira_opcode_desc_ADC[] = {
	...
	{ NULL, 0x0001, 0x00D40000, { 0x15, 0x00, 0x00 }, _IRA_OPERAND_REG_ACCUMULATOR_OSA, _IRA_OPERAND_IOS, _IRA_NA, _IRA_NA },
	// REX.W + 15 id ADC RAX, imm32 C Valid N.E. Add with carry imm32 sign extended to 64-bits to RAX.
	{ NULL, 0x0801, 0x00940000, { 0x15, 0x00, 0x00 }, _IRA_OPERAND_REG_ACCUMULATOR_OSA, _IRA_OPERAND_IOS, _IRA_NA, _IRA_NA },
...
struct ira_instruction_desc _ira_instructions_desc[] = {
		...
		{ "adc", _IRA_IT_IA, 4, _ira_opcode_desc_ADC },
		{ NULL, 0, 0, NULL }
};
