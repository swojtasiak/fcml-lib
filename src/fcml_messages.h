...
typedef enum fcml_en_msg_message_code {
	...
	FCML_MC_GEC_INVALID_INPUT,
	FCML_MC_GEC_VALUE_OUT_OF_RANGE,
	FCML_MC_GEC_UNSUPPORTED_ADDRESSING_MODE,
	FCML_MC_GEC_UNSUPPORTED_OPPERAND,
	FCML_MC_GEC_UNKNOWN_MNEMONIC,
	FCML_MC_GEC_UNSUPPORTED_OPPERAND_SIZE,
	FCML_MC_GEC_UNSUPPORTED_ADDRESS_SIZE,
	FCML_MC_GEC_UNSUPPORTED_ADDRESSING_FORM,
	FCML_MC_GEC_UNSUPPORTED_PREFIX
