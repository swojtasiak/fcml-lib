...
fcml_st_dialect_mnemonic fcml_arr_dialect_gas_mnemonics[] = {
    ...
    { FCML_TEXT("call[sf,od];callw[sf,ow];callq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_CALL, FCML_RMO ), 0 },
    { FCML_TEXT("lcall[sf,od];lcallw[sf,ow];lcall[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_CALL, FCML_PTR16_O ), 0 },
    { FCML_TEXT("lcall[sf,od,d06];lcallw[sf,ow,d04];lcallq[sf,oq,d0a]"), FCML_ASM_DIALECT_INSTRUCTION( F_CALL, FCML_M16_O ), FCML_GAS_DF_HINTS | FCML_HINT_FAR_POINTER | FCML_HINT_INDIRECT_POINTER },
    ...
    { FCML_TEXT("cvtsi2sdl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_CVTSI2SD, FCML_RX_RM32 ), 0 },
    { FCML_TEXT("cvtsi2sdq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_CVTSI2SD, FCML_RX_RM64 ), 0 },
    { FCML_TEXT("vcvtsi2sdl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_VCVTSI2SD, FCML_RX_RX_RM32 ), 0 },
    { FCML_TEXT("vcvtsi2sdq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_VCVTSI2SD, FCML_RX_RX_RM64 ), 0 },
    { FCML_TEXT("cvtsi2ssl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_CVTSI2SS, FCML_RX_RM32 ), 0 },
    { FCML_TEXT("cvtsi2ssq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_CVTSI2SS, FCML_RX_RM64 ), 0 },
    { FCML_TEXT("vcvtsi2ssl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_VCVTSI2SS, FCML_RX_RX_RM32 ), 0 },
    { FCML_TEXT("vcvtsi2ssq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_VCVTSI2SS, FCML_RX_RX_RM64 ), 0 },
    ...
    { FCML_TEXT("jmp[sf,od];jmpw[sf,ow];jmpq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_JMP, FCML_RMO ), 0 },
    ...
    { FCML_TEXT("ljmpl[sf,od,d06];ljmpw[sf,ow,d04];ljmpq[sf,oq,d0a]"), FCML_ASM_DIALECT_INSTRUCTION( F_JMP, FCML_M16_O ), FCML_GAS_DF_HINTS | FCML_HINT_FAR_POINTER | FCML_HINT_INDIRECT_POINTER },
    ...
    { FCML_TEXT("monitor[tb]"), FCML_ASM_DIALECT_INSTRUCTION( F_MONITOR, FCML_AM_ALL ), FCML_GAS_DF_DO_NOT_REVERT_OPERANDS },
    ...
    { FCML_TEXT("movsb[tb,sb];movs"), FCML_ASM_DIALECT_INSTRUCTION( F_MOVS, FCML_M8_M8 ), 0 },
    { FCML_TEXT("movs;movsw[tb,sf,ow];movsl[tb,sf,od];movsq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_MOVS, FCML_MO_MO ), 0 },
    ...
    { FCML_TEXT("mulw[sf,ow,mm];mull[sf,od,mm];mulq[sf,oq,mm];mul"), FCML_ASM_DIALECT_INSTRUCTION( F_MUL, FCML_RMO ), 0 },
    ...
    { FCML_TEXT("neg;negb[sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_NEG, FCML_RM8 ), 0 },
    { FCML_TEXT("neg;negw[sf,ow,mm];negl[sf,od,mm];negq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_NEG, FCML_RMO ), 0 },
    { FCML_TEXT("nop"), FCML_ASM_DIALECT_INSTRUCTION( F_NOP, FCML_AM_ALL ), 0 },
    { FCML_TEXT("nop;nopw[sf,ow,mm];nopl[sf,od,mm];nopq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_NOP, FCML_RMO ), 0 },
    { FCML_TEXT("not;notb[sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_NOT, FCML_RM8 ), 0 },
    { FCML_TEXT("not;notw[sf,ow,mm];notl[sf,od,mm];notq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_NOT, FCML_RMO ), 0 },
    ...
    { FCML_TEXT("outsb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_OUTS, FCML_M8 ), 0 },
    { FCML_TEXT("outsw[tb,sf,ow]"), FCML_ASM_DIALECT_INSTRUCTION( F_OUTS, FCML_M16 ), 0 },
    { FCML_TEXT("outsl[tb,sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_OUTS, FCML_M32 ), 0 },
    ...
    { FCML_TEXT("rcl;rclw[sf,ow,mm];rcll[sf,od,mm];rclq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_RCL, FCML_RMO ), 0 },
    { FCML_TEXT("rcl;rclw[sf,ow,mm];rcll[sf,od,mm];rclq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_RCL, FCML_AM_RMO_IMM8 ), 0 },
    { FCML_TEXT("rcl;rclb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_RCL, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("rcr;rcrw[sf,ow,mm];rcrl[sf,od,mm];rcrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_RCR, FCML_RMO ), 0 },
    { FCML_TEXT("rcr;rcrw[sf,ow,mm];rcrl[sf,od,mm];rcrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_RCR, FCML_AM_RMO_IMM8 ), 0 },
    { FCML_TEXT("rcr;rcrb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_RCR, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("rol;rolw[sf,ow,mm];roll[sf,od,mm];rolq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_ROL, FCML_RMO ), 0 },
    { FCML_TEXT("rol;rolw[sf,ow,mm];roll[sf,od,mm];rolq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_ROL, FCML_AM_RMO_IMM8 ), 0 },
    { FCML_TEXT("rol;rolb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_ROL, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("ror;rorw[sf,ow,mm];rorl[sf,od,mm];rorq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_ROR, FCML_RMO ), 0 },
    { FCML_TEXT("ror;rorw[sf,ow,mm];rorl[sf,od,mm];rorq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_ROR, FCML_AM_RMO_IMM8 ), 0 },
    { FCML_TEXT("ror;rorb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_ROR, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("sar;sarw[sf,ow,mm];sarl[sf,od,mm];sarq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SAR, FCML_RMO ), 0 },
    { FCML_TEXT("sar;sarw[sf,ow,mm];sarl[sf,od,mm];sarq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SAR, FCML_AM_RMO_IMM8 ), 0 },
    { FCML_TEXT("sar;sarb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SAR, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("shl;shlw[sf,ow,mm];shll[sf,od,mm];shlq[sf,oq,mm];salw[sf,ow,mm];sall[sf,od,mm];salq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SHL, FCML_RMO ), 0 },
    ...
    { FCML_TEXT("shl;shlb[sb,mm];sal;salb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SHL, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("shr;shrw[sf,ow,mm];shrl[sf,od,mm];shrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SHR, FCML_RMO ), 0 },
    { FCML_TEXT("shr;shrw[sf,ow,mm];shrl[sf,od,mm];shrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SHR, FCML_AM_RMO_IMM8 ), 0 },
    { FCML_TEXT("shr;shrb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION( F_SHR, FCML_RM8 ), 0 },
    ...
    { FCML_TEXT("scas;scasb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_SCAS, FCML_RM8 ), 0 },
    { FCML_TEXT("scas;scasw[tb,sf,ow];scasl[tb,sf,od];scasq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_SCAS, FCML_RMO ), 0 },
    { FCML_TEXT("set"), FCML_ASM_DIALECT_INSTRUCTION( F_SET, FCML_AM_ALL ), 0 },
    { FCML_TEXT("stos;stosb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_STOS, FCML_RM8 ), 0 },
    { FCML_TEXT("stos;stosw[tb,sf,ow];stosl[tb,sf,od];stosq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_STOS, FCML_RMO ), 0 },
...
fcml_ceh_error fcml_ifn_asm_dialect_get_mnemonic_gas( const fcml_st_dialect *dialect, fcml_st_def_instruction_desc *instruction, fcml_st_def_addr_mode_desc *addr_mode, fcml_st_condition *condition, fcml_st_mp_mnemonic **mnemonics, int *mnemonics_counter ) {
