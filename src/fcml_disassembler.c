...
typedef fcml_ceh_error (*fcml_ifp_dasm_instruction_decoder)( fcml_ist_dasm_decoding_context *context,
        struct fcml_ist_dasm_instruction_decoding_def *instruction_decoding_def );
typedef fcml_bool (*fcml_ifp_dasm_instruction_acceptor)( fcml_ist_dasm_decoding_context *context,
        struct fcml_ist_dasm_instruction_decoding_def *instruction_decoding_def );
...
fcml_ceh_error fcml_ifn_dasm_instruction_decoder_IA( fcml_ist_dasm_decoding_context *decoding_context,
...
fcml_ceh_error fcml_ifn_dasm_utils_decode_segment_selector( fcml_ist_dasm_decoding_context *context, fcml_st_segment_selector *selector,
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_imm( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper, fcml_ptr args ) {
    ...
    if ( size_ex != size ) {
        error = fcml_fn_utils_convert_integer_to_integer( immediate, immediate, size, size_ex );
        if ( error ) {
            return error;
        }
    }
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_explicit_reg( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_explicit_gps_reg_addressing( fcml_ist_dasm_decoding_context *context,
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_opcode_reg( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_immediate_dis_relative( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
    ...
    if ( rel_args->encoded_size != FCML_EOS_UNDEFINED ) {
        ...
        if ( context->effective_operand_size_attribute == FCML_DS_16 && entry_point->op_mode == FCML_OM_64_BIT ) {
            fcml_fn_ceh_add_error( &( context->errors ), fcml_fn_msg_get_message( FCML_MC_CEH_GEC_INVALID_ADDRESSING_MODE ),
                    FCML_CEH_MEW_WARN_INVALID_ADDRESSING_MODE, FCML_EN_CEH_EL_WARN );
        }
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_far_pointer( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_explicit_ib( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_segment_relative_offset( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
    ...
    if ( ( rm_args->flags & FCML_RMF_R ) && decoded_modrm->reg.is_not_null ) {
        ...
        *address = decoded_modrm->address;
        ...
        if ( decoded_modrm->is_rip ) {
            /* We known the instruction size, so post processing is not needed and RIP can be calculated now.*/
            error = fcml_fn_modrm_decode_rip( (fcml_uint64_t) context->disassembler_context->entry_point.ip + context->calculated_instruction_size,
                    context->effective_address_size_attribute, &( address->offset ), &( address->offset ) );
        }
...
fcml_ceh_error fcml_ifn_dasm_operand_decoder_far_pointer_indirect( fcml_ist_dasm_decoding_context *context, fcml_ist_dasm_operand_wrapper *operand_wrapper,
        fcml_ptr args ) {
...
fcml_ist_dasm_operand_decoder_def fcml_iarr_def_operand_decoders[] = { { NULL, NULL }, { fcml_ifn_dasm_operand_decoder_imm,
        fcml_ifn_dasm_operand_size_calculator_imm, NULL }, { fcml_ifn_dasm_operand_decoder_explicit_reg, NULL, NULL }, {
        fcml_ifn_dasm_operand_decoder_opcode_reg, NULL, NULL }, { fcml_ifn_dasm_operand_decoder_immediate_dis_relative,
        fcml_ifn_dasm_operand_size_calculator_immediate_dis_relative, fcml_fn_hts_ihc_immediate_dis_relative }, { fcml_ifn_dasm_operand_decoder_far_pointer,
        fcml_ifn_dasm_operand_size_calculator_far_pointer, fcml_fn_hts_ihc_far_pointer }, { fcml_ifn_dasm_operand_decoder_explicit_gps_reg_addressing, NULL,
NULL }, { fcml_ifn_dasm_operand_decoder_explicit_ib, NULL, NULL }, { fcml_ifn_dasm_operand_decoder_segment_relative_offset,
        fcml_ifn_dasm_operand_size_calculator_segment_relative_offset, NULL }, { fcml_ifn_dasm_operand_decoder_rm, NULL, fcml_fn_hts_ihc_modrm_hints }, {
        fcml_ifn_dasm_operand_decoder_r, NULL, NULL }, { fcml_ifn_dasm_operand_decoder_vex_vvvv, NULL, NULL }, { fcml_ifn_dasm_operand_decoder_isX,
        fcml_ifn_dasm_operand_size_calculator_isX, NULL }, { fcml_ifn_dasm_operand_decoder_rm, NULL, NULL }, { fcml_ifn_dasm_operand_decoder_pseudo_op,
        fcml_ifn_dasm_operand_size_calculator_pseudo_op, fcml_fn_hts_ihc_pseudo_opcode } };
...
void fcml_ifn_dasm_dts_free_decoding_def( fcml_ist_dasm_instruction_decoding_def *decoding ) {
...
fcml_ceh_error fcml_ifn_dasm_dts_prepare_operand_decoding( fcml_st_def_addr_mode_desc *addr_mode_desc, fcml_ist_dasm_operand_decoding *operand_decoding,
        fcml_uint32_t operand_def, fcml_hints *instruction_hints ) {
    ...
    fcml_st_def_decoded_addr_mode *decoded_addr_mode = fcml_fn_def_decode_addr_mode_args( operand_def, &error );
    if ( error ) {
        return error;
    }
...
fcml_bool fcml_ifn_dasm_instruction_acceptor_prefixes( fcml_ist_dasm_decoding_context *context,
        fcml_ist_dasm_instruction_decoding_def *instruction_decoding_def ) {
...
fcml_bool fcml_ifn_dasm_instruction_acceptor_size_attributes_restrictions( fcml_ist_dasm_decoding_context *context,
        fcml_ist_dasm_instruction_decoding_def *instruction_decoding_def ) {
...
fcml_ifp_dasm_instruction_acceptor fcml_ifn_dasm_instruction_acceptor_factory_size_attributes_restrictions( fcml_st_def_addr_mode_desc *addr_mode_desc ) {
    return ( FCML_DEF_OPCODE_FLAGS_IS_EOSA_RESTRICTION( addr_mode_desc->opcode_flags )
            || FCML_DEF_OPCODE_FLAGS_IS_EASA_RESTRICTION( addr_mode_desc->opcode_flags ) ) ? fcml_ifn_dasm_instruction_acceptor_size_attributes_restrictions : NULL;
}
...
fcml_bool fcml_ifn_dasm_instruction_acceptor_addr_mode( fcml_ist_dasm_decoding_context *context,
        fcml_ist_dasm_instruction_decoding_def *instruction_decoding_def ) {
    ...
    return ( ( op_mode == FCML_OM_16_BIT || op_mode == FCML_OM_32_BIT )
            ...
            || ( op_mode == FCML_OM_64_BIT && FCML_DEF_OPCODE_FLAGS_64_BIT_MODE_SUPPORTED( instruction_decoding_def->opcode_flags ) );
}
...
fcml_ifp_dasm_instruction_acceptor_factory fcml_iarr_dasm_dts_acceptor_factories[] = { fcml_ifn_dasm_instruction_acceptor_factory_prefixes,
        fcml_ifn_dasm_instruction_acceptor_factory_addr_mode, fcml_ifn_dasm_instruction_acceptor_factory_modrm,
...
fcml_ceh_error fcml_ifn_dasm_dts_allocate_acceptors_chain( fcml_st_def_addr_mode_desc *addr_mode_desc, fcml_ist_dasm_addr_mode_acceptor_chain **chain ) {
    ...
    while ( *factory ) {
        /* Asks every factory for acceptor dedicated to the provided addressing mode description. */
        fcml_ifp_dasm_instruction_acceptor acceptor = ( *factory )( addr_mode_desc );
        if ( acceptor ) {
            fcml_ist_dasm_addr_mode_acceptor_chain *chain_element = (fcml_ist_dasm_addr_mode_acceptor_chain*) fcml_fn_env_memory_alloc_clear(
...
void fcml_ifn_dasm_dts_dispose_instruction_decoding_callback_default( fcml_st_dialect_context_int *dialect, fcml_ptr decoding_ptr ) {
    fcml_ifn_dasm_dts_free_decoding_def( (fcml_ist_dasm_instruction_decoding_def *) decoding_ptr );
}
...
fcml_ceh_error fcml_ifn_dasm_dts_prepare_instruction_decoding_callback_default( fcml_st_dialect_context_int *dialect, fcml_st_dt_diss_tree_element *element,
        fcml_st_def_instruction_desc *instruction_desc, fcml_st_def_addr_mode_desc *addr_mode_desc ) {

    fcml_ceh_error error = FCML_CEH_GEC_NO_ERROR;

    /* Prepare instruction decoding structure.*/
    fcml_ist_dasm_instruction_decoding_def *decoding = (fcml_ist_dasm_instruction_decoding_def*) fcml_fn_env_memory_alloc_clear(
    ...
    for ( i = 0; i < FCML_OPERANDS_COUNT; i++ ) {
        error = fcml_ifn_dasm_dts_prepare_operand_decoding( addr_mode_desc, &( decoding->operand_decodings[i] ), addr_mode_desc->opperands[i],
                &( decoding->hints ) );
        if ( !error ) {
...
fcml_ceh_error fcml_ifn_dasm_prepare_opcode_iterator( fcml_ist_dasm_decoding_context *decoding_context, struct fcml_ist_dasm_opcode_iterator **iterator_ptr ) {
    fcml_ceh_error error = FCML_CEH_GEC_NO_ERROR;
    fcml_ist_dasm_opcode_iterator_impl *iterator = (fcml_ist_dasm_opcode_iterator_impl*) fcml_fn_env_memory_alloc_clear(
...
void fcml_ifn_dasm_decode_opcode_fields( fcml_ist_dasm_decoding_context *decoding_context, fcml_ist_dasm_instruction_decoding_def *instruction_decoding_def,
        fcml_uint8_t primary_opcode_byte ) {
...
fcml_ceh_error fcml_ifn_dasm_instruction_decoder_IA( fcml_ist_dasm_decoding_context *decoding_context,
    ...
    /* Branches, take into account that this condition do not collide with multi-instructions.*/
    ...
    if ( FCML_DEF_OPCODE_FLAGS_OPCODE_IS_MODRM( instruction_decoding_def->opcode_flags ) ) {
        ...
        error = fcml_fn_modrm_decode( &modrm_context, &modrm_source, &( decoding_context->decoded_modrm ), &( decoding_context->decoded_modrm_details ),
                flags );
        if ( error ) {
            return error;
        }
...
fcml_ceh_error LIB_CALL fcml_fn_disassembler_init( fcml_st_dialect *dialect, fcml_st_disassembler **disassembler ) {
    ...
    if ( int_disasm ) {
        ...
        error = fcml_fn_dt_dts_tree_init( (fcml_st_dialect_context_int*) dialect, &( int_disasm->decoding_tree ),
                &fcml_ifn_dasm_dts_prepare_instruction_decoding_callback_default, &fcml_ifn_dasm_dts_dispose_instruction_decoding_callback_default );
        if ( !error ) {
...
fcml_ceh_error fcml_ifn_disassemble_core( fcml_st_disassembler_context *context, fcml_st_disassembler_result *result ) {
    ...
    if ( !error ) {
        ...
        fcml_fn_env_memory_copy( &instruction_details->instruction_code, context->code,
                instruction_details->instruction_size > FCML_INSTRUCTION_SIZE ? FCML_INSTRUCTION_SIZE : instruction_details->instruction_size );
        ...
        if ( decoding_context.pseudo_op ) {
            ...
            mp_config.is_memory =
                    ( decoding_context.decoded_modrm.address.address_form != FCML_AF_UNDEFINED && !decoding_context.decoded_modrm.reg.is_not_null );
            ...
            if ( mnemonic ) {
                ...
                instruction->mnemonic = int_disasm->dialect_context->render_mnemonic( mnemonic->mnemonic,
                        decoding_context.is_conditional ? &( decoding_context.condition ) : NULL, context->configuration.conditional_group,
