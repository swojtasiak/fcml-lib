...
void fcml_fn_rend_utils_format_append_reg( fcml_st_dialect_context_int *dialect_context, fcml_st_memory_stream *stream, const fcml_st_register *reg,
        fcml_bool is_rex );
...
fcml_bool fcml_fn_rend_utils_render_operand_separator( fcml_st_render_config *config, fcml_st_memory_stream *output_stream, fcml_int padding_length,
