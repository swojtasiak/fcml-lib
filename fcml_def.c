...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AAA[] = {
	{ NULL, 0x0001, 0x00440000, { 0x37, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AAD[] = {
	{ NULL, 0x0001, 0x00580000, { 0xD5, 0x0A, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0xD5, 0x00, 0x00 }, FCML_OP_IB, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AAM[] = {
	{ NULL, 0x0001, 0x00580000, { 0xD4, 0x0A, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0xD4, 0x00, 0x00 }, FCML_OP_IB, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AAS[] = {
	{ NULL, 0x0001, 0x00440000, { 0x3F, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADC[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0x14, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 15 iw ADC AX, imm16 C Valid Valid Add with carry imm16 to AX.
	// 15 id ADC EAX, imm32 C Valid Valid Add with carry imm32 to EAX.
	{ NULL, 0x0001, 0x00C40000, { 0x15, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 15 id ADC RAX, imm32 C Valid N.E. Add with carry imm32 sign extended to 64-bits to RAX.
	{ NULL, 0x0009, 0x00840000, { 0x15, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C59000, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C59000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /2 id ADC r/m64, imm32 B Valid N.E. Add with CF imm32 sign extended to 64-bits to r/m64.
	{ NULL, 0x0009, 0x00859000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C59000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /2 ib ADC r/m64, imm8 B Valid N.E. Add with CF sign-extended imm8 into r/m64.
	{ NULL, 0x0009, 0x00859000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x10, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x11, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x12, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x13, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADD[] = {
	// 04 ib ADD AL, imm8 C Valid Valid Add imm8 to AL..
	{ NULL, 0x0001, 0x00C40000, { 0x04, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 05 iw ADD AX, imm16 C Valid Valid Add imm16 to AX.
	// 05 id ADD EAX, imm32 C Valid Valid Add imm32 to EAX.
	{ NULL, 0x0001, 0x00C40000, { 0x05, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 05 id ADD RAX, imm32 C Valid N.E. Add imm32 sign-extended to 64-bits to RAX.
	{ NULL, 0x0009, 0x00840000, { 0x05, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C58000, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// 81 /0 iw ADD r/m16, imm16 B Valid Valid Add imm16 to r/m16.
	// 81 /0 id ADD r/m32, imm32 B Valid Valid Add imm32 to r/m32.
	{ NULL, 0x0001, 0x00C58000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /0 id ADD r/m64, imm32 B Valid N.E. Add imm32 sign-extended to 64-bits to r/m64.
	{ NULL, 0x0009, 0x00858000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C58000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /0 ib ADD r/m64, imm8 B Valid N.E. Add sign-extended imm8 to r/m64.
	{ NULL, 0x0009, 0x00858000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 00 /r ADD r/m8, r8 A Valid Valid Add r8 to r/m8.
	// REX + 00 /r ADD r/m8*, r8* A Valid N.E. Add r8 to r/m8.
	{ NULL, 0x0001, 0x00C48000, { 0x00, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x01, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 02 /r ADD r8, r/m8 A Valid Valid Add r/m8 to r8.
	// REX + 02 /r ADD r8*, r/m8* A Valid N.E. Add r/m8 to r8.
	{ NULL, 0x0001, 0x00C48000, { 0x02, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x03, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADDPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vaddpd", 0x1080, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADDPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 58 /r VADDPS xmm1,xmm2, xmm3/m128
	// VEX.NDS.256.0F 58 /r VADDPS ymm1, ymm2, ymm3/m256
	{ "vaddps", 0x0080, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADDSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 58 /r VADDSD xmm1,xmm2,xmm3/m64
	{ "vaddsd", 0x20C0, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADDSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 58 /r VADDSS xmm1,xmm2, xmm3/m32
	{ "vaddss", 0x40C0, 0x00D88000, { 0x0F, 0x58, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADDSUBPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xD0, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F D0 /r VADDSUBPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F D0 /r VADDSUBPD ymm1,ymm2,ymm3/m256
	{ "vaddsubpd", 0x1080, 0x00D88000, { 0x0F, 0xD0, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADDSUBPS[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0xD0, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F D0 /r VADDSUBPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.F2.0F D0 /r VADDSUBPS ymm1, ymm2,ymm3/m256
	{ "vaddsubps", 0x2080, 0x00D88000, { 0x0F, 0xD0, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AESDEC[] = {
	// 66 0F 38 DE /r AESDEC xmm1,xmm2/m128
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x38, 0xDE }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG DE /r VAESDEC xmm1,xmm2,xmm3/m128
	{ "vaesdec", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0xDE }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AESDECLAST[] = {
	// 66 0F 38 DF /r AESDECLAST xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0xDF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG DF /r VAESDECLAST xmm1,xmm2,xmm3/m128
	{ "vaesdeclast", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0xDF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AESENC[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0xDC }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG DC /r VAESENC xmm1, xmm2, xmm3/m128
	{ "vaesenc", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0xDC }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AESENCLAST[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0xDD }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG DD /r VAESENCLAST xmm1,xmm2,xmm3/m128
	{ "vaesenclast", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0xDD }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AESIMC[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0xDB }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG DB /r VAESIMC xmm1, xmm2/m128
	{ "vaesimc", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0xDB }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AESKEYGENASSIST[] = {
	...
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x3A, 0xDF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG DF /r ib VAESKEYGENASSIST xmm1,xmm2/m128,imm8
	{ "vaeskeygenassist", 0x11C0, 0x00EC8000, { 0x0F, 0x3A, 0xDF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_AND[] = {
	// 24 ib AND AL, imm8 C Valid Valid AL AND imm8.
	{ NULL, 0x0001, 0x00C40000, { 0x24, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 25 iw AND AX, imm16 C Valid Valid AX AND imm16.
	// 25 id AND EAX, imm32 C Valid Valid EAX AND imm32.
	{ NULL, 0x0001, 0x03C40000, { 0x25, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 25 id AND RAX, imm32 C Valid N.E. RAX AND imm32 signextended to 64-bits.
	{ NULL, 0x0001, 0x04840000, { 0x25, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 80 /4 ib AND r/m8, imm8 MR Valid Valid r/m8 AND imm8.
	// REX + 80 /4 ib AND r/m8*, imm8 MR Valid N.E. r/m8 AND imm8.
	{ NULL, 0x0001, 0x00C5A000, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// 81 /4 iw AND r/m16, imm16 B Valid Valid r/m16 AND imm16.
	// 81 /4 id AND r/m32, imm32 B Valid Valid r/m32 AND imm32.
	{ NULL, 0x0001, 0x03C5A000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /4 id AND r/m64, imm32 B Valid N.E. r/m64 AND imm32 sign extended to 64-bits.
	{ NULL, 0x0001, 0x0485A000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x03C5A000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /4 ib AND r/m64, imm8 B Valid N.E. r/m64 AND imm8 (signextended).
	{ NULL, 0x0001, 0x0485A000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 20 /r AND r/m8, r8 A Valid Valid r/m8 AND r8.
	// REX + 20 /r AND r/m8*, r8* A Valid N.E. r/m64 AND r8 (signextended).
	{ NULL, 0x0001, 0x00C48000, { 0x20, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x21, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 22 /r AND r8, r/m8 A Valid Valid r8 AND r/m8.
	// REX + 22 /r AND r8*, r/m8* A Valid N.E. r/m64 AND r8 (signextended).
	{ NULL, 0x0001, 0x00C48000, { 0x22, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x23, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ANDPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x54, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 54 /r VANDPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 54 /r VANDPD ymm1,ymm2,ymm3/m256
	{ "vandpd", 0x1080, 0x00D88000, { 0x0F, 0x54, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ANDPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x54, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 54 /r VANDPS xmm1,xmm2, xmm3/m128
	// VEX.NDS.256.0F 54 /r VANDPS ymm1, ymm2, ymm3/m256
	{ "vandps", 0x0080, 0x00D88000, { 0x0F, 0x54, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ANDNPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x55, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 55 /r VANDNPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 55 /r VANDNPD ymm1,ymm2,ymm3/m256
	{ "vandnpd", 0x1080, 0x00D88000, { 0x0F, 0x55, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ANDNPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x55, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 55 /r VANDNPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.0F 55 /r VANDNPS ymm1,ymm2,ymm3/m256
	{ "vandnps", 0x0080, 0x00D88000, { 0x0F, 0x55, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ARPL[] = {
	...
	{ NULL, 0x0001, 0x00448000, { 0x63, 0x00, 0x00 }, FCML_OP_MODRM_RM_16, FCML_OP_MODRM_R_16, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLENDPD[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x0D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	...
	{ "vblendpd", 0x1080, 0x00EC8000, { 0x0F, 0x3A, 0x0D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLENDPS[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x0C }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	...
	{ "vblendps", 0x1080, 0x00EC8000, { 0x0F, 0x3A, 0x0C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLENDVPD[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x15 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_EXPLICIT_REG( IRA_REG_SIMD, _IRA_REG_XMM0, FCML_EOS_OWORD ), FCML_NA },
	...
	{ "vblendvpd", 0x1080, 0x00EC8000, { 0x0F, 0x3A, 0x4B }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLENDVPS[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x14 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_EXPLICIT_REG( IRA_REG_SIMD, _IRA_REG_XMM0, FCML_EOS_OWORD ), FCML_NA },
	...
	{ "vblendvps", 0x1080, 0x00EC8000, { 0x0F, 0x3A, 0x4A }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VBROADCASTSS[] = {
	...
	{ NULL, 0x1000, 0x80EC8000, { 0x0F, 0x38, 0x18 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA },
	// VEX.256.66.0F38 19 /r VBROADCASTSD ymm1, m64
	{ "vbroadcastsd", 0x11A0, 0x80EC8000, { 0x0F, 0x38, 0x19 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.W0 1A /r VBROADCASTF128 ymm1,m128
	{ "vbroadcastf128", 0x11B0, 0x80EC8000, { 0x0F, 0x38, 0x1A }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_M_128, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.W0 5A /r VBROADCASTI128 ymm1,m128
	{ "vbroadcasti128", 0x11B0, 0x80EC8000, { 0x0F, 0x38, 0x5A }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_M_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.W0 18 /r VBROADCASTSS xmm1,xmm2
	// VEX.256.66.0F38.W0 18 /r VBROADCASTSS ymm1,xmm2
	{ "vbroadcastss", 0x1180, 0x00EE8000, { 0x0F, 0x38, 0x18 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.256.66.0F38.W0 19 /r VBROADCASTSD ymm1,xmm2
	{ "vbroadcastsd", 0x11A0, 0x00EE8000, { 0x0F, 0x38, 0x19 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPBROADCAST[] = {
	...
	{ "vpbroadcastb", 0x1190, 0x00EC8000, { 0x0F, 0x38, 0x78 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_8, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.W0 79 /r VPBROADCASTW xmm1,xmm2/m16
	// VEX.256.66.0F38.W0 79 /r VPBROADCASTW ymm1,xmm2/m16
	{ "vpbroadcastw", 0x1190, 0x00EC8000, { 0x0F, 0x38, 0x79 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_16, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.W0 58 /r VPBROADCASTD xmm1,xmm2/m32
	// VEX.256.66.0F38.W0 58 /r VPBROADCASTD ymm1,xmm2/m32
	{ "vpbroadcastd", 0x1190, 0x00EC8000, { 0x0F, 0x38, 0x58 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.W0 59 /r VPBROADCASTQ xmm1,xmm2/m64
	// VEX.256.66.0F38.W0 59 /r VPBROADCASTQ ymm1,xmm2/m64
	{ "vpbroadcastq", 0x1190, 0x00EC8000, { 0x0F, 0x38, 0x59 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BOUND[] = {
	...
	{ NULL, 0x0001, 0x00448000, { 0x62 }, FCML_OP_MODRM_R, FCML_OP_MODRM_MM_OSA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BSF[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xBC, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BSWAP[] = {
	...
	{ NULL, 0x0001, 0x00D80001, { 0x0F, 0xC8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_NA, FCML_NA, FCML_NA },
	// REX.W + 0F C8+rd BSWAP r64 A Valid N.E. Reverses the byte order of a 64-bit register.
	{ NULL, 0x0009, 0x00980001, { 0x0F, 0xC8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BT[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xA3, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D9A000, { 0x0F, 0xBA, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BTC[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xBB, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D9B800, { 0x0F, 0xBA, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BTR[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xB3, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D9B000, { 0x0F, 0xBA, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BTS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xAB, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D9A800, { 0x0F, 0xBA, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CALL[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xE8, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_EOSA, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x40C59000, { 0xFF, 0x00, 0x00 }, FCML_OP_MODRM_RM, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00440000, { 0x9A, 0x00, 0x00 }, FCML_OP_FAR_POINTER, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C59800, { 0xFF, 0x00, 0x00 }, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CBW[] = {
	// 98 CBW A Valid Valid AX  sign-extend of AL.
	{ "cbw", 0x0001, 0x01C40000, { 0x98, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 98 CWDE A Valid Valid EAX  sign-extend of AX.
	{ "cwde", 0x0001, 0x02C40000, { 0x98, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// REX.W + 98 CDQE A Valid N.E. RAX  sign-extend of EAX.
	{ "cdqe", 0x0001, 0x04C40000, { 0x98, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CLC[] = {
	// F8 CLC A Valid Valid Clear CF flag.
	{ NULL, 0x0001, 0x00C40000, { 0xF8, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CLD[] = {
	// F8 CLC A Valid Valid Clear CF flag.
	{ NULL, 0x0001, 0x00C40000, { 0xFC, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CLFLUSH[] = {
	...
	{ NULL, 0x0001, 0x00D9B800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_8_W, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMOV[] = {
	...
	{ NULL, 0x0001, 0x00D88040, { 0x0F, 0x40, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_JCXZ[] = {
	...
	{ "jcxz", 0x0001, 0x08440000, { 0xE3, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA },
	// E3 cb JECXZ rel8 A Valid Valid Jump short if ECX register is 0.
	{ "jecxz", 0x0001, 0x50C40000, { 0xE3, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA },
	// E3 cb JRCXZ rel8 A Valid N.E. Jump short if RCX register is 0.
	{ "jrcxz", 0x0001, 0x60840000, { 0xE3, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_Jcc[] = {
	// JA rel8 A Valid Valid Jump short if ...
	{ NULL, 0x0001, 0x40C40040, { 0x70, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA },
	// JA rel32 A Valid Valid Jump near if ...
	// JAE rel16 A N.S. Valid Jump near if ...
	{ NULL, 0x0001, 0x40D80040, { 0x0F, 0x80, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_EOSA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_JMP[] = {
	...
	{ NULL, 0x0001, 0x40C40000, { 0xEB, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x40C40000, { 0xE9, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_EOSA, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x40C5A000, { 0xFF, 0x00, 0x00 }, FCML_OP_MODRM_RM, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00440000, { 0xEA, 0x00, 0x00 }, FCML_OP_FAR_POINTER, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5A800, { 0xFF, 0x00, 0x00 }, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMP[] = {
	// 3C ib CMP AL, imm8 D Valid Valid Compare imm8 with AL.
	{ NULL, 0x0001, 0x00C40000, { 0x3C, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 3D iw CMP AX, imm16 D Valid Valid Compare imm16 with AX.
	// 3D id CMP EAX, imm32 D Valid Valid Compare imm32 with EAX.
	{ NULL, 0x0001, 0x00C40000, { 0x3D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 3D id CMP RAX, imm32 D Valid N.E. Compare imm32 sign extended to 64-bits with RAX.
	{ NULL, 0x0009, 0x00840000, { 0x3D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 80 /7 ib CMP r/m8, imm8 C Valid Valid Compare imm8 with r/m8.
	// REX + 80 /7 ib CMP r/m8*, imm8 C Valid N.E. Compare imm8 with r/m8.
	{ NULL, 0x0001, 0x00C5B800, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5B800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /7 id CMP r/m64, imm32 C Valid N.E. Compare imm32 sign extended to 64-bits with r/m64.
	{ NULL, 0x0009, 0x0085B800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 83 /7 ib CMP r/m16, imm8 C Valid Valid Compare imm8 with r/m16.
	// 83 /7 ib CMP r/m32, imm8 C Valid Valid Compare imm8 with r/m32.
	{ NULL, 0x0001, 0x00C5B800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /7 ib CMP r/m64, imm8 C Valid N.E. Compare imm8 with r/m64.
	{ NULL, 0x0009, 0x0085B800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 38 /r CMP r/m8, r8 B Valid Valid Compare r8 with r/m8.
	// REX + 38 /r CMP r/m8*, r8* B Valid N.E. Compare r8 with r/m8.
	{ NULL, 0x0001, 0x00C48000, { 0x38, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x39, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 3A /r CMP r8, r/m8 A Valid Valid Compare r/m8 with r8.
	// REX + 3A /r CMP r8*, r/m8* A Valid N.E. Compare r/m8 with r8.
	{ NULL, 0x0001, 0x00C48000, { 0x3A, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x3B, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F C2 /r ib VCMPPD xmm1, xmm2, xmm3/m128, imm8
	// VEX.NDS.256.66.0F C2 /r ib VCMPPD ymm1, ymm2, ymm3/m256, imm8
	{ "vcmppd", 0x1080, 0x00D88000, { 0x0F, 0xC2, 0x0C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.0F C2 /r ib VCMPPS xmm1, xmm2, xmm3/m128, imm8
	// VEX.NDS.256.0F C2 /r ib VCMPPS ymm1, ymm2, ymm3/m256, imm8
	{ "vcmpps", 0x0080, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPS[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA6, 0x00, 0x00 },
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_SI, FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ),
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ),
			FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA7, 0x00, 0x00 },
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_SI, FCML_EOS_EOSA,FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ),
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_EOSA,FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ),
			FCML_NA, FCML_NA }
	// CMPSB
	// CMPSW
	// CMPSQ
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.F2.0F C2 /r ib VCMPSD xmm1, xmm2, xmm3/m64, imm8
	{ "vcmpsd", 0x20C0, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.F3.0F C2 /r ib VCMPSS xmm1, xmm2, xmm3/m32, imm8
	{ "vcmpss", 0x40C0, 0x00D88000, { 0x0F, 0xC2, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPXCHG[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xB0, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xB1, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CMPXCHGxB[] = {
	...
	{ "cmpxchg8b", 0x0001, 0x03D98800, { 0x0F, 0xC7, 0x00 }, FCML_OP_MODRM_MM_OSA, FCML_NA, FCML_NA, FCML_NA },
	{ "cmpxchg16b", 0x0001, 0x04D98800, { 0x0F, 0xC7, 0x00 }, FCML_OP_MODRM_MM_OSA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_COMISD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x2F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F 2F /r VCOMISD xmm1, xmm2/m64
	{ "vcomisd", 0x11C1, 0x00D88000, { 0x0F, 0x2F, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_COMISS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x2F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.0F 2F /r VCOMISS xmm1, xmm2/m32
	{ "vcomiss", 0x01C1, 0x00D88000, { 0x0F, 0x2F, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CPUID[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0xA2, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CRC32[] = {
	...
	{ NULL, 0x2001, 0x03EC8000, { 0x0F, 0x38, 0xF0 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	// F2 REX.W 0F 38 F0 /r CRC32 r64, r/m8 A Valid N.E. Accumulate CRC32 on r/m8.
	{ NULL, 0x2009, 0x04AC8000, { 0x0F, 0x38, 0xF0 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x2001, 0x03EC8000, { 0x0F, 0x38, 0xF1 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA },
	// F2 REX.W 0F 38 F1 /r CRC32 r64, r/m64 A Valid N.E. Accumulate CRC32 on r/m64.
	{ NULL, 0x2009, 0x04AC8000, { 0x0F, 0x38, 0xF1 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTDQ2PD[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.F3.0F E6 /r VCVTDQ2PD xmm1, xmm2/m64
	{ "vcvtdq2pd", 0x41C1, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA },
	// VEX.256.F3.0F E6 /r VCVTDQ2PD ymm1, xmm2/m128
	{ "vcvtdq2pd", 0x41A1, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTDQ2PS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x5B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.0F 5B /r VCVTDQ2PS xmm1, xmm2/m128
	// VEX.256.0F 5B /r VCVTDQ2PS ymm1, ymm2/m256
	{ "vcvtdq2ps", 0x0181, 0x00D88000, { 0x0F, 0x5B, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPD2DQ[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.F2.0F E6 /r VCVTPD2DQ xmm1, xmm2/m128
	// VEX.256.F2.0F E6 /r VCVTPD2DQ xmm1, ymm2/m256
	{ "vcvtpd2dq", 0x2181, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPD2PI[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPD2PS[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F 5A /r VCVTPD2PS xmm1, xmm2/m128
	// VEX.256.66.0F 5A /r VCVTPD2PS xmm1, ymm2/m256
	{ "vcvtpd2ps", 0x1181, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPI2PD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPI2PS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPS2DQ[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x5B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F 5B /r VCVTPS2DQ xmm1, xmm2/m128
	// VEX.256.66.0F 5B /r VCVTPS2DQ ymm1, ymm2/m256
	{ "vcvtps2dq", 0x1180, 0x00D88000, { 0x0F, 0x5B, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPS2PD[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.0F 5A /r VCVTPS2PD xmm1, xmm2/m64
	// VEX.256.0F 5A /r VCVTPS2PD ymm1, xmm2/m128
	{ "vcvtps2pd", 0x0180, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTPS2PI[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTSD2SI[] = {
	...
	{ NULL, 0x2001, 0x03D88000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ NULL, 0x2009, 0x04988000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.F2.0F.W0 2D /r VCVTSD2SI r32, xmm1/m64
	{ "vcvtsd2si", 0x21D0, 0x03D88000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA },
	// VEX.128.F2.0F.W1 2D /r VCVTSD2SI r64, xmm1/m64
	{ "vcvtsd2si", 0x21C8, 0x04988000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTSD2SS[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 5A /r VCVTSD2SS xmm1,xmm2,xmm3/m64
	{ "vcvtsd2ss", 0x20C0, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTSI2SD[] = {
	...
	{ NULL, 0x2001, 0x03D88000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	...
	{ NULL, 0x2009, 0x04988000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F.W0 2A /r VCVTSI2SD xmm1, xmm2, r/m32
	{ "vcvtsi2sd", 0x20D0, 0x03D88000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_32, FCML_NA },
	// VEX.NDS.128.F2.0F.W1 2A /r VCVTSI2SD xmm1, xmm2, r/m64
	{ "vcvtsi2sd", 0x20C8, 0x04988000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTSI2SS[] = {
	...
	{ NULL, 0x4001, 0x03D88000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	...
	{ NULL, 0x4009, 0x04988000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F.W0 2A /r VCVTSI2SS xmm1, xmm2, r/m32
	{ "vcvtsi2ss", 0x40D0, 0x03D88000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_32, FCML_NA },
	// VEX.NDS.128.F3.0F.W1 2A /r VCVTSI2SS xmm1, xmm2, r/m64
	{ "vcvtsi2ss", 0x40C8, 0x04988000, { 0x0F, 0x2A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTSS2SD[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 5A /r VCVTSS2SD xmm1, xmm2, xmm3/m32
	{ "vcvtss2sd", 0x40C0, 0x00D88000, { 0x0F, 0x5A, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_32, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTSS2SI[] = {
	...
	{ NULL, 0x4001, 0x03D88000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	...
	{ NULL, 0x4009, 0x04988000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.F3.0F.W0 2D /r VCVTSS2SI r32, xmm1/m32
	{ "vcvtss2si", 0x41D0, 0x03D88000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA, FCML_NA },
	// VEX.128.F3.0F.W1 2D /r VCVTSS2SI r64, xmm1/m32
	{ "vcvtss2si", 0x41C8, 0x04988000, { 0x0F, 0x2D, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTTPD2DQ[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F E6 /r VCVTTPD2DQ xmm1, xmm2/m128
	// VEX.256.66.0F E6 /r VCVTTPD2DQ xmm1, ymm2/m256
	{ "vcvttpd2dq", 0x1180, 0x00D88000, { 0x0F, 0xE6, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTTPD2PI[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTTPS2DQ[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x5B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 5B /r VCVTTPS2DQ xmm1, xmm2/m128
	// VEX.256.F3.0F 5B /r VCVTTPS2DQ ymm1, ymm2/m256
	{ "vcvttps2dq", 0x4180, 0x00D88000, { 0x0F, 0x5B, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTTPS2PI[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTTSD2SI[] = {
	...
	{ NULL, 0x2001, 0x03D88000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ NULL, 0x2009, 0x04988000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.F2.0F.W0 2C /r VCVTTSD2SI r32, xmm1/m64
	{ "vcvttsd2si", 0x21D0, 0x03D88000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA },
	// VEX.128.F2.0F.W1 2C /r VCVTTSD2SI r64, xmm1/m64
	{ "vcvttsd2si", 0x21C8, 0x04988000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CVTTSS2SI[] = {
	...
	{ NULL, 0x4001, 0x03D88000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	...
	{ NULL, 0x4009, 0x04988000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.F3.0F.W0 2C /r VCVTTSS2SI r32, xmm1/m32
	{ "vcvttss2si", 0x41C0, 0x03D88000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA, FCML_NA },
	// VEX.128.F3.0F.W1 2C /r VCVTTSS2SI r64, xmm1/m32
	{ "vcvttss2si", 0x41D0, 0x04988000, { 0x0F, 0x2C, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CWD_CDQ_CQO[] = {
	// 99 CWD A Valid Valid DX:AX <- sign-extend of AX.
	{ "cwd", 0x0001, 0x01C40000, { 0x99, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 99 CDQ A Valid Valid EDX:EAX <- sign-extend of EAX.
	{ "cdq", 0x0001, 0x02C40000, { 0x99, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// REX.W + 99 CQO A Valid N.E. RDX:RAX <- sign-extend of RAX.
	{ "cqo", 0x0001, 0x04840000, { 0x99, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DAA[] = {
	// 27 DAA A Invalid Valid Decimal adjust AL after addition.
	{ NULL, 0x0001, 0x00440000, { 0x27, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DAS[] = {
	...
	{ NULL, 0x0001, 0x00440000, { 0x2F, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DEC[] = {
	...
	{ NULL, 0x0001, 0x00C58800, { 0xFE, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C58800, { 0xFF, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA },
	// 48+rw DEC r16 B N.E. Valid Decrement r16 by 1.
	// 48+rd DEC r32 B N.E. Valid Decrement r32 by 1.
	{ NULL, 0x0001, 0x00440001, { 0x48, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DIV[] = {
	...
	{ NULL, 0x0001, 0x00C5B000, { 0xF6, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AX, FCML_EOS_WORD ), FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5B000, { 0xF7, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ), FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DIVPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 5E /r VDIVPD xmm1, xmm2, xmm3/m128
	// VEX.NDS.256.66.0F 5E /r VDIVPD ymm1, ymm2, ymm3/m256
	{ "vdivpd", 0x1080, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DIVPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 5E /r VDIVPS xmm1, xmm2, xmm3/m128
	// VEX.NDS.256.0F 5E /r VDIVPS ymm1, ymm2, ymm3/m256
	{ "vdivps", 0x0080, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DIVSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 5E /r VDIVSD xmm1, xmm2, xmm3/m64
	{ "vdivsd", 0x20C0, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DIVSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 5E /r VDIVSS xmm1, xmm2, xmm3/m32
	{ "vdivss", 0x40C0, 0x00D88000, { 0x0F, 0x5E, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DPPD[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x41 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A 41 /r ib VDPPD xmm1,xmm2,xmm3/m128,imm8
	{ "vdppd", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x41 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_128, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_DPPS[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x40 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A 40 /r ib VDPPS xmm1,xmm2,xmm3/m128,imm8
	// VEX.NDS.256.66.0F3A 40 /r ib VDPPS ymm1,ymm2,ymm3/m256,imm8
	{ "vdpps", 0x1080, 0x00EC8000, { 0x0F, 0x3A, 0x40 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VEXTRACTF128[] = {
	...
	{ "vextractf128", 0x11A0, 0x00EC8000, { 0x0F, 0x3A, 0x19 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_SIMD_L, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_EMMS[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0x77, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ENTER[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xC8, 0x00, 0x00 }, FCML_OP_IW | FCML_OA_W, FCML_OP_IB, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_EXTRACTPS[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x17 }, FCML_OP_MODRM_RM_32_W, FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A 17 /r ib VEXTRACTPS r/m32, xmm1, imm8
	{ "vextractps", 0x11C0, 0x00EC8000, { 0x0F, 0x3A, 0x17 }, FCML_OP_MODRM_RM_32_W, FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_EXTRQ[] = {
	// EXTRQ xmm1,imm8,imm8 66 0F 78 /0 ib ib
	{ NULL, 0x1000, 0x00DB8000, { 0x0F, 0x78, 0x00 }, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_OP_IB, FCML_NA },
	// EXTRQ xmm1,xmm2 66 0F 79 /r
	{ NULL, 0x1000, 0x00DA8000, { 0x0F, 0x79, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_F2XM1[] = {
	// D9 F0 F2XM1 Valid Valid Replace ST(0) with (2ST(0) – 1).
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF0, 0x17 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FABS[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xE1, 0x17 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FADD[] = {
	...
	{ NULL, 0x0001, 0x00C58000, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /0 FADD m64fp Valid Valid Add m64fp to ST(0) and store result in ST(0).
	{ NULL, 0x0001, 0x00C58000, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 C0+i FADD ST(0), ST(i) Valid Valid Add ST(0) to ST(i) and store result in ST(0).
	{ NULL, 0x0001, 0x00D80001, { 0xD8, 0xC0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DC C0+i FADD ST(i), ST(0) Valid Valid Add ST(i) to ST(0) and store result in ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDC, 0xC0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DE C0+i FADDP ST(i), ST(0) Valid Valid Add ST(0) to ST(i), store result in ST(i), and pop the register stack.
	{ "faddp", 0x0001, 0x00D80001, { 0xDE, 0xC0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA /0 FIADD m32int Valid Valid Add m32int to ST(0) and store result in ST(0).
	{ "fiadd", 0x0001, 0x00C58000, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /0 FIADD m16int Valid Valid Add m16int to ST(0) and store result in ST(0).
	{ "fiadd", 0x0001, 0x00C58000, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FBLD[] = {
	...
	{ NULL, 0x0001, 0x00C5A000, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_80, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FBSTP[] = {
	...
	{ NULL, 0x0001, 0x00C5B000, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_80, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FCHS[] = {
	// D9 E0 FCHS Valid Valid Complements sign of ST(0).
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xE0, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FCLEX[] = {
	...
	{ NULL, 0x0001, 0x00EC0000, { 0x9B, 0xDB, 0xE2 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// DB E2 * Valid Valid Clear floating-point exception flags without checking for pending unmasked floating-point exceptions.
	{ "fnclex", 0x0001, 0x00D80000, { 0xDB, 0xE2, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FCMOV[] = {
	...
	{ "fcmovb", 0x0001, 0x00D80001, { 0xDA, 0xC0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA C8+i FCMOVE ST(0), ST(i) Valid Valid Move if equal (ZF=1).
	{ "fcmove", 0x0001, 0x00D80001, { 0xDA, 0xC8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA D0+i FCMOVBE ST(0), ST(i) Valid Valid Move if below or equal (CF=1 or ZF=1).
	{ "fcmovbe", 0x0001, 0x00D80001, { 0xDA, 0xD0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA D8+i FCMOVU ST(0), ST(i) Valid Valid Move if unordered (PF=1).
	{ "fcmovu", 0x0001, 0x00D80001, { 0xDA, 0xD8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DB C0+i FCMOVNB ST(0), ST(i) Valid Valid Move if not below (CF=0).
	{ "fcmovnb", 0x0001, 0x00D80001, { 0xDB, 0xC0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DB C8+i FCMOVNE ST(0), ST(i) Valid Valid Move if not equal (ZF=0).
	{ "fcmovne", 0x0001, 0x00D80001, { 0xDB, 0xC8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DB D0+i FCMOVNBE ST(0), ST(i) Valid Valid Move if not below or equal (CF=0 and ZF=0).
	{ "fcmovnbe", 0x0001, 0x00D80001, { 0xDB, 0xD0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DB D8+i FCMOVNU ST(0), ST(i) Valid Valid Move if not unordered (PF=0).
	{ "fcmovnu", 0x0001, 0x00D80001, { 0xDB, 0xD8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FCOM[] = {
	// D8 /2 FCOM m32fp
	{ "fcom", 0x0000, 0x00C59000, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// D8 /3 FCOMP m32fp
	{ "fcomp", 0x0000, 0x00C59800, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /2 FCOM m64fp
	{ "fcom", 0x0000, 0x00C59000, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// DC /3 FCOMP m64fp
	{ "fcomp", 0x0000, 0x00C59800, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 D0+i FCOM ST(i)
	{ "fcom", 0x0000, 0x00D80001, { 0xD8, 0xD0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// D8 D8+i FCOMP ST(i)
	{ "fcomp", 0x0000, 0x00D80001, { 0xD8, 0xD8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// DE D9 FCOMPP
	{ "fcompp", 0x0000, 0x00D80000, { 0xDE, 0xD9, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FCOMI[] = {
	...
	{ "fcomi", 0x0001, 0x00D80001, { 0xDB, 0xF0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DF F0+i FCOMIP ST, ST(i) Valid Valid Compare ST(0) with ST(i), set status flags accordingly, and pop register stack.
	{ "fcomip", 0x0001, 0x00D80001, { 0xDF, 0xF0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DB E8+i FUCOMI ST, ST(i) Valid Valid Compare ST(0) with ST(i), check for ordered values, and set status flags accordingly.
	{ "fucomi", 0x0001, 0x00D80001, { 0xDB, 0xE8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	...
	{ "fucomip", 0x0001, 0x00D80001, { 0xDF, 0xE8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FCOS[] = {
	// D9 FF FCOS Valid Valid Replace ST(0) with its cosine.
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xFF, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FDECSTP[] = {
	// D9 F6 FDECSTP Valid Valid Decrement
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF6, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FDIV[] = {
	...
	{ NULL, 0x0001, 0x00C5B000, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /6 FDIV m64fp Valid Valid Divide ST(0) by m64fp and store result in ST(0).
	{ NULL, 0x0001, 0x00C5B000, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 F0+i FDIV ST(0), ST(i) Valid Valid Divide ST(0) by ST(i) and store result in ST(0).
	{ NULL, 0x0001, 0x00D80001, { 0xD8, 0xF0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DC F8+i FDIV ST(i), ST(0) Valid Valid Divide ST(i) by ST(0) and store result in ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDC, 0xF8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DE F8+i FDIVP ST(i), ST(0) Valid Valid Divide ST(i) by ST(0), store result in ST(i), and pop the register stack.
	{ "fdivp", 0x0001, 0x00D80001, { 0xDE, 0xF8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA /6 FIDIV m32int Valid Valid Divide ST(0) by m32int and store result in ST(0).
	{ "fidiv", 0x0001, 0x00C5B000, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /6 FIDIV m16int Valid Valid Divide ST(0) by m64int and store result in ST(0).
	{ "fidiv", 0x0001, 0x00C5B000, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FDIVR[] = {
	...
	{ NULL, 0x0001, 0x00C5B800, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /7 FDIVR m64fp Valid Valid Divide m64fp by ST(0) and store result in ST(0).
	{ NULL, 0x0001, 0x00C5B800, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 F8+i FDIVR ST(0), ST(i) Valid Valid Divide ST(i) by ST(0) and store result in ST(0).
	{ NULL, 0x0001, 0x00D80001, { 0xD8, 0xF8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DC F0+i FDIVR ST(i), ST(0) Valid Valid Divide ST(0) by ST(i) and store result in ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDC, 0xF0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DE F0+i FDIVRP ST(i), ST(0) Valid Valid Divide ST(0) by ST(i), store result in ST(i), and pop the register stack.
	{ "fdivrp", 0x0001, 0x00D80001, { 0xDE, 0xF0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA /7 FIDIVR m32int Valid Valid Divide m32int by ST(0) and store result in ST(0).
	{ "fidivr", 0x0001, 0x00C5B800, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /7 FIDIVR m16int Valid Valid Divide m16int by ST(0) and store result in ST(0).
	{ "fidivr", 0x0001, 0x00C5B800, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FFREE[] = {
	...
	{ NULL, 0x0001, 0x00D80001, { 0xDD, 0xC0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FICOM[] = {
	...
	{ NULL, 0x0001, 0x00C59000, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA },
	// DA /2 FICOM m32int Valid Valid Compare ST(0) with m32int.
	{ NULL, 0x0001, 0x00C59000, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /3 FICOMP m16int Valid Valid Compare ST(0) with m16int and pop stack register.
	{ "ficomp", 0x0001, 0x00C59800, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA },
	// DA /3 FICOMP m32int Valid Valid Compare ST(0) with m32int and pop stack register.
	{ "ficomp", 0x0001, 0x00C59800, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FILD[] = {
	...
	{ NULL, 0x0001, 0x00C58000, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA },
	// DB /0 FILD m32int Valid Valid Push m32int onto the FPU register stack.
	{ NULL, 0x0001, 0x00C58000, { 0xDB, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DF /5 FILD m64int Valid Valid Push m64int onto the FPU register stack.
	{ NULL, 0x0001, 0x00C5A800, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FINCSTP[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF7, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FINIT[] = {
	...
	{ NULL, 0x0001, 0x00EC0000, { 0x9B, 0xDB, 0xE3 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// DB E3 FNINIT* Valid Valid Initialize FPU without checking for pending unmasked floating-point exceptions.
	{ "fninit", 0x0001, 0x00D80000, { 0xDB, 0xE3, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FIST[] = {
	// DF /2 FIST m16int Valid Valid Store ST(0) in m16int.
	{ NULL, 0x0001, 0x00C59000, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA },
	// DB /2 FIST m32int Valid Valid Store ST(0) in m32int.
	{ NULL, 0x0001, 0x00C59000, { 0xDB, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DF /3 FISTP m16int Valid Valid Store ST(0) in m16int and pop register stack.
	{ "fistp", 0x0001, 0x00C59800, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA },
	// DB /3 FISTP m32int Valid Valid Store ST(0) in m32int and pop register stack.
	{ "fistp", 0x0001, 0x00C59800, { 0xDB, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DF /7 FISTP m64int Valid Valid Store ST(0) in m64int and pop register stack.
	{ "fistp", 0x0001, 0x00C5B800, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FISTTP[] = {
	...
	{ NULL, 0x0001, 0x00C58800, { 0xDF, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA },
	// DB /1 FISTTP m32int Valid Valid Store ST(0) in m32int with truncation.
	{ NULL, 0x0001, 0x00C58800, { 0xDB, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DD /1 FISTTP m64int Valid Valid Store ST(0) in m64int with truncation.
	{ NULL, 0x0001, 0x00C58800, { 0xDD, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FLD[] = {
	...
	{ NULL, 0x0001, 0x00C58000, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DD /0 FLD m64fp Valid Valid Push m64fp onto the FPU register stack.
	{ NULL, 0x0001, 0x00C58000, { 0xDD, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// DB /5 FLD m80fp Valid Valid Push m80fp onto the FPU register stack.
	{ NULL, 0x0001, 0x00C5A800, { 0xDB, 0x00, 0x00 }, FCML_OP_MODRM_M_80, FCML_NA, FCML_NA, FCML_NA },
	// D9 C0+i FLD ST(i) Valid Valid Push ST(i) onto the FPU register stack.
	{ NULL, 0x0001, 0x00D80001, { 0xD9, 0xC0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FLDx[] = {
	...
	{ "fld1", 0x0001, 0x00D80000, { 0xD9, 0xE8, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// D9 E9 FLDL2T Valid Valid Push log210 onto the FPU register stack.
	{ "fldl2t", 0x0001, 0x00D80000, { 0xD9, 0xE9, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// D9 EA FLDL2E Valid Valid Push log2e onto the FPU register stack.
	{ "fldl2e", 0x0001, 0x00D80000, { 0xD9, 0xEA, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// D9 EB FLDPI Valid Valid Push onto the FPU register stack.
	{ "fldpi", 0x0001, 0x00D80000, { 0xD9, 0xEB, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// D9 EC FLDLG2 Valid Valid Push log102 onto the FPU register stack.
	{ "fldlg2", 0x0001, 0x00D80000, { 0xD9, 0xEC, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// D9 ED FLDLN2 Valid Valid Push loge2 onto the FPU register stack.
	{ "fldln2", 0x0001, 0x00D80000, { 0xD9, 0xED, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// D9 EE FLDZ Valid Valid Push +0.0 onto the FPU register stack.
	{ "fldz", 0x0001, 0x00D80000, { 0xD9, 0xEE, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FLDCW[] = {
	...
	{ NULL, 0x0001, 0x00C5A800, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FLDENV[] = {
	...
	{ NULL, 0x0001, 0x00C5A000, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_14_28, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FMUL[] = {
	...
	{ NULL, 0x0001, 0x00C58800, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /1 FMUL m64fp Valid Valid Multiply ST(0) by m64fp and store result in ST(0).
	{ NULL, 0x0001, 0x00C58800, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 C8+i FMUL ST(0), ST(i) Valid Valid Multiply ST(0) by ST(i) and store result in ST(0).
	{ NULL, 0x0001, 0x00D80001, { 0xD8, 0xC8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DC C8+i FMUL ST(i), ST(0) Valid Valid Multiply ST(i) by ST(0) and store result in ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDC, 0xC8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DE C8+i FMULP ST(i), ST(0) Valid Valid Multiply ST(i) by ST(0), store result in ST(i), and pop the register stack.
	{ "fmulp", 0x0001, 0x00D80001, { 0xDE, 0xC8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA /1 FIMUL m32int Valid Valid Multiply ST(0) by m32int and store result in ST(0).
	{ "fimul", 0x0001, 0x00C58800, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /1 FIMUL m16int Valid Valid Multiply ST(0) by m16int and store result in ST(0).
	{ "fimul", 0x0001, 0x00C58800, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FNOP[] = {
	// D9 D0 FNOP Valid Valid No operation is performed.
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xD0, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FPATAN[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF3, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FPREM[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF8, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FPREM1[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF5, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FPTAN[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF2, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FRNDINT[] = {
	// D9 FC FRNDINT Valid Valid Round ST(0) to an integer.
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xFC, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FRSTOR[] = {
	...
	{ NULL, 0x0001, 0x00C5A000, { 0xDD, 0x00, 0x00 }, FCML_OP_MODRM_M_94_108, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSAVE[] = {
	...
	{ NULL, 0x0001, 0x00D9B000, { 0x9B, 0xDD, 0x00 }, FCML_OP_MODRM_M_94_108, FCML_NA, FCML_NA, FCML_NA },
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSINCOS[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xFB, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSQRT[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xFA, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FST[] = {
	// D9 /2 FST m32fp Valid Valid Copy ST(0) to m32fp.
	{ NULL, 0x0001, 0x00C59000, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DD /2 FST m64fp Valid Valid Copy ST(0) to m64fp.
	{ NULL, 0x0001, 0x00C59000, { 0xDD, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// DD D0+i FST ST(i) Valid Valid Copy ST(0) to ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDD, 0xD0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// D9 /3 FSTP m32fp Valid Valid Copy ST(0) to m32fp and pop register stack.
	{ "fstp", 0x0001, 0x00C59800, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DD /3 FSTP m64fp Valid Valid Copy ST(0) to m64fp and pop register stack.
	{ "fstp", 0x0001, 0x00C59800, { 0xDD, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// DB /7 FSTP m80fp Valid Valid Copy ST(0) to m80fp and pop register stack.
	{ "fstp", 0x0001, 0x00C5B800, { 0xDB, 0x00, 0x00 }, FCML_OP_MODRM_M_80, FCML_NA, FCML_NA, FCML_NA },
	// DD D8+i FSTP ST(i) Valid Valid Copy ST(0) to ST(i) and pop register stack.
	{ "fstp", 0x0001, 0x00D80001, { 0xDD, 0xD8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSTCW[] = {
	...
	{ NULL, 0x0001, 0x00D9B800, { 0x9B, 0xD9, 0x00 }, FCML_OP_MODRM_M_16_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ "fnstcw", 0x0001, 0x00C5B800, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_16_W, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSTENV[] = {
	...
	{ NULL, 0x0001, 0x00D9B000, { 0x9B, 0xD9, 0x00 }, FCML_OP_MODRM_M_14_28_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ "fnstenv", 0x0001, 0x00C5B000, { 0xD9, 0x00, 0x00 }, FCML_OP_MODRM_M_14_28_W, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSTSW[] = {
	...
	{ NULL, 0x0001, 0x00D9B800, { 0x9B, 0xDD, 0x00 }, FCML_OP_MODRM_M_16_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00EC0000, { 0x9B, 0xDF, 0xE0 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AX, FCML_EOS_WORD ), FCML_NA, FCML_NA, FCML_NA },
	...
	{ "fnstsw", 0x0001, 0x00C5B800, { 0xDD, 0x00, 0x00 }, FCML_OP_MODRM_M_16_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ "fnstsw", 0x0001, 0x00D80000, { 0xDF, 0xE0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AX, FCML_EOS_WORD ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSUB[] = {
	...
	{ NULL, 0x0001, 0x00C5A000, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /4 FSUB m64fp Valid Valid Subtract m64fp from ST(0) and store result in ST(0).
	{ NULL, 0x0001, 0x00C5A000, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 E0+i FSUB ST(0), ST(i) Valid Valid Subtract ST(i) from ST(0) and store result in ST(0).
	{ NULL, 0x0001, 0x00D80001, { 0xD8, 0xE0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DC E8+i FSUB ST(i), ST(0) Valid Valid Subtract ST(0) from ST(i) and store result in ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDC, 0xE8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DE E8+i FSUBP ST(i), ST(0) Valid Valid Subtract ST(0) from ST(i), store result in ST(i), and pop register stack.
	{ "fsubp", 0x0001, 0x00D80001, { 0xDE, 0xE8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA /4 FISUB m32int Valid Valid Subtract m32int from ST(0) and store result in ST(0).
	{ "fisub", 0x0001, 0x00C5A000, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /4 FISUB m16int Valid Valid Subtract m16int from ST(0) and store result in ST(0).
	{ "fisub", 0x0001, 0x00C5A000, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FSUBR[] = {
	...
	{ NULL, 0x0001, 0x00C5A800, { 0xD8, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DC /5 FSUBR m64fp Valid Valid Subtract ST(0) from m64fp and store result in ST(0).
	{ NULL, 0x0001, 0x00C5A800, { 0xDC, 0x00, 0x00 }, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA, FCML_NA },
	// D8 E8+i FSUBR ST(0), ST(i) Valid Valid Subtract ST(0) from ST(i) and store result in ST(0).
	{ NULL, 0x0001, 0x00D80001, { 0xD8, 0xE8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DC E0+i FSUBR ST(i), ST(0) Valid Valid Subtract ST(i) from ST(0) and store result in ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDC, 0xE0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DE E0+i FSUBRP ST(i), ST(0) Valid Valid Subtract ST(i) from ST(0), store result in ST(i), and pop register stack.
	{ "fsubrp", 0x0001, 0x00D80001, { 0xDE, 0xE0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_OP_EXPLICIT_REG( IRA_REG_FPU, _IRA_REG_ST0, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA },
	// DA /5 FISUBR m32int Valid Valid Subtract ST(0) from m32int and store result in ST(0).
	{ "fisubr", 0x0001, 0x00C5A800, { 0xDA, 0x00, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// DE /5 FISUBR m16int Valid Valid Subtract ST(0) from m16int and store result in ST(0).
	{ "fisubr", 0x0001, 0x00C5A800, { 0xDE, 0x00, 0x00 }, FCML_OP_MODRM_M_16, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FTST[] = {
	// D9 E4 FTST Valid Valid Compare ST(0) with 0.0.
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xE4, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FUCOM[] = {
	// DD E0+i FUCOM ST(i) Valid Valid Compare ST(0) with ST(i).
	{ NULL, 0x0001, 0x00D80001, { 0xDD, 0xE0, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// DD E8+i FUCOMP ST(i) Valid Valid Compare ST(0) with ST(i) and pop register stack.
	{ "fucomp", 0x0001, 0x00D80001, { 0xDD, 0xE8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// DA E9 FUCOMPP Valid Valid Compare ST(0) with ST(1) and pop register stack twice.
	{ "fucompp", 0x0001, 0x00D80000, { 0xDA, 0xE9, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FXAM[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xE5, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FXCH[] = {
	...
	{ NULL, 0x0001, 0x00D80001, { 0xD9, 0xC8, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_FPU, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FXRSTOR[] = {
	...
	{ NULL, 0x0001, 0x03D98800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA },
	// REX.W+ 0F AE /1 FXRSTOR64 m512byte A Valid N.E. Restore the x87 FPU, MMX, XMM, and MXCSR register state from m512byte.
	{ "fxrstor64", 0x0008, 0x04998800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FXSAVE[] = {
	...
	{ NULL, 0x0001, 0x03D98000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA },
	// REX.W+ 0F AE /0 FXSAVE64 m512byte A Valid N.E. Save the x87 FPU, MMX, XMM, and MXCSR register state to m512byte.
	{ "fxsave64", 0x0008, 0x04998000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FXTRACT[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF4, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FYL2X[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF1, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FYL2XP1[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0xD9, 0xF9, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_HADDPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x7C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 7C /r VHADDPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 7C /r VHADDPD ymm1,ymm2,ymm3/m256
	{ "vhaddpd", 0x1080, 0x00D88000, { 0x0F, 0x7C, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_HADDPS[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x7C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 7C /r VHADDPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.F2.0F 7C /r VHADDPS ymm1,ymm2,ymm3/m256
	{ "vhaddps", 0x2080, 0x00D88000, { 0x0F, 0x7C, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_HLT[] = {
	// F4 HLT A Valid Valid Halt
	{ NULL, 0x0001, 0x00C40000, { 0xF4, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_HSUBPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x7D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 7D /r VHSUBPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 7D /r VHSUBPD ymm1,ymm2,ymm3/m256
	{ "vhsubpd", 0x1080, 0x00D88000, { 0x0F, 0x7D, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_HSUBPS[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x7D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 7D /r VHSUBPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.F2.0F 7D /r VHSUBPS ymm1,ymm2,ymm3/m256
	{ "vhsubps", 0x2080, 0x00D88000, { 0x0F, 0x7D, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_IDIV[] = {
	...
	{ NULL, 0x0001, 0x00C5B800, { 0xF6, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AX, FCML_EOS_WORD ), FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5B800, { 0xF7, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ), FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_IMUL[] = {
	...
	{ NULL, 0x0001, 0x00C5A800, { 0xF6, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5A800, { 0xF7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xAF, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM,  FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x6B, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_OP_IB_EX_EOSA, FCML_NA },
	...
	{ NULL, 0x0001, 0x03C48000, { 0x69, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_OP_IMM_EOSA, FCML_NA },
	// REX.W + 69 /r id IMUL r64, r/m64, imm32 C Valid N.E. Quadword register r/m64 immediate doubleword.
	{ NULL, 0x0001, 0x04848000, { 0x69, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_OP_ID_EX_EOSA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_IN[] = {
	...
	{ NULL, 0x0001, 0x07C40000, { 0xE4, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// E5 ib IN AX, imm8 A Valid Valid Input word from imm8 I/O port address into AX.
	{ NULL, 0x0001, 0x01C40000, { 0xE5, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_WORD), FCML_OP_IB, FCML_NA, FCML_NA },
	// E5 ib IN EAX, imm8 A Valid Valid Input dword from imm8 I/O port address into EAX.
	{ NULL, 0x0001, 0x06C40000, { 0xE5, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_DWORD), FCML_OP_IB, FCML_NA, FCML_NA },
	// EC IN AL,DX B Valid Valid Input byte from I/O port in DX into AL.
	{ NULL, 0x0001, 0x07C40000, { 0xEC, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_BYTE ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	// ED IN AX,DX B Valid Valid Input word from I/O port in DX into AX.
	{ NULL, 0x0001, 0x01C40000, { 0xED, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_WORD ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	// ED IN EAX,DX B Valid Valid Input doubleword from I/O port in DX into EAX.
	{ NULL, 0x0001, 0x06C40000, { 0xED, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_DWORD ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INC[] = {
	...
	{ NULL, 0x0001, 0x00C58000, { 0xFE, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C58000, { 0xFF, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA },
	// 40+ rw** INC r16 B N.E. Valid Increment word register by 1.
	// 40+ rd INC r32 B N.E. Valid Increment doubleword register by 1.
	{ NULL, 0x0001, 0x00440001, { 0x40, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INS[] = {
	...
	{ NULL, 0x0001, 0x07C40000, { 0x6C, 0x00, 0x00 },
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ),
			FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x01C40000, { 0x6D, 0x00, 0x00 },
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_WORD, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ),
			FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x06C40000, { 0x6D, 0x00, 0x00 },
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_DWORD, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ),
			FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_NA, FCML_NA }
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INSERTPS[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x021 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A 21 /r ib VINSERTPS xmm1,xmm2,xmm3/m32,imm8
	{ "vinsertps", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x21 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INSERTQ[] = {
	// INSERTQ xmm1, xmm2, imm8, imm8 F2 0F 78 /r ib ib
	{ NULL, 0x2000, 0x00DA8000, { 0x0F, 0x78, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_OP_IB },
	// INSERTQ xmm1, xmm2 F2 0F 79 /r
	{ NULL, 0x2000, 0x00DA8000, { 0x0F, 0x79, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VINSERTF128[] = {
	...
	{ "vinsertf128", 0x10A0, 0x00EC8000, { 0x0F, 0x3A, 0x18 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INT[] = {
	// CC INT 3 A Valid Valid Interrupt 3—trap to debugger.
	{ NULL, 0x0001, 0x00C40000, { 0xCC, 0x00, 0x00 }, FCML_OP_EXPLICIT_IB( 3 ), FCML_NA, FCML_NA, FCML_NA },
	// CD ib INT imm8 B Valid Valid Interrupt vector number specified by immediate byte.
	{ NULL, 0x0001, 0x00C40000, { 0xCD, 0x00, 0x00 }, FCML_OP_IB, FCML_NA, FCML_NA, FCML_NA },
	// CE INTO A Invalid Valid Interrupt 4—if overflow flag is 1.
	{ "into", 0x0001, 0x00C40000, { 0xCE, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INVD[] = {
	...
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0x08, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INVLPG[] = {
	...
	{ NULL, 0x0001, 0x00D9B800, { 0x0F, 0x01, 0x00 }, FCML_OP_MODRM_M_UNDEF, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INVLPGA[] = {
	// INVLPGA rAX, ECX 0F 01 DF
	{ NULL, 0x0001, 0x00EC0000, { 0x0F, 0x01, 0xDF }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_EASA ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_ECX, FCML_EOS_DWORD ), FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_INVPCID[] = {
	...
	{ NULL, 0x1001, 0x806C8000, { 0x0F, 0x38, 0x82 }, FCML_OP_MODRM_R_32, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_OWORD, FCML_RMF_M ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x1001, 0x80AC8000, { 0x0F, 0x38, 0x82 }, FCML_OP_MODRM_R_64, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_OWORD, FCML_RMF_M ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_IRET[] = {
	...
	{ NULL, 0x0001, 0x01C40000, { 0xCF, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// CF IRETD A Valid Valid Interrupt return (32-bit operand size).
	{ "iretd", 0x0001, 0x02C40000, { 0xCF, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// REX.W + CF IRETQ A Valid N.E. Interrupt return (64-bit operand size).
	{ "iretq", 0x0001, 0x04C40000, { 0xCF, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LAHF[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0x9F, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LAR[] = {
	...
	{ NULL, 0x0001, 0x03D80000, { 0x0F, 0x02, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_WORD, FCML_RMF_RM ), FCML_NA, FCML_NA },
	// REX.W + 0F 02 /r LAR r64, r32/m16 A Valid N.E. r64 r32/m16 masked by 00FxFF00H
	{ NULL, 0x0001, 0x04980000, { 0x0F, 0x02, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_WORD, FCML_RMF_RM ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LDDQU[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0xF0, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_M_UNDEF, FCML_NA, FCML_NA },
	// VEX.128.F2.0F F0 /r VLDDQU xmm1, m128
	// VEX.256.F2.0F F0 /r VLDDQU ymm1, m256
	{ "vlddqu", 0x2180, 0x80D88000, { 0x0F, 0xF0, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_L, FCML_RMF_M ), FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VLDMXCSR[] = {
	// VEX.128.0F AE /2 VLDMXCSR m32
	{ NULL, 0x01C0, 0x80D99000, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_DWORD, FCML_RMF_M ), FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LDMXCSR[] = {
	...
	{ NULL, 0x0001, 0x00D99000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LDS[] = {
	...
	{ NULL, 0x0001, 0x00448000, { 0xC5, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA },
	...
	{ "lss", 0x0001, 0x00D88000, { 0x0F, 0xB2, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA },
	...
	{ "les", 0x0001, 0x00448000, { 0xC4, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA },
	...
	{ "lfs", 0x0001, 0x00D88000, { 0x0F, 0xB4, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA },
	...
	{ "lgs", 0x0001, 0x00D88000, { 0x0F, 0xB5, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_FAR_POINTER_INDIRECT, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LEA[] = {
	...
	{ NULL, 0x0001, 0x00C48000, { 0x8D, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_M_UNDEF, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LEAVE[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xC9, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LFENCE[] = {
	...
	{ NULL, 0x0001, 0x00EC0000, { 0x0F, 0xAE, 0xE8 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LLWPCB[] = {
	// LLWPCB reg32 8F RXB.09 0.1111.0.00 12 /0
	{ NULL, 0x0450, 0x00DB8000, { 0x09, 0x12, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA, FCML_NA },
	// LLWPCB reg64 8F RXB.09 1.1111.0.00 12 /0
	{ NULL, 0x0448, 0x00DB8000, { 0x09, 0x12, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LGDT[] = {
	// 0F 01 /2 LGDT m16&32 A N.E. Valid Load m into GDTR.
	{ NULL, 0x0001, 0x03D99000, { 0x0F, 0x01, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, (FCML_EOS_WORD + FCML_EOS_DWORD), FCML_RMF_M ), FCML_NA, FCML_NA, FCML_NA },
	// 0F 01 /2 LGDT m16&64 A Valid N.E. Load m into GDTR.
	{ NULL, 0x0001, 0x04999000, { 0x0F, 0x01, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, (FCML_EOS_WORD + FCML_EOS_QWORD), FCML_RMF_M ), FCML_NA, FCML_NA, FCML_NA },
	// 0F 01 /3 LIDT m16&32 A N.E. Valid Load m into IDTR.
	{ "lidt", 0x0001, 0x04999800, { 0x0F, 0x01, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, (FCML_EOS_WORD + FCML_EOS_DWORD), FCML_RMF_M ), FCML_NA, FCML_NA, FCML_NA },
	// 0F 01 /3 LIDT m16&64 A Valid N.E. Load m into IDTR.
	{ "lidt", 0x0001, 0x04980000, { 0x0F, 0x01, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, (FCML_EOS_WORD + FCML_EOS_QWORD), FCML_RMF_M ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LLDT[] = {
	...
	{ NULL, 0x0001, 0x00D99000, { 0x0F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LMSW[] = {
	...
	{ NULL, 0x0001, 0x00D9B000, { 0x0F, 0x01, 0x00 }, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LOOP[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xE2, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA },
	// E1 cb LOOPE rel8 A Valid Valid Decrement count; jump short if count 0 and ZF = 1.
	{ "loope", 0x0001, 0x00C40000, { 0xE1, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA },
	// E0 cb LOOPNE rel8 A Valid Valid Decrement count; jump short if count 0 and ZF = 0.
	{ "loopne", 0x0001, 0x00C40000, { 0xE0, 0x00, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_R_8, FCML_NA, FCML_NA, FCML_NA }
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LWPINS[] = {
	...
	{ NULL, 0x0450, 0x00D98000, { 0x0A, 0x12, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_OP_ID, FCML_NA },
	// LWPINS reg64.vvvv, reg/mem32, imm32 8F RXB.0A 1.src1.0.00 12 /0 /imm32
	{ NULL, 0x0448, 0x00D98000, { 0x0A, 0x12, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_OP_ID, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LWPVAL[] = {
	...
	{ NULL, 0x0450, 0x00D98800, { 0x0A, 0x12, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_OP_ID, FCML_NA },
	// LWPVAL reg64.vvvv, reg/mem32, imm32 8F RXB.0A 1.src1.0.00 12 /1 /imm32
	{ NULL, 0x0448, 0x00D98800, { 0x0A, 0x12, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_OP_ID, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LSL[] = {
	...
	{ NULL, 0x0001, 0x03D80000, { 0x0F, 0x03, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_WORD, FCML_RMF_RM ), FCML_NA, FCML_NA },
	// REX.W + 0F 03 /r LSL r64, r32/m16* A Valid Valid Load: r64 segment limit, selector r32/m16
	{ NULL, 0x0001, 0x04980000, { 0x0F, 0x03, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_WORD, FCML_RMF_RM ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LTR[] = {
	...
	{ NULL, 0x0001, 0x00D99800, { 0x0F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MASKMOVDQU[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xF7, 0x00 }, FCML_OP_R( IRA_REG_SIMD, FCML_EOS_OWORD ), FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.128.66.0F F7 /r VMASKMOVDQU xmm1,xmm2
	{ "vmaskmovdqu", 0x11C0, 0x00D88000, { 0x0F, 0xF7, 0x00 }, FCML_OP_R( IRA_REG_SIMD, FCML_EOS_OWORD ), FCML_OP_RM( IRA_REG_SIMD, _IRA_OS_XMMWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VMASKMOVP[] = {
	...
	{ "vmaskmovps", 0x1080, 0x00EC8000, { 0x0F, 0x38, 0x2C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_M_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38 2D /r VMASKMOVPD xmm1,xmm2,m128
	// VEX.NDS.256.66.0F38 2D /r VMASKMOVPD ymm1,ymm2,m256
	{ "vmaskmovpd", 0x1080, 0x00EC8000, { 0x0F, 0x38, 0x2D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_M_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38 2E /r VMASKMOVPS m128,xmm1,xmm2
	// VEX.NDS.256.66.0F38 2E /r VMASKMOVPS m256,ymm1,ymm2
	{ "vmaskmovps", 0x1080, 0x00EC8000, { 0x0F, 0x38, 0x2E }, FCML_OP_MODRM_M_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_R_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38 2F /r VMASKMOVPD m128,xmm1,xmm2
	// VEX.NDS.256.66.0F38 2F /r VMASKMOVPD m256,ymm1,ymm2
	{ "vmaskmovpd", 0x1080, 0x00EC8000, { 0x0F, 0x38, 0x2F }, FCML_OP_MODRM_M_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_R_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMASKMOVD[] = {
	...
	{ "vpmaskmovd", 0x1090, 0x80EC8000, { 0x0F, 0x38, 0x8C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_M_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38.W1 8C /r VPMASKMOVQ xmm1,xmm2,m128
	// VEX.NDS.256.66.0F38.W1 8C /r VPMASKMOVQ ymm1,ymm2,m256
	{ "vpmaskmovq", 0x1088, 0x80EC8000, { 0x0F, 0x38, 0x8C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_M_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38.W0 8E /r VPMASKMOVD m128,xmm1,xmm2
	// VEX.NDS.256.66.0F38.W0 8E /r VPMASKMOVD m256,ymm1,ymm2
	{ "vpmaskmovd", 0x1090, 0x80EC8000, { 0x0F, 0x38, 0x8E }, FCML_OP_MODRM_M_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_R_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38.W1 8E /r VPMASKMOVQ m128,xmm1,xmm2
	// VEX.NDS.256.66.0F38.W1 8E /r VPMASKMOVQ m256,ymm1,ymm2
	{ "vpmaskmovq", 0x1088, 0x80EC8000, { 0x0F, 0x38, 0x8E }, FCML_OP_MODRM_M_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_R_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MASKMOVQ[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xF7, 0x00 }, FCML_OP_R( IRA_REG_SIMD, FCML_EOS_QWORD ), FCML_OP_RM( IRA_REG_SIMD, _IRA_OS_MMWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MAXPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 5F /r VMAXPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 5F /r VMAXPD ymm1,ymm2,ymm3/m256
	{ "vmaxpd", 0x1080, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MAXPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 5F /r VMAXPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.0F 5F /r VMAXPS ymm1,ymm2,ymm3/m256
	{ "vmaxps", 0x0080, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MAXSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 5F /r VMAXSD xmm1,xmm2,xmm3/m64
	{ "vmaxsd", 0x20C0, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MAXSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 5F /r VMAXSS xmm1, xmm2, xmm3/m32
	{ "vmaxss", 0x40C0, 0x00D88000, { 0x0F, 0x5F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MFENCE[] = {
	...
	{ NULL, 0x0001, 0x00EC0000, { 0x0F, 0xAE, 0xF0 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MINPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 5D /r VMINPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 5D /r VMINPD ymm1,ymm2,ymm3/m256
	{ "vminpd", 0x1080, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MINPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 5D /r VMINPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.0F 5D /r VMINPS ymm1,ymm2,ymm3/m256
	{ "vminps", 0x0080, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MINSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 5D /r VMINSD xmm1, xmm2, xmm3/m64
	{ "vminsd", 0x20C0, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MINSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 5D /r VMINSS xmm1,xmm2,xmm3/m32
	{ "vminss", 0x40C0, 0x00D88000, { 0x0F, 0x5D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MONITOR[] = {
	...
	{ NULL, 0x0001, 0x006C0000, { 0x0F, 0x01, 0xC8 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_DWORD ),
		FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_ECX, FCML_EOS_DWORD ),
		FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EDX, FCML_EOS_DWORD ), FCML_NA },
	{ NULL, 0x0001, 0x00AC0000, { 0x0F, 0x01, 0xC8 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_RAX, FCML_EOS_QWORD ),
		FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_RCX, FCML_EOS_QWORD ),
		FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_RDX, FCML_EOS_QWORD ), FCML_NA }
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOV[] = {
	...
	{ NULL, 0x0001, 0x00C48000, { 0x88, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x89, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 8A /r MOV r8,r/m8 B Valid Valid Move r/m8 to r8.
	// REX + 8A /r MOV r8***,r/m8*** B Valid N.E. Move r/m8 to r8.
	{ NULL, 0x0001, 0x00C48000, { 0x8A, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x8B, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA },
	// 8C /r MOV r/m16,Sreg** A Valid Valid Move segment register to r/m16.
	{ NULL, 0x0001, 0x03C48000, { 0x8C, 0x00, 0x00 }, FCML_OP_MODRM_RM_16_W, FCML_OP_R( IRA_REG_SEG, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x04848000, { 0x8C, 0x00, 0x00 }, FCML_OP_MODRM_RM_64_W, FCML_OP_R( IRA_REG_SEG, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	// 8E /r MOV Sreg,r/m16** RM Valid Valid Move r/m16 to segment register.
	{ NULL, 0x0001, 0x03C48000, { 0x8E, 0x00, 0x00 }, FCML_OP_R( IRA_REG_SEG, FCML_EOS_WORD ), FCML_OP_MODRM_RM_16_W, FCML_NA, FCML_NA },
	// REX.W + 8E /r MOV Sreg,r/m64** RM Valid Valid Move lower 16 bits of r/m64 to segment register.
	{ NULL, 0x0001, 0x04848000, { 0x8E, 0x00, 0x00 }, FCML_OP_R( IRA_REG_SEG, FCML_EOS_WORD ), FCML_OP_MODRM_RM_64_W, FCML_NA, FCML_NA },
	// A0 MOV AL,moffs8* C Valid Valid Move byte at (seg:offset) to AL.
	// REX.W + A0 MOV AL,moffs8* C Valid N.E. Move byte at (offset) to AL.
	{ NULL, 0x0001, 0x00C40000, { 0xA0, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_BYTE ), FCML_OP_SEGMENT_RELATIVE_OFFSET( FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA1, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_EOSA ), FCML_OP_SEGMENT_RELATIVE_OFFSET( FCML_EOS_EOSA, FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ), FCML_NA, FCML_NA },
	// A2 MOV moffs8,AL D Valid Valid Move AL to (seg:offset).
	// REX.W + A2 MOV moffs8***,AL D Valid N.E. Move AL to (offset).
	{ NULL, 0x0001, 0x00C40000, { 0xA2, 0x00, 0x00 }, FCML_OP_SEGMENT_RELATIVE_OFFSET( FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA3, 0x00, 0x00 }, FCML_OP_SEGMENT_RELATIVE_OFFSET( FCML_EOS_EOSA, FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_EOSA ), FCML_NA, FCML_NA },
	// B0+ rb MOV r8, imm8 E Valid Valid Move imm8 to r8.
	// REX + B0+ rb MOV r8***, imm8 E Valid N.E. Move imm8 to r8.
	{ NULL, 0x0001, 0x00C40001, { 0xB0, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_BYTE ) | FCML_OA_W, FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C40001, { 0xB8, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// C6 /0 MOV r/m8, imm8 F Valid Valid Move imm8 to r/m8.
	// REX + C6 /0 MOV r/m8***, imm8 F Valid N.E. Move imm8 to r/m8.
	{ NULL, 0x0001, 0x00C58000, { 0xC6, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// C7 /0 MOV r/m16, imm16 F Valid Valid Move imm16 to r/m16.
	// C7 /0 MOV r/m32, imm32 F Valid Valid Move imm32 to r/m32.
	{ NULL, 0x0001, 0x03C58000, { 0xC7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + C7 /0 MOV r/m64, imm32 F Valid N.E. Move imm32 sign extended to 64-bits to r/m64.
	{ NULL, 0x0001, 0x04858000, { 0xC7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOV_CR[] = {
	...
	{ NULL, 0x0001, 0x00588000, { 0x0F, 0x20, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_R( IRA_REG_CR, FCML_EOS_DWORD ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00988000, { 0x0F, 0x20, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_R( IRA_REG_CR, FCML_EOS_QWORD ), FCML_NA, FCML_NA },
	// 0F 22 /r MOV CR0–CR7, r32 A N.E. Valid Move r32 to control register
	{ NULL, 0x0001, 0x00588000, { 0x0F, 0x22, 0x00 }, FCML_OP_R( IRA_REG_CR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00988000, { 0x0F, 0x22, 0x00 }, FCML_OP_R( IRA_REG_CR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOV_DR[] = {
	...
	{ NULL, 0x0001, 0x00588000, { 0x0F, 0x21, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_R( IRA_REG_DR, FCML_EOS_DWORD ), FCML_NA, FCML_NA },
	// 0F 21/r MOV r64, DR0–DR7 A Valid N.E. Move extended debug register to r64.
	{ NULL, 0x0001, 0x00988000, { 0x0F, 0x21, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_R( IRA_REG_DR, FCML_EOS_QWORD ), FCML_NA, FCML_NA },
	// 0F 23 /r MOV DR0–DR7, r32 A N.E. Valid Move r32 to debug register
	{ NULL, 0x0001, 0x00588000, { 0x0F, 0x23, 0x00 }, FCML_OP_R( IRA_REG_DR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// 0F 23 /r MOV DR0–DR7, r64 A Valid N.E. Move r64 to extended debug register.
	{ NULL, 0x0001, 0x00988000, { 0x0F, 0x23, 0x00 }, FCML_OP_R( IRA_REG_DR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVAPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x28, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 29 /r MOVAPD xmm2/m128, xmm1 B Valid Valid Move packed doubleprecision floating-point values from xmm1 to xmm2/m128.
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x29, 0x00 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.66.0F 28 /r VMOVAPD xmm1,xmm2/m128
	// VEX.256.66.0F 28 /r VMOVAPD ymm1,ymm2/m256
	{ "vmovapd", 0x1180, 0x00D88000, { 0x0F, 0x28, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	// VEX.128.66.0F 29 /r VMOVAPD xmm2/m128,xmm1
	// VEX.256.66.0F 29 /r VMOVAPD ymm2/m256,ymm1
	{ "vmovapd", 0x1180, 0x00D88000, { 0x0F, 0x29, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_W, FCML_OP_MODRM_R_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVAPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x28, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 0F 29 /r MOVAPS xmm2/m128, xmm1 B Valid Valid Move packed singleprecision floating-point values from xmm1 to xmm2/m128.
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x29, 0x00 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.0F 28 /r VMOVAPS xmm1,xmm2/m128
	// VEX.256.0F 28 /r VMOVAPS ymm1,ymm2/m256
	{ "vmovaps", 0x0180, 0x00D88000, { 0x0F, 0x28, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	// VEX.128.0F 29 /r VMOVAPS xmm2/m128,xmm1
	// VEX.256.0F 29 /r VMOVAPS ymm2/m256,ymm1
	{ "vmovaps", 0x0180, 0x00D88000, { 0x0F, 0x29, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_W, FCML_OP_MODRM_R_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVBE[] = {
	...
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x38, 0xF0 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x38, 0xF1 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVD[] = {
	...
	{ NULL, 0x0001, 0x03D88000, { 0x0F, 0x6E, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// REX.W + 0F 6E /r MOVQ mm, r/m64 A Valid N.E. Move quadword from r/m64 to mm.
	{ "movq", 0x0001, 0x04988000, { 0x0F, 0x6E, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA },
	// 0F 7E /r MOVD r/m32, mm B Valid Valid Move doubleword from mm to r/m32.
	{ NULL, 0x0001, 0x03D88000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_RM_32_W, FCML_OP_MODRM_R_MMX, FCML_NA, FCML_NA },
	// REX.W + 0F 7E /r MOVQ r/m64, mm B Valid N.E. Move quadword from mm to r/m64.
	{ "movq", 0x0001, 0x04988000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_RM_64_W, FCML_OP_MODRM_R_MMX, FCML_NA, FCML_NA },
	// 66 0F 6E /r MOVD xmm, r/m32 A Valid Valid Move doubleword from r/m32 to xmm.
	{ NULL, 0x1001, 0x03D88000, { 0x0F, 0x6E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// 66 REX.W 0F 6E /r MOVQ xmm, r/m64 A Valid N.E. Move quadword from r/m64 to xmm.
	{ "movq", 0x1001, 0x04988000, { 0x0F, 0x6E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA },
	// 66 0F 7E /r MOVD r/m32, xmm B Valid Valid Move doubleword from xmm register to r/m32.
	{ NULL, 0x1001, 0x03D88000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_RM_32_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// 66 REX.W 0F 7E /r MOVQ r/m64, xmm B Valid N.E. Move quadword from xmm register to r/m64.
	{ "movq", 0x1001, 0x04988000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_RM_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.66.0F.W0 6E /r VMOVD xmm1,r32/m32
	{ "vmovd", 0x11D0, 0x03588000, { 0x0F, 0x6E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// VEX.128.66.0F.W1 6E /r VMOVQ xmm1,r64/m64
	{ "vmovq", 0x11C8, 0x04988000, { 0x0F, 0x6E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F.W0 7E /r VMOVD r32/m32,xmm1
	{ "vmovd", 0x11D0, 0x03588000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_RM_32_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.66.0F.W1 7E /r VMOVQ r64/m64,xmm1
	{ "vmovq", 0x11C8, 0x04988000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_RM_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVDDUP[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.F2.0F 12 /r VMOVDDUP xmm1,xmm2/m64
	{ "vmovddup", 0x21C0, 0x00D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.256.F2.0F 12 /r VMOVDDUP ymm1,ymm2/m256
	{ "vmovddup", 0x21A0, 0x00D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVDQA[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x6F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 7F /r MOVDQA xmm2/m128, xmm1 B Valid Valid Move aligned double quadword from xmm1 to xmm2/m128.
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x7F, 0x00 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.66.0F 6F /r VMOVDQA xmm1,xmm2/m128
	// VEX.256.66.0F 6F /r VMOVDQA ymm1,ymm2/m256
	{ "vmovdqa", 0x1180, 0x00D88000, { 0x0F, 0x6F, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	// VEX.128.66.0F 7F /r VMOVDQA xmm2/m128,xmm1
	// VEX.256.66.0F 7F /r VMOVDQA ymm2/m256,ymm1
	{ "vmovdqa", 0x1180, 0x00D88000, { 0x0F, 0x7F, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_W, FCML_OP_MODRM_R_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVDQU[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x6F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// F3 0F 7F /r MOVDQU xmm2/m128, xmm1 B Valid Valid Move unaligned double quadword from xmm1 to xmm2/m128.
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x7F, 0x00 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 6F /r VMOVDQU xmm1,xmm2/m128
	// VEX.256.F3.0F 6F /r VMOVDQU ymm1,ymm2/m256
	{ "vmovdqu", 0x4180, 0x00D88000, { 0x0F, 0x6F, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 7F /r VMOVDQU xmm2/m128,xmm1
	// VEX.256.F3.0F 7F /r VMOVDQU ymm2/m256,ymm1
	{ "vmovdqu", 0x4180, 0x00D88000, { 0x0F, 0x7F, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_W, FCML_OP_MODRM_R_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVDQ2Q[] = {
	...
	{ NULL, 0x2001, 0x00DA8000, { 0x0F, 0xD6, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVHLPS[] = {
	...
	{ NULL, 0x0001, 0x00DA8000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 12 /r VMOVHLPS xmm1, xmm2, xmm3
	{ "vmovhlps", 0x00C0, 0x00DA8000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_L, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVHPD[] = {
	...
	{ NULL, 0x1001, 0x80D88000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ), FCML_NA, FCML_NA },
	// 66 0F 17 /r MOVHPD m64, xmm B Valid Valid Move double-precision floating-point value from high quadword of xmm to m64.
	{ NULL, 0x1001, 0x80D88000, { 0x0F, 0x17, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 16 /r VMOVHPD xmm2,xmm1,m64
	{ "vmovhpd", 0x10C0, 0x80D88000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA },
	// VEX128.66.0F 17/r VMOVHPD m64, xmm1
	{ "vmovhpd", 0x11C0, 0x80D88000, { 0x0F, 0x17, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_64_W, FCML_OP_MODRM_R_SIMD_L_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVHPS[] = {
	...
	{ NULL, 0x0001, 0x80D88000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x80D88000, { 0x0F, 0x17, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 16 /r VMOVHPS xmm2,xmm1,m64
	{ "vmovhps", 0x00C0, 0x80D88000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA },
	// VEX.128.0F 17 /r VMOVHPS m64,xmm1
	{ "vmovhps", 0x01C0, 0x80D88000, { 0x0F, 0x17, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_64_W, FCML_OP_MODRM_R_SIMD_L_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVLHPS[] = {
	...
	{ NULL, 0x0001, 0x00DA8000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 16 /r VMOVLHPS xmm1,xmm2,xmm3
	{ "vmovlhps", 0x00C0, 0x00DA8000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVLPD[] = {
	...
	{ NULL, 0x1001, 0x80D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x1001, 0x80D88000, { 0x0F, 0x13, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 12 /r VMOVLPD xmm2,xmm1,m64
	{ "vmovlpd", 0x10C0, 0x80D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA },
	// VEX.128.66.0F 13 /r VMOVLPD m64,xmm1
	{ "vmovlpd", 0x11C0, 0x80D88000, { 0x0F, 0x13, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_64_W, FCML_OP_MODRM_R_SIMD_L_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVLPS[] = {
	...
	{ NULL, 0x0001, 0x80D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x80D88000, { 0x0F, 0x13, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 12 /r VMOVLPS xmm2,xmm1,m64
	{ "vmovlps", 0x00C0, 0x80D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_M_64, FCML_NA },
	// VEX.128.0F 13 /r VMOVLPS m64, xmm1
	{ "vmovlps", 0x01C0, 0x80D88000, { 0x0F, 0x13, 0x00 }, FCML_OP_MODRM_M_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVMSKPD[] = {
	...
	{ NULL, 0x1001, 0x005A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	{ NULL, 0x1001, 0x009A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.128.66.0F 50 /r VMOVMSKPD reg,xmm2
	// VEX.256.66.0F 50 /r VMOVMSKPD reg,ymm2
	{ "vmovmskpd", 0x1180, 0x005A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_L, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	{ "vmovmskpd", 0x1180, 0x009A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_L, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVMSKPS[] = {
	...
	{ NULL, 0x0001, 0x005A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x009A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.128.0F 50 /r VMOVMSKPS reg,xmm2
	// VEX.256.0F 50 /r VMOVMSKPS reg,ymm2
	{ "vmovmskps", 0x0180, 0x005A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_L, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	{ "vmovmskps", 0x0180, 0x009A8000, { 0x0F, 0x50, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_L, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTDQA[] = {
	...
	{ NULL, 0x1001, 0x80EC8000, { 0x0F, 0x38, 0x2A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_OWORD, FCML_RMF_M ), FCML_NA, FCML_NA },
	// VEX.128.66.0F38 2A /r VMOVNTDQA xmm1,m128
	{ "vmovntdqa", 0x11C0, 0x80EC8000, { 0x0F, 0x38, 0x2A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_M_128, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 2A /r VMOVNTDQA ymm1,m256
	{ "vmovntdqa", 0x11A0, 0x80EC8000, { 0x0F, 0x38, 0x2A }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_M_256, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTDQ[] = {
	...
	{ NULL, 0x1001, 0x80D88000, { 0x0F, 0xE7, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_OWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM , FCML_NA, FCML_NA },
	// VEX.128.66.0F E7 /r VMOVNTDQ m128,xmm1
	{ "vmovntdq", 0x11C0, 0x80D88000, { 0x0F, 0xE7, 0x00 }, FCML_OP_MODRM_M_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTI[] = {
	...
	{ NULL, 0x0001, 0x83D88000, { 0x0F, 0xC3, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_DWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_32 , FCML_NA, FCML_NA },
	// REX.W + 0F C3 /rMOVNTI m64, r64 A Valid N.E. Move quadword from r64 to m64 using non-temporal hint.
	{ NULL, 0x0001, 0x84988000, { 0x0F, 0xC3, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_64 , FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTPD[] = {
	...
	{ NULL, 0x1001, 0x80D88000, { 0x0F, 0x2B, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_OWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM , FCML_NA, FCML_NA },
	// VEX.128.66.0F 2B /r VMOVNTPD m128,xmm1
	{ "vmovntpd", 0x11C0, 0x80D88000, { 0x0F, 0x2B, 0x00 }, FCML_OP_MODRM_M_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTPS[] = {
	...
	{ NULL, 0x0001, 0x80D88000, { 0x0F, 0x2B, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_OWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM , FCML_NA, FCML_NA },
	// VEX.128.0F 2B /r VMOVNTPS m128, xmm1
	{ "vmovntps", 0x01C0, 0x80D88000, { 0x0F, 0x2B, 0x00 }, FCML_OP_MODRM_M_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTSD[] = {
	// MOVNTSD mem64, xmm F2 0F 2B /r
	{ NULL, 0x2000, 0x80D88000, { 0x0F, 0x2B, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM , FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTSS[] = {
	// MOVNTSS mem32, xmm F3 0F 2B /r
	{ NULL, 0x4000, 0x80D88000, { 0x0F, 0x2B, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_DWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_XMM , FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVNTQ[] = {
	...
	{ NULL, 0x0001, 0x80D88000, { 0x0F, 0xE7, 0x00 }, FCML_OP_RM( IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_QWORD, FCML_RMF_M ) | FCML_OA_W, FCML_OP_MODRM_R_MMX , FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVQ[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x6F, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 7F /r MOVQ mm/m64, mm B Valid Valid Move quadword from mm to mm/m64.
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x7F, 0x00 }, FCML_OP_MODRM_RM_MMX_W, FCML_OP_MODRM_R_MMX, FCML_NA, FCML_NA },
	// F3 0F 7E MOVQ xmm1, xmm2/m64 A Valid Valid Move quadword from xmm2/mem64 to xmm1.
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// 66 0F D6 MOVQ xmm2/m64, xmm1 B Valid Valid Move quadword from xmm1 to xmm2/mem64.
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xD6, 0x00 }, FCML_OP_MODRM_RM_XMM_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 7E /r VMOVQ xmm1,xmm2
	// VEX.128.F3.0F 7E /r VMOVQ xmm1,m64
	{ "vmovq", 0x41C0, 0x00D88000, { 0x0F, 0x7E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F D6 /r VMOVQ xmm1/m64,xmm2
	{ "vmovq", 0x41C0, 0x00D88000, { 0x0F, 0xD6, 0x00 }, FCML_OP_MODRM_RM_XMM_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVQ2DQ[] = {
	...
	{ NULL, 0x4001, 0x00DA8000, { 0x0F, 0xD6, 0x00 }, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_MODRM_R_MMX, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_RM_XMM_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 10 /r VMOVSD xmm1,xmm2,xmm3
	{ "vmovsd", 0x20C0, 0x00DA8000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA },
	// VEX.NDS.128.F2.0F 11 /r VMOVSD xmm1,xmm2,xmm3
	{ "vmovsd", 0x20C0, 0x00DA8000, { 0x0F, 0x11, 0x00 }, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_R_XMM, FCML_NA },
	// VEX.128.F2.0F 10 /r VMOVSD xmm1,m64
	{ "vmovsd", 0x21C0, 0x80D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_M_64, FCML_NA, FCML_NA },
	// VEX.128.F2.0F 11 /r VMOVSD m64,xmm1
	{ "vmovsd", 0x21C0, 0x80D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_M_64_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVSHDUP[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 16 /r VMOVSHDUP xmm1,xmm2/m128
	// VEX.256.F3.0F 16 /r VMOVSHDUP ymm1,ymm2/m256
	{ "vmovshdup", 0x4180, 0x00D88000, { 0x0F, 0x16, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVSLDUP[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 12 /r VMOVSLDUP xmm1,xmm2/m128
	// VEX.256.F3.0F 12 /r VMOVSLDUP ymm1,ymm2/m256
	{ "vmovsldup", 0x4180, 0x00D88000, { 0x0F, 0x12, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// F3 0F 11 /r MOVSS xmm2/m32, xmm B Valid Valid Move scalar single-precision floating-point value from xmm1 register to
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_RM_XMM_32_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 10 /r VMOVSS xmm1,xmm2,xmm3
	{ "vmovss", 0x40C0, 0x00DA8000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA },
	// VEX.NDS.128.F3.0F 11 /r VMOVSS xmm1,xmm2,xmm3
	{ "vmovss", 0x40C0, 0x00DA8000, { 0x0F, 0x11, 0x00 }, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_R_XMM, FCML_NA },
	// VEX.128.F3.0F 10 /r VMOVSS xmm1,m32
	{ "vmovss", 0x41C0, 0x80D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA },
	// VEX.128.F3.0F 11 /r VMOVSS m32,xmm1
	{ "vmovss", 0x41C0, 0x80D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_M_32_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVSX[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xBE, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	// 0F BF /r MOVSX r32, r/m16 A Valid Valid Move word to doubleword, with sign-extension.
	{ NULL, 0x0001, 0x03D88000, { 0x0F, 0xBF, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA },
	// REX.W + 0F BF /r MOVSX r64, r/m16 A Valid N.E. Move word to quadword with sign-extension.
	{ NULL, 0x0001, 0x04988000, { 0x0F, 0xBF, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA },
	// REX.W** + 63 /r MOVSXD r64, r/m32 A Valid N.E. Move doubleword to quadword with signextension.
	{ "movsxd", 0x0001, 0x04848000, { 0x63, 0x00, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVUPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 11 /r MOVUPD xmm2/m128, xmm B Valid Valid Move packed doubleprecision floating-point values from xmm1 to xmm2/m128.
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.66.0F 10 /r VMOVUPD xmm1,xmm2/m128
	// VEX.256.66.0F 10 /r VMOVUPD ymm1,ymm2/m256
	{ "vmovupd", 0x1180, 0x00D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	// VEX.128.66.0F 11 /r VMOVUPD xmm2/m128,xmm1
	// VEX.256.66.0F 11 /r VMOVUPD ymm2/m256,ymm1
	{ "vmovupd", 0x1180, 0x00D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_W, FCML_OP_MODRM_R_SIMD_L, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVUPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 0F 11 /r MOVUPS xmm2/m128, xmm1 B Valid Valid Move packed singleprecision floating-point values from xmm1 to xmm2/m128.
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_NA, FCML_NA },
	// VEX.128.0F 10 /r VMOVUPS xmm1,xmm2/m128
	// VEX.256.0F 10 /r VMOVUPS ymm1,ymm2/m256
	{ "vmovups", 0x0180, 0x00D88000, { 0x0F, 0x10, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	// VEX.128.0F 11 /r VMOVUPS xmm2/m128,xmm1
	// VEX.256.0F 11 /r VMOVUPS ymm2/m256,ymm1
	{ "vmovups", 0x0180, 0x00D88000, { 0x0F, 0x11, 0x00 }, FCML_OP_MODRM_RM_SIMD_L_W, FCML_OP_MODRM_R_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MOVZX[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xB6, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	// 0F B7 /r MOVZX r32, r/m16 A Valid Valid Move word to doubleword, zero-extension.
	{ NULL, 0x0001, 0x03D88000, { 0x0F, 0xB7, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA },
	// REX.W + 0F B7 /r MOVZX r64, r/m16 A Valid N.E. Move word to quadword, zero-extension.
	{ NULL, 0x0001, 0x04988000, { 0x0F, 0xB7, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MPSADBW[] = {
	...
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x42 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A 42 /r ib VMPSADBW xmm1,xmm2,xmm3/m128,imm8
	{ "vmpsadbw", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x42 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// AVX2
	// VEX.NDS.256.66.0F3A.WIG 42 /r ib VMPSADBW ymm1,ymm2,ymm3/m256,imm8
	{ "vmpsadbw", 0x10A0, 0x00EC8000, { 0x0F, 0x3A, 0x42 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MUL[] = {
	...
	{ NULL, 0x0001, 0x00C5A000, { 0xF6, 0x00, 0x00 }, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5A000, { 0xF7, 0x00, 0x00 }, FCML_OP_MODRM_RM, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MULPD[] = {
	...
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 59 /r VMULPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 59 /r VMULPD ymm1,ymm2,ymm3/m256
	{ "vmulpd", 0x1080, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MULPS[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 59 /r VMULPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.0F 59 /r VMULPS ymm1,ymm2,ymm3/m256
	{ "vmulps", 0x0080, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MULSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.NDS.128.F2.0F 59 /r VMULSD xmm1,xmm2,xmm3/m64
	{ "vmulsd", 0x20C0, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MULSS[] = {
	...
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.128.F3.0F 59 /r VMULSS xmm1,xmm2,xmm3/m32
	{ "vmulss", 0x40C0, 0x00D88000, { 0x0F, 0x59, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MWAIT[] = {
	...
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x01, 0xC9 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_NEG[] = {
	...
	{ NULL, 0x0001, 0x00C59800, { 0xF6, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C59800, { 0xF7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_NOP[] = {
	// 90 NOP NP Valid Valid One byte no-operation instruction.
	{ NULL, 0x0001, 0x00C40000, { 0x90, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D98000, { 0x0F, 0x1F, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_NOT[] = {
	...
	{ NULL, 0x0001, 0x00C59000, { 0xF6, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C59000, { 0xF7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_OR[] = {
	// 0C ib OR AL, imm8 I Valid Valid AL OR imm8.
	{ NULL, 0x0001, 0x00C40000, { 0x0C, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 0D iw OR AX, imm16 I Valid Valid AX OR imm16.
	// 0D id OR EAX, imm32 I Valid Valid EAX OR imm32.
	{ NULL, 0x0001, 0x03C40000, { 0x0D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 0D id OR RAX, imm32 I Valid N.E. RAX OR imm32 (sign-extended).
	{ NULL, 0x0001, 0x04840000, { 0x0D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 80 /1 ib OR r/m8, imm8 MI Valid Valid r/m8 OR imm8.
	// REX + 80 /1 ib OR r/m8*, imm8 MI Valid N.E. r/m8 OR imm8.
	{ NULL, 0x0001, 0x00C58800, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// 81 /1 iw OR r/m16, imm16 MI Valid Valid r/m16 OR imm16.
	// 81 /1 id OR r/m32, imm32 MI Valid Valid r/m32 OR imm32.
	{ NULL, 0x0001, 0x03C58800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /1 id OR r/m64, imm32 MI Valid N.E. r/m64 OR imm32 (sign-extended).
	{ NULL, 0x0001, 0x04858800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x03C58800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /1 ib OR r/m64, imm8 MI Valid N.E. r/m64 OR imm8 (sign-extended).
	{ NULL, 0x0001, 0x04858800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 08 /r OR r/m8, r8 MR Valid Valid r/m8 OR r8.
	// REX + 08 /r OR r/m8*, r8* MR Valid N.E. r/m8 OR r8.
	{ NULL, 0x0001, 0x00C48000, { 0x08, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x09, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 0A /r OR r8, r/m8 RM Valid Valid r8 OR r/m8.
	// REX + 0A /r OR r8*, r/m8* RM Valid N.E. r8 OR r/m8.
	{ NULL, 0x0001, 0x00C48000, { 0x0A, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x0B, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ORPD[] = {
	// 66 0F 56 /r ORPD xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0x56, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F 56 /r VORPD xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F 56 /r VORPD ymm1,ymm2,ymm3/m256
	{ "vorpd", 0x1080, 0x00D88000, { 0x0F, 0x56, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ORPS[] = {
	// 0F 56 /r ORPS xmm1, xmm2/m128
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x56, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.0F 56 /r VORPS xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.0F 56 /r VORPS ymm1,ymm2,ymm3/m256
	{ "vorps", 0x0080, 0x00D88000, { 0x0F, 0x56, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_OUT[] = {
	...
	{ NULL, 0x0001, 0x07C40000, { 0xE6, 0x00, 0x00 }, FCML_OP_IB, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// E7 ib OUT imm8, AX I Valid Valid Output word in AX to I/O port address imm8.
	{ NULL, 0x0001, 0x01C40000, { 0xE7, 0x00, 0x00 }, FCML_OP_IB, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_WORD), FCML_NA, FCML_NA },
	// E7 ib OUT imm8, EAX I Valid Valid Output doubleword in EAX to I/O port address imm8.
	{ NULL, 0x0001, 0x06C40000, { 0xE7, 0x00, 0x00 }, FCML_OP_IB, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_DWORD), FCML_NA, FCML_NA },
	// EE OUT DX, AL NP Valid Valid Output byte in AL to I/O port address in DX.
	{ NULL, 0x0001, 0x07C40000, { 0xEE, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// EF OUT DX, AX NP Valid Valid Output word in AX to I/O port address in DX.
	{ NULL, 0x0001, 0x01C40000, { 0xEF, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_WORD ), FCML_NA, FCML_NA },
	// EF OUT DX, EAX NP Valid Valid Output doubleword in EAX to I/O port address in DX.
	{ NULL, 0x0001, 0x06C40000, { 0xEF, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ), FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_AL, FCML_EOS_DWORD ), FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_OUTS[] = {
	...
	{ NULL, 0x0001, 0x07C40000, { 0x6E, 0x00, 0x00 },
			FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ),
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x01C40000, { 0x6F, 0x00, 0x00 },
			FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ),
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_WORD, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x06C40000, { 0x6F, 0x00, 0x00 },
			FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_DX, FCML_EOS_WORD ),
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_DI, FCML_EOS_DWORD, FCML_SEG_ENCODE_REGISTER( _IRA_REG_ES, FCML_SEG_DENY_OVERRIDE ) ), FCML_NA, FCML_NA }
	// TODO: W przypadku assemblera trzeba to bedzie obsluzyc.
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PABS[] = {
	...
	{ "pabsb", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x1C }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 38 1D /r1 PABSW mm1,mm2/m64
	{ "pabsw", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x1D }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 38 1E /r1 PABSD mm1,mm2/m64
	{ "pabsd", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x1E }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 1C /r PABSB xmm1,xmm2/m128
	{ "pabsb", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x1C }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 38 1D /r PABSW xmm1,xmm2/m128
	{ "pabsw", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x1D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 38 1E /r PABSD xmm1,xmm2/m128
	{ "pabsd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x1E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38 1C /r VPABSB xmm1,xmm2/m128
	{ "vpabsb", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x1C }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38 1D /r VPABSW xmm1,xmm2/m128
	{ "vpabsw", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x1D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38 1E /r VPABSD xmm1,xmm2/m128
	{ "vpabsd", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x1E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 1C /r VPABSB ymm1, ymm2/m256
	{ "vpabsb", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x1C }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 1D /r VPABSW ymm1, ymm2/m256
	{ "vpabsw", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x1D }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 1E /r VPABSD ymm1, ymm2/m256
	{ "vpabsd", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x1E }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PACKSS[] = {
	...
	{ "packsswb", 0x0001, 0x00D88000, { 0x0F, 0x63, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 6B /r1 PACKSSDW mm1,mm2/m64
	{ "packssdw", 0x0001, 0x00D88000, { 0x0F, 0x6B, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 63 /r PACKSSWB xmm1,xmm2/m128
	{ "packsswb", 0x1001, 0x00D88000, { 0x0F, 0x63, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 6B /r PACKSSDW xmm1,xmm2/m128
	{ "packssdw", 0x1001, 0x00D88000, { 0x0F, 0x6B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 63 /r VPACKSSWB xmm1,xmm2,xmm3/m128
	{ "vpacksswb", 0x10C0, 0x00D88000, { 0x0F, 0x63, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 6B /r VPACKSSDW xmm1,xmm2,xmm3/m128
	{ "vpackssdw", 0x10C0, 0x00D88000, { 0x0F, 0x6B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 63 /r VPACKSSWB ymm1,ymm2,ymm3/m256
	{ "vpacksswb", 0x10A0, 0x00D88000, { 0x0F, 0x63, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 6B /r VPACKSSDW ymm1,ymm2,ymm3/m256
	{ "vpackssdw", 0x10A0, 0x00D88000, { 0x0F, 0x6B, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }

};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PACKUSD[] = {
	// 66 0F 38 2B /r PACKUSDW xmm1,xmm2/m128
	{ "packusdw", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x2B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 2B /r VPACKUSDW xmm1,xmm2,xmm3/m128
	{ "vpackusdw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x2B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 2B /r VPACKUSDW ymm1,ymm2,ymm3/m256
	{ "vpackusdw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x2B }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PACKUSW[] = {
	// 0F 67 /r1 PACKUSWB mm,mm/m64
	{ "packuswb", 0x0001, 0x00D88000, { 0x0F, 0x67, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 67 /r PACKUSWB xmm1,xmm2/m128
	{ "packuswb", 0x1001, 0x00D88000, { 0x0F, 0x67, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 67 /r VPACKUSWB xmm1,xmm2,xmm3/m128
	{ "vpackuswb", 0x10C0, 0x00D88000, { 0x0F, 0x67, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 67 /r VPACKUSWB ymm1,ymm2,ymm3/m256
	{ "vpackuswb", 0x10A0, 0x00D88000, { 0x0F, 0x67, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PADD[] = {
	// 0F FC /r1 PADDB mm,mm/m64
	{ "paddb", 0x0001, 0x00D88000, { 0x0F, 0xFC, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F FD /r1 PADDW mm,mm/m64
	{ "paddw", 0x0001, 0x00D88000, { 0x0F, 0xFD, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F FE /r1 PADDD mm,mm/m64
	{ "paddd", 0x0001, 0x00D88000, { 0x0F, 0xFE, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F FC /r PADDB xmm1,xmm2/m128
	{ "paddb", 0x1001, 0x00D88000, { 0x0F, 0xFC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F FD /r PADDW xmm1,xmm2/m128
	{ "paddw", 0x1001, 0x00D88000, { 0x0F, 0xFD, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F FE /r PADDD xmm1,xmm2/m128
	{ "paddd", 0x1001, 0x00D88000, { 0x0F, 0xFE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG FC /r VPADDB xmm1,xmm2,xmm3/m128
	{ "vpaddb", 0x10C0, 0x00D88000, { 0x0F, 0xFC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG FD /r VPADDW xmm1,xmm2,xmm3/m128
	{ "vpaddw", 0x10C0, 0x00D88000, { 0x0F, 0xFD, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG FE /r VPADDD xmm1,xmm2,xmm3/m128
	{ "vpaddd", 0x10C0, 0x00D88000, { 0x0F, 0xFE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG FC /r VPADDB ymm1,ymm2,ymm3/m256
	{ "vpaddb", 0x10A0, 0x00D88000, { 0x0F, 0xFC, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG FD /r VPADDW ymm1,ymm2,ymm3/m256
	{ "vpaddw", 0x10A0, 0x00D88000, { 0x0F, 0xFD, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG FE /r VPADDD ymm1,ymm2,ymm3/m256
	{ "vpaddd", 0x10A0, 0x00D88000, { 0x0F, 0xFE, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG D4 /r VPADDQ ymm1,ymm2,ymm3/m256
	{ "vpaddq", 0x10A0, 0x00D88000, { 0x0F, 0xD4, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PADDS[] = {
	// 0F EC /r1 PADDSB mm,mm/m64
	{ "paddsb", 0x0001, 0x00D88000, { 0x0F, 0xEC, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F ED /r1 PADDSW mm,mm/m64
	{ "paddsw", 0x0001, 0x00D88000, { 0x0F, 0xED, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F EC /r PADDSB xmm1,xmm2/m128
	{ "paddsb", 0x1001, 0x00D88000, { 0x0F, 0xEC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F ED /r PADDSW xmm1,xmm2/m128
	{ "paddsw", 0x1001, 0x00D88000, { 0x0F, 0xED, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG EC /r VPADDSB xmm1,xmm2,xmm3/m128
	{ "vpaddsb", 0x10C0, 0x00D88000, { 0x0F, 0xEC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG ED /r VPADDSW xmm1,xmm2,xmm3/m128
	{ "vpaddsw", 0x10C0, 0x00D88000, { 0x0F, 0xED, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG EC /r VPADDSB ymm1,ymm2,ymm3/m256
	{ "vpaddsb", 0x10A0, 0x00D88000, { 0x0F, 0xEC, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG ED /r VPADDSW ymm1,ymm2,ymm3/m256
	{ "vpaddsw", 0x10A0, 0x00D88000, { 0x0F, 0xED, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PADDUS[] = {
	// 0F DC /r1 PADDUSB mm,mm/m64
	{ "paddusb", 0x0001, 0x00D88000, { 0x0F, 0xDC, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F DD /r1 PADDUSW mm,mm/m64
	{ "paddusw", 0x0001, 0x00D88000, { 0x0F, 0xDD, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F DC /r PADDUSB xmm1,xmm2/m128
	{ "paddusb", 0x1001, 0x00D88000, { 0x0F, 0xDC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F DD /r PADDUSW xmm1,xmm2/m128
	{ "paddusw", 0x1001, 0x00D88000, { 0x0F, 0xDD, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.660F.WIG DC /r VPADDUSB xmm1,xmm2,xmm3/m128
	{ "vpaddusb", 0x10C0, 0x00D88000, { 0x0F, 0xDC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG DD /r VPADDUSW xmm1,xmm2,xmm3/m128
	{ "vpaddusw", 0x10C0, 0x00D88000, { 0x0F, 0xDD, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG DC /r VPADDUSB ymm1,ymm2,ymm3/m256
	{ "vpaddusb", 0x10A0, 0x00D88000, { 0x0F, 0xDC, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG DD /r VPADDUSW ymm1,ymm2,ymm3/m256
	{ "vpaddusw", 0x10A0, 0x00D88000, { 0x0F, 0xDD, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PADDQ[] = {
	// 0F D4 /r1 PADDQ mm1,mm2/m64
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xD4, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F D4 /r PADDQ xmm1,xmm2/m128
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0xD4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D4 /r VPADDQ xmm1,xmm2,xmm3/m128
	{ "vpaddq", 0x10C0, 0x00D88000, { 0x0F, 0xD4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PALIGNR[] = {
	// 0F 3A 0F PALIGNR mm1,mm2/m64,imm8
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x3A, 0x00F }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_OP_IB, FCML_NA },
	// 66 0F 3A 0F PALIGNR xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x00F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A.WIG 0F /r ib VPALIGNR xmm1,xmm2,xmm3/m128,imm8
	{ "vpalignr", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x0F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VEX.NDS.256.66.0F3A.WIG 0F /r ib VPALIGNR ymm1,ymm2,ymm3/m256,imm8
	{ "vpalignr", 0x10A0, 0x00EC8000, { 0x0F, 0x3A, 0x0F }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PAND[] = {
		// 0F DB /r PAND mm,mm/m64
		{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xDB, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
		// 66 0F DB /r PAND xmm1,xmm2/m128
		{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xDB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
		// VEX.NDS.128.66.0F.WIG DB /r VPAND xmm1,xmm2,xmm3/m128
		{ "vpand", 0x10C0, 0x00D88000, { 0x0F, 0xDB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
		// VEX.NDS.256.66.0F.WIG DB /r VPAND ymm1,ymm2,ymm3/m256
		{ "vpand", 0x10A0, 0x00D88000, { 0x0F, 0xDB, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PANDN[] = {
		// 0F DF /r PANDN mm,mm/m64
		{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xDF, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
		// 66 0F DF /r PANDN xmm1,xmm2/m128
		{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xDF, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
		// VEX.NDS.128.66.0F.WIG DF /r VPANDN xmm1,xmm2,xmm3/m128
		{ "vpandn", 0x10C0, 0x00D88000, { 0x0F, 0xDF, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
		// VEX.NDS.256.66.0F.WIG DF /r VPANDN ymm1,ymm2,ymm3/m256
		{ "vpandn", 0x10A0, 0x00D88000, { 0x0F, 0xDF, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PAUSE[] = {
	// F3 90 PAUSE
	{ NULL, 0x4001, 0x00C40000, { 0x90, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PAVG[] = {
	// 0F E0 /r1 PAVGB mm1,mm2/m64
	{ "pavgb", 0x0001, 0x00D88000, { 0x0F, 0xE0, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F E3 /r1 PAVGW mm1,mm2/m64
	{ "pavgw", 0x0001, 0x00D88000, { 0x0F, 0xE3, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F E0, /r PAVGB xmm1,xmm2/m128
	{ "pavgb", 0x1001, 0x00D88000, { 0x0F, 0xE0, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F E3 /r PAVGW xmm1,xmm2/m128
	{ "pavgw", 0x1001, 0x00D88000, { 0x0F, 0xE3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E0 /r VPAVGB xmm1,xmm2,xmm3/m128
	{ "vpavgb", 0x10C0, 0x00D88000, { 0x0F, 0xE0, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E3 /r VPAVGW xmm1,xmm2,xmm3/m128
	{ "vpavgw", 0x10C0, 0x00D88000, { 0x0F, 0xE3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E0 /r VPAVGB ymm1,ymm2,ymm3/m256
	{ "vpavgb", 0x10A0, 0x00D88000, { 0x0F, 0xE0, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E3 /r VPAVGW ymm1,ymm2,ymm3/m256
	{ "vpavgw", 0x10A0, 0x00D88000, { 0x0F, 0xE3, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PBLENDVB[] = {
	// 66 0F 38 10 /r PBLENDVB xmm1,xmm2/m128,<XMM0>
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x10 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_EXPLICIT_REG( IRA_REG_SIMD, _IRA_REG_XMM0, FCML_EOS_OWORD ), FCML_NA },
	// VEX.NDS.128.66.0F3A 4C /r /is4 VPBLENDVB xmm1,xmm2,xmm3/m128,xmm4
	{ "vpblendvb", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x4C }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 },
	// VEX.NDS.256.66.0F3A.W0 4C /r /is4 VPBLENDVB ymm1,ymm2,ymm3/m256,ymm4
	{ "vpblendvb", 0x10A0, 0x00EC8000, { 0x0F, 0x3A, 0x4C }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_OPERAND_IS4 }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PBLENDW[] = {
	// 66 0F 3A 0E /r ib PBLENDW xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x0E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A 0E /r ib VPBLENDW xmm1,xmm2,xmm3/m128,imm8
	{ "vpblendw", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x0E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VEX.NDS.256.66.0F3A.WIG 0E /r ib VPBLENDW ymm1,ymm2,ymm3/m256,imm8
	{ "vpblendw", 0x10A0, 0x00EC8000, { 0x0F, 0x3A, 0x0E }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPBLENDD[] = {
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x02 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCLMULQDQ[] = {
	// 66 0F 3A 44 /r ib PCLMULQDQ xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x44 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A 44 /r ib VPCLMULQDQ xmm1,xmm2,xmm3/m128,imm8
	{ "vpclmulqdq", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x44 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPEQ[] = {
	// 0F 74 /r1 PCMPEQB mm,mm/m64
	{ "pcmpeqb", 0x0001, 0x00D88000, { 0x0F, 0x74, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 75 /r1 PCMPEQW mm,mm/m64
	{ "pcmpeqw", 0x0001, 0x00D88000, { 0x0F, 0x75, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 76 /r1 PCMPEQD mm,mm/m64
	{ "pcmpeqd", 0x0001, 0x00D88000, { 0x0F, 0x76, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 74 /r PCMPEQB xmm1,xmm2/m128
	{ "pcmpeqb", 0x1001, 0x00D88000, { 0x0F, 0x74, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 75 /r PCMPEQW xmm1,xmm2/m128
	{ "pcmpeqw", 0x1001, 0x00D88000, { 0x0F, 0x75, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 76 /r PCMPEQD xmm1,xmm2/m128
	{ "pcmpeqd", 0x1001, 0x00D88000, { 0x0F, 0x76, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 74 /r VPCMPEQB xmm1,xmm2,xmm3/m128
	{ "vpcmpeqb", 0x10C0, 0x00D88000, { 0x0F, 0x74, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 75 /r VPCMPEQW xmm1,xmm2,xmm3/m128
	{ "vpcmpeqw", 0x10C0, 0x00D88000, { 0x0F, 0x75, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 76 /r VPCMPEQD xmm1,xmm2,xmm3/m128
	{ "vpcmpeqd", 0x10C0, 0x00D88000, { 0x0F, 0x76, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 74 /r VPCMPEQB ymm1,ymm2,ymm3/m256
	{ "vpcmpeqb", 0x10A0, 0x00D88000, { 0x0F, 0x74, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 75 /r VPCMPEQW ymm1,ymm2,ymm3/m256
	{ "vpcmpeqw", 0x10A0, 0x00D88000, { 0x0F, 0x75, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 76 /r VPCMPEQD ymm1,ymm2,ymm3/m256
	{ "vpcmpeqd", 0x10A0, 0x00D88000, { 0x0F, 0x76, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPEQQ[] = {
	// 66 0F 38 29 /r PCMPEQQ xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x29 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 29 /r VPCMPEQQ xmm1,xmm2,xmm3/m128
	{ "vpcmpeqq", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x29 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 29 /r VPCMPEQQ ymm1,ymm2,ymm3/m256
	{ "vpcmpeqq", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x29 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPESTRI[] = {
	// 66 0F 3A 61 /r imm8 PCMPESTRI xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x61 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG 61 /r ib VPCMPESTRI xmm1,xmm2/m128,imm8
	{ "vpcmpestri", 0x11C0, 0x00EC8000, { 0x0F, 0x3A, 0x61 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPESTRM[] = {
	// 66 0F 3A 60 /r imm8 PCMPESTRM xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x60 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG 60 /r ib VPCMPESTRM xmm1,xmm2/m128,imm8
	{ "vpcmpestrm", 0x11C0, 0x00EC8000, { 0x0F, 0x3A, 0x60 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPGT[] = {
	...
	{ "pcmpgtb", 0x0001, 0x00D88000, { 0x0F, 0x64, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	{ "pcmpgtw", 0x0001, 0x00D88000, { 0x0F, 0x65, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	{ "pcmpgtd", 0x0001, 0x00D88000, { 0x0F, 0x66, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 64 /r PCMPGTB xmm1,xmm2/m128
	// 66 0F 65 /r PCMPGTW xmm1,xmm2/m128
	// 66 0F 66 /r PCMPGTD xmm1,xmm2/m128
	{ "pcmpgtb", 0x1001, 0x00D88000, { 0x0F, 0x64, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	{ "pcmpgtw", 0x1001, 0x00D88000, { 0x0F, 0x65, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	{ "pcmpgtd", 0x1001, 0x00D88000, { 0x0F, 0x66, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vpcmpgtb", 0x10C0, 0x00D88000, { 0x0F, 0x64, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	{ "vpcmpgtw", 0x10C0, 0x00D88000, { 0x0F, 0x65, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	{ "vpcmpgtd", 0x10C0, 0x00D88000, { 0x0F, 0x66, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	...
	{ "vpcmpgtb", 0x10A0, 0x00D88000, { 0x0F, 0x64, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	{ "vpcmpgtw", 0x10A0, 0x00D88000, { 0x0F, 0x65, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	{ "vpcmpgtd", 0x10A0, 0x00D88000, { 0x0F, 0x66, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPGTQ[] = {
	// 66 0F 38 37 /r PCMPGTQ xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x37 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 37 /r VPCMPGTQ xmm1,xmm2,xmm3/m128
	{ "vpcmpgtq", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x37 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 37 /r VPCMPGTQ ymm1,ymm2,ymm3/m256
	{ "vpcmpgtq", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x37 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPISTRI[] = {
	// 66 0F 3A 63 /r imm8 PCMPISTRI xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x63 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG 63 /r ib VPCMPISTRI xmm1,xmm2/m128,imm8
	{ "vpcmpistri", 0x11C0, 0x00EC8000, { 0x0F, 0x3A, 0x63 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PCMPISTRM[] = {
	// 66 0F 3A 62 /r imm8 PCMPISTRM xmm1,xmm2/m128,imm8
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x62 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG 62 /r ib VPCMPISTRM xmm1,xmm2/m128,imm8
	{ "vpcmpistrm", 0x11C0, 0x00EC8000, { 0x0F, 0x3A, 0x62 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PEXTR[] = {
	// 66 0F 3A 14 /r ib PEXTRB reg/m8,xmm2,imm8
	{ "pextrb", 0x1001, 0x40EC8000, { 0x0F, 0x3A, 0x14 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_BYTE, FCML_RMF_RM ), FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	// 66 0F 3A 16 /r ib PEXTRD r/m32, xmm2, imm8
	{ "pextrd", 0x1001, 0x40EC8000, { 0x0F, 0x3A, 0x16 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_DWORD, FCML_RMF_RM ), FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	// 66 REX.W 0F 3A 16 /r ib PEXTRQ r/m64, xmm2, imm8
	{ "pextrq", 0x1009, 0x04AC8000, { 0x0F, 0x3A, 0x16 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_QWORD, FCML_RMF_RM ), FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.W0 14 /r ib VPEXTRB reg/m8, xmm2, imm8
	{ "vpextrb", 0x13C0, 0x40EC8000, { 0x0F, 0x3A, 0x14 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_BYTE, FCML_RMF_RM ), FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.W0 16 /r ib VPEXTRD r32/m32, xmm2, imm8
	{ "vpextrd", 0x13D0, 0x40EC8000, { 0x0F, 0x3A, 0x16 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_DWORD, FCML_RMF_RM ), FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.W1 16 /r ib VPEXTRQ r64/m64, xmm2, imm8
	{ "vpextrq", 0x11C8, 0x04AC8000, { 0x0F, 0x3A, 0x16 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_QWORD, FCML_RMF_RM ), FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PEXTRW[] = {
	// 0F C5 /r ib PEXTRW reg,mm,imm8
	{ NULL, 0x0001, 0x40DA8000, { 0x0F, 0xC5, 0x00 }, FCML_OP_R(IRA_REG_GPR, FCML_EOS_EOSA), FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// 66 0F C5 /r ib PEXTRW reg,xmm,imm8
	{ NULL, 0x1001, 0x40DA8000, { 0x0F, 0xC5, 0x00 }, FCML_OP_R(IRA_REG_GPR, FCML_EOS_EOSA), FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// 66 0F 3A 15 /r ib PEXTRW reg/m16,xmm,imm8
	{ NULL, 0x1001, 0x40EC8000, { 0x0F, 0x3A, 0x15 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_WORD, FCML_RMF_RM ), FCML_OP_R(IRA_REG_SIMD, FCML_EOS_OWORD), FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F.W0 C5 /r ib VPEXTRW reg,xmm1,imm8
	{ "vpextrw", 0x13C1, 0x40DA8000, { 0x0F, 0xC5, 0x00 }, FCML_OP_R(IRA_REG_GPR, FCML_EOS_EOSA), FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.W0 15 /r ib VPEXTRW reg/m16,xmm2,imm8
	{ "vpextrw", 0x13C1, 0x40EC8000, { 0x0F, 0x3A, 0x15 }, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_WORD, FCML_RMF_RM ), FCML_OP_R(IRA_REG_SIMD, FCML_EOS_OWORD), FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PHADD[] = {
	// 0F 38 01 /r PHADDW mm1,mm2/m64
	{ "phaddw", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x01 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 38 02 /r PHADDD mm1,mm2/m64
	{ "phaddd", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x02 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 01 /r PHADDW xmm1,xmm2/m128
	{ "phaddw", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x01 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 38 02 /r PHADDD xmm1,xmm2/m128
	{ "phaddd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x02 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 01 /r VPHADDW xmm1,xmm2,xmm3/m128
	{ "vphaddw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x01 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 02 /r VPHADDD xmm1,xmm2,xmm3/m128
	{ "vphaddd", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x02 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 01 /r VPHADDW ymm1,ymm2,ymm3/m256
	{ "vphaddw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x01 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 02 /r VPHADDD ymm1,ymm2,ymm3/m256
	{ "vphaddd", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x02 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PHADDSW[] = {
	// 0F 38 03 /r PHADDSW mm1,mm2/m64
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x03 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 03 /r PHADDSW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x03 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 03 /r VPHADDSW xmm1,xmm2,xmm3/m128
	{ "vphaddsw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x03 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 03 /r VPHADDSW ymm1,ymm2,ymm3/m256
	{ "vphaddsw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x03 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PHMINPOSUW[] = {
	// 66 0F 38 41 /r PHMINPOSUW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x41 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 41 /r VPHMINPOSUW xmm1,xmm2/m128
	{ "vphminposuw", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x41 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PHSUB[] = {
	// 0F 38 05 /r1 PHSUBW mm1,mm2/m64
	{ "phsubw", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x05 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 38 06 /r PHSUBD mm1,mm2/m64
	{ "phsubd", 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x06 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 05 /r PHSUBW xmm1,xmm2/m128
	{ "phsubw", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x05 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 38 06 /r PHSUBD xmm1,xmm2/m128
	{ "phsubd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x06 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 05 /r VPHSUBW xmm1,xmm2,xmm3/m128
	{ "vphsubw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x05 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 06 /r VPHSUBD xmm1,xmm2,xmm3/m128
	{ "vphsubd", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x06 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 05 /r VPHSUBW ymm1,ymm2,ymm3/m256
	{ "vphsubw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x05 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 06 /r VPHSUBD ymm1,ymm2,ymm3/m256
	{ "vphsubd", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x06 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PHSUBSW[] = {
	// 0F 38 07 /r PHSUBSW mm1,mm2/m64
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x07 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 07 /r PHSUBSW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x07 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 07 /r VPHSUBSW xmm1,xmm2,xmm3/m128
	{ "vphsubsw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x07 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 07 /r VPHSUBSW ymm1,ymm2,ymm3/m256
	{ "vphsubsw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x07 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PINSR[] = {
	// 66 0F 3A 20 /r ib PINSRB xmm1,r32/m8,imm8
	{ "pinsrb", 0x1001, 0x00EC8000, { 0x0F, 0x3A, 0x20 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_BYTE, FCML_RMF_RM ), FCML_OP_IB, FCML_NA },
	// 66 0F 3A 22 /r ib PINSRD xmm1,r/m32,imm8
	{ "pinsrd", 0x1001, 0x03EC8000, { 0x0F, 0x3A, 0x22 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_32, FCML_OP_IB, FCML_NA },
	// 66 REX.W 0F 3A 22 /r ib PINSRQ xmm1,r/m64,imm8
	{ "pinsrq", 0x1009, 0x04AC8000, { 0x0F, 0x3A, 0x22 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_64, FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F3A.W0 20 /r ib VPINSRB xmm1,xmm2,r32/m8,imm8
	{ "vpinsrb", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x20 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_BYTE, FCML_RMF_RM ), FCML_OP_IB },
	// VEX.NDS.128.66.0F3A.W0 22 /r ib VPINSRD xmm1,xmm2,r32/m32,imm8
	{ "vpinsrd", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x22 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_32, FCML_OP_IB },
	// VEX.NDS.128.66.0F3A.W1 22 /r ib VPINSRQ xmm1,xmm2,r64/m64,imm8
	{ "vpinsrq", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x22 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_64, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PINSRW[] = {
	// 0F C4 /r ib PINSRW mm,r32/m16,imm8
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xC4, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_WORD, FCML_RMF_RM ), FCML_OP_IB, FCML_NA },
	// 66 0F C4 /r ib PINSRW xmm,r32/m16,imm8
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xC4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_WORD, FCML_RMF_RM ), FCML_OP_IB, FCML_NA },
	// VEX.NDS.128.66.0F.W0 C4 /r ib VPINSRW xmm1,xmm2,r32/m16,imm8
	{ "vpinsrw", 0x10C0, 0x00D88000, { 0x0F, 0xC4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_RM(IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_WORD, FCML_RMF_RM ), FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMADDUBSW[] = {
	// 0F 38 04 /r PMADDUBSW mm1,mm2/m64
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x04 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 04 /r PMADDUBSW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x04 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 04 /r VPMADDUBSW xmm1,xmm2,xmm3/m128
	{ "vpmaddubsw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x04 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 04 /r VPMADDUBSW ymm1,ymm2,ymm3/m256
	{ "vpmaddubsw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x04 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMADDWD[] = {
	// 0F F5 /r PMADDWD mm,mm/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xF5, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F F5 /r PMADDWD xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xF5, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F5 /r VPMADDWD xmm1,xmm2,xmm3/m128
	{ "vpmaddwd", 0x10C0, 0x00D88000, { 0x0F, 0xF5, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG F5 /r VPMADDWD ymm1,ymm2,ymm3/m256
	{ "vpmaddwd", 0x10A0, 0x00D88000, { 0x0F, 0xF5, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }

};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMAXSB[] = {
	// 66 0F 38 3C /r PMAXSB xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x3C }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 3C /r VPMAXSB xmm1,xmm2,xmm3/m128
	{ "vpmaxsb", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x3C }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 3C /r VPMAXSB ymm1,ymm2,ymm3/m256
	{ "vpmaxsb", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x3C }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMAXSD[] = {
	// 66 0F 38 3D /r PMAXSD xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x3D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 3D /r VPMAXSD xmm1,xmm2,xmm3/m128
	{ "vpmaxsd", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x3D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 3D /r VPMAXSD ymm1,ymm2,ymm3/m256
	{ "vpmaxsd", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x3D }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMAXSW[] = {
	// 0F EE /r PMAXSW mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xEE, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F EE /r PMAXSW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xEE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG EE /r VPMAXSW xmm1,xmm2,xmm3/m128
	{ "vpmaxsw", 0x10C0, 0x00D88000, { 0x0F, 0xEE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG EE /r VPMAXSW ymm1,ymm2,ymm3/m256
	{ "vpmaxsw", 0x10A0, 0x00D88000, { 0x0F, 0xEE, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMAXUB[] = {
	// 0F DE /r PMAXUB mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xDE, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F DE /r PMAXUB xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xDE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG DE /r VPMAXUB xmm1,xmm2,xmm3/m128
	{ "vpmaxub", 0x10C0, 0x00D88000, { 0x0F, 0xDE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG DE /r VPMAXUB ymm1,ymm2,ymm3/m256
	{ "vpmaxub", 0x10A0, 0x00D88000, { 0x0F, 0xDE, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMAXUD[] = {
	// 66 0F 38 3F /r PMAXUD xmm1, xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x3F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 3F /r VPMAXUD xmm1,xmm2,xmm3/m128
	{ "vpmaxud", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x3F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 3F /r VPMAXUD ymm1,ymm2,ymm3/m256
	{ "vpmaxud", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x3F }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMAXUW[] = {
	// 66 0F 38 3E /r PMAXUW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x3E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 3E/r VPMAXUW xmm1,xmm2,xmm3/m128
	{ "vpmaxuw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x3E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 3E /r VPMAXUW ymm1,ymm2,ymm3/m256
	{ "vpmaxuw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x3E }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMINSB[] = {
	// 66 0F 38 38 /r PMINSB xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x38 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 38 /r VPMINSB xmm1,xmm2,xmm3/m128
	{ "vpminsb", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x38 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 38 /r VPMINSB ymm1,ymm2,ymm3/m256
	{ "vpminsb", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x38 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMINSD[] = {
	// 66 0F 38 39 /r PMINSD xmm1, xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x39 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 39 /r VPMINSD xmm1, xmm2, xmm3/m128
	{ "vpminsd", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x39 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 39 /r VPMINSD ymm1,ymm2,ymm3/m256
	{ "vpminsd", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x39 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMINSW[] = {
	// 0F EA /r PMINSW mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xEA, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F EA /r PMINSW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xEA, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG EA /r VPMINSW xmm1,xmm2,xmm3/m128
	{ "vpminsw", 0x10C0, 0x00D88000, { 0x0F, 0xEA, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG EA /r VPMINSW ymm1,ymm2,ymm3/m256
	{ "vpminsw", 0x10A0, 0x00D88000, { 0x0F, 0xEA, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMINUB[] = {
	// 0F DA /r PMINUB mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xDA, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F DA /r PMINUB xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xDA, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG DA /r VPMINUB xmm1,xmm2,xmm3/m128
	{ "vpminub", 0x10C0, 0x00D88000, { 0x0F, 0xDA, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG DA /r VPMINUB ymm1,ymm2,ymm3/m256
	{ "vpminub", 0x10A0, 0x00D88000, { 0x0F, 0xDA, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMINUW[] = {
	// 66 0F 38 3A /r PMINUW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x3A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 3A /r VPMINUW xmm1,xmm2,xmm3/m128
	{ "vpminuw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x3A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 3A /r VPMINUW ymm1,ymm2,ymm3/m256
	{ "vpminuw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x3A }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMINUD[] = {
	// 66 0F 38 3B /r PMINUD xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x3B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 3B /r VPMINUD xmm1,xmm2,xmm3/m128
	{ "vpminud", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x3B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 3B /r VPMINUD ymm1,ymm2,ymm3/m256
	{ "vpminud", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x3B }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMOVMSKB[] = {
	// 0F D7 /r1 PMOVMSKB reg, mm
	{ NULL, 0x0001, 0x40DA8000, { 0x0F, 0xD7, 0x00 }, FCML_OP_R(IRA_REG_GPR, FCML_EOS_EOSA), FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// 66 0F D7 /r PMOVMSKB reg, xmm
	{ NULL, 0x1001, 0x40DA8000, { 0x0F, 0xD7, 0x00 }, FCML_OP_R(IRA_REG_GPR, FCML_EOS_EOSA), FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA },
	// VEX.128.66.0F.WIG D7 /r VPMOVMSKB reg,xmm1
	{ "vpmovmskb", 0x13C0, 0x40DA8000, { 0x0F, 0xD7, 0x22 }, FCML_OP_MODRM_R_W, FCML_OP_VEX_VVVV_REG( IRA_REG_SIMD, FCML_EOS_OWORD ), FCML_NA, FCML_NA },
	// VEX.256.66.0F.WIG D7 /r VPMOVMSKB reg,ymm1
	{ "vpmovmskb", 0x13A0, 0x40DA8000, { 0x0F, 0xD7, 0x22 }, FCML_OP_MODRM_R_W, FCML_OP_VEX_VVVV_REG( IRA_REG_SIMD, FCML_EOS_YWORD ), FCML_NA, FCML_NA }

};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMOVSX[] = {
	// 66 0f 38 20 /r PMOVSXBW xmm1,xmm2/m64
	{ "pmovsxbw", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x20 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// 66 0f 38 21 /r PMOVSXBD xmm1,xmm2/m32
	{ "pmovsxbd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x21 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// 66 0f 38 22 /r PMOVSXBQ xmm1,xmm2/m16
	{ "pmovsxbq", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x22 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_16, FCML_NA, FCML_NA },
	// 66 0f 38 23 /r PMOVSXWD xmm1,xmm2/m64
	{ "pmovsxwd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x23 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// 66 0f 38 24 /r PMOVSXWQ xmm1,xmm2/m32
	{ "pmovsxwq", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x24 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// 66 0f 38 25 /r PMOVSXDQ xmm1,xmm2/m64
	{ "pmovsxdq", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x25 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 20 /r VPMOVSXBW xmm1,xmm2/m64
	{ "vpmovsxbw", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x20 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 21 /r VPMOVSXBD xmm1,xmm2/m32
	{ "vpmovsxbd", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x21 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 22 /r VPMOVSXBQ xmm1,xmm2/m16
	{ "vpmovsxbq", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x22 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_16, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 23 /r VPMOVSXWD xmm1,xmm2/m64
	{ "vpmovsxwd", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x23 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 24 /r VPMOVSXWQ xmm1,xmm2/m32
	{ "vpmovsxwq", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x24 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 25 /r VPMOVSXDQ xmm1,xmm2/m64
	{ "vpmovsxdq", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x25 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 20 /r VPMOVSXBW ymm1,xmm2/m128
	{ "vpmovsxbw", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x20 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 21 /r VPMOVSXBD ymm1,xmm2/m64
	{ "vpmovsxbd", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x21 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 22 /r VPMOVSXBQ ymm1,xmm2/m32
	{ "vpmovsxbq", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x22 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMOVZX[] = {
	// 66 0f 38 30 /r PMOVZXBW xmm1,xmm2/m64
	{ "pmovzxbw", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x30 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// 66 0f 38 31 /r PMOVZXBD xmm1,xmm2/m32
	{ "pmovzxbd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x31 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// 66 0f 38 32 /r PMOVZXBQ xmm1,xmm2/m16
	{ "pmovzxbq", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x32 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_16, FCML_NA, FCML_NA },
	// 66 0f 38 33 /r PMOVZXWD xmm1,xmm2/m64
	{ "pmovzxwd", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x33 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// 66 0f 38 34 /r PMOVZXWQ xmm1,xmm2/m32
	{ "pmovzxwq", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x34 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// 66 0f 38 35 /r PMOVZXDQ xmm1,xmm2/m64
	{ "pmovzxdq", 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x35 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 30 /r VPMOVZXBW xmm1,xmm2/m64
	{ "vpmovzxbw", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x30 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 31 /r VPMOVZXBD xmm1,xmm2/m32
	{ "vpmovzxbd", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x31 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 32 /r VPMOVZXBQ xmm1,xmm2/m16
	{ "vpmovzxbq", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x32 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_16, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 33 /r VPMOVZXWD xmm1,xmm2/m64
	{ "vpmovzxwd", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x33 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 34 /r VPMOVZXWQ xmm1,xmm2/m32
	{ "vpmovzxwq", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x34 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 35 /r VPMOVZXDQ xmm1,xmm2/m64
	{ "vpmovzxdq", 0x11C0, 0x00EC8000, { 0x0F, 0x38, 0x35 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 30 /r VPMOVZXBW ymm1,xmm2/m128
	{ "vpmovzxbw", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x30 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 31 /r VPMOVZXBD ymm1,xmm2/m64
	{ "vpmovzxbd", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x31 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 32 /r VPMOVZXBQ ymm1,xmm2/m32
	{ "vpmovzxbq", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x32 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.256.66.0F38.WIG 33 /r VPMOVZXWD ymm1,xmm2/m128
	{ "vpmovzxwd", 0x11A0, 0x00EC8000, { 0x0F, 0x38, 0x33 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULDQ[] = {
	// 66 0F 38 28 /r PMULDQ xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x28 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 28 /r VPMULDQ xmm1,xmm2,xmm3/m128
	{ "vpmuldq", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x28 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 28 /r VPMULDQ ymm1,ymm2,ymm3/m256
	{ "vpmuldq", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x28 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULHRSW[] = {
	// 0F 38 0B /r PMULHRSW mm1,mm2/m64
	{ NULL, 0x0001, 0x00EC8000, { 0x0F, 0x38, 0x0B }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 0B /r PMULHRSW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x0B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 0B /r VPMULHRSW xmm1,xmm2,xmm3/m128
	{ "vpmulhrsw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x0B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 0B /r VPMULHRSW ymm1,ymm2,ymm3/m256
	{ "vpmulhrsw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x0B }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }

};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULHUW[] = {
	// 0F E4 /r PMULHUW mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xE4, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F E4 /r PMULHUW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xE4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E4 /r VPMULHUW xmm1,xmm2,xmm3/m128
	{ "vpmulhuw", 0x10C0, 0x00D88000, { 0x0F, 0xE4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E4 /r VPMULHUW ymm1,ymm2,ymm3/m256
	{ "vpmulhuw", 0x10A0, 0x00D88000, { 0x0F, 0xE4, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULHW[] = {
	// 0F E5 /r PMULHW mm,mm/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xE5, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F E5 /r PMULHW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xE5, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E5 /r VPMULHW xmm1,xmm2,xmm3/m128
	{ "vpmulhw", 0x10C0, 0x00D88000, { 0x0F, 0xE5, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E5 /r VPMULHW ymm1,ymm2,ymm3/m256
	{ "vpmulhw", 0x10A0, 0x00D88000, { 0x0F, 0xE5, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULUDQ[] = {
	// 0F F4 /r1 PMULUDQ mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xF4, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F F4 /r PMULUDQ xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xF4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F4 /r VPMULUDQ xmm1,xmm2,xmm3/m128
	{ "vpmuludq", 0x10C0, 0x00D88000, { 0x0F, 0xF4, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG F4 /r VPMULUDQ ymm1,ymm2,ymm3/m256
	{ "vpmuludq", 0x10A0, 0x00D88000, { 0x0F, 0xF4, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULLW[] = {
	// 0F D5 /r PMULLW mm,mm/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xD5, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F D5 /r PMULLW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xD5, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D5 /r VPMULLW xmm1,xmm2,xmm3/m128
	{ "vpmullw", 0x10C0, 0x00D88000, { 0x0F, 0xD5, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG D5 /r VPMULLW ymm1,ymm2,ymm3/m256
	{ "vpmullw", 0x10A0, 0x00D88000, { 0x0F, 0xD5, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULLD[] = {
	// 66 0F 38 40 /r PMULLD xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00EC8000, { 0x0F, 0x38, 0x40 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 40 /r VPMULLD xmm1,xmm2,xmm3/m128
	{ "vpmulld", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x40 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 40 /r VPMULLD ymm1,ymm2,ymm3/m256
	{ "vpmulld", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x40 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_POP[] = {
	...
	{ NULL, 0x0001, 0x00458000, { 0x8F, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x01858000, { 0x8F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16_W, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x06858000, { 0x8F, 0x00, 0x00 }, FCML_OP_MODRM_RM_64_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00440000, { 0x58, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x01840000, { 0x58, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_WORD ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x06840000, { 0x58, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00440000, { 0x1F, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_DS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0x07, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_ES, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0x17, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_SS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0xA1, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_FS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0xA9, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_GS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_POPA[] = {
	// 61 POPA NP Invalid Valid Pop DI, SI, BP, BX, DX, CX, and AX.
	{ NULL, 0x0001, 0x01440000, { 0x61, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 61 POPAD NP Invalid Valid Pop EDI, ESI, EBP, EBX, EDX, ECX, and EAX.
	{ "popad", 0x0001, 0x02440000, { 0x61, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_POPCNT[] = {
	...
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0xB8, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_POPF[] = {
	...
	{ NULL, 0x0000, 0x01C40000, { 0x9D, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 9D POPFD NP N.E. Valid Pop top of stack into EFLAGS.
	{ "popfd", 0x0000, 0x02440000, { 0x9D, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// REX.W + 9D POPFQ NP Valid N.E. Pop top of stack and zero-extend into RFLAGS.
	{ "popfq", 0x0000, 0x04840000, { 0x9D, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_POR[] = {
	// 0F EB /r1 POR mm,mm/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xEB, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F EB /r POR xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xEB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG EB /r VPOR xmm1,xmm2,xmm3/m128
	{ "vpor", 0x10C0, 0x00D88000, { 0x0F, 0xEB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG EB /r VPOR ymm1,ymm2,ymm3/m256
	{ "vpor", 0x10A0, 0x00D88000, { 0x0F, 0xEB, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PREFETCHT[] = {
	...
	{ "prefetcht0", 0x0001, 0x80D98800, { 0x0F, 0x18, 0x00 }, FCML_OP_MODRM_M_8, FCML_NA, FCML_NA, FCML_NA },
	// 0F 18 /2 PREFETCHT1 m8 M Valid Valid Move data from m8 closer to the processor using T1 hint.
	{ "prefetcht1", 0x0001, 0x80D99000, { 0x0F, 0x18, 0x00 }, FCML_OP_MODRM_M_8, FCML_NA, FCML_NA, FCML_NA },
	// 0F 18 /3 PREFETCHT2 m8 M Valid Valid Move data from m8 closer to the processor using T2 hint.
	{ "prefetcht2", 0x0001, 0x80D99800, { 0x0F, 0x18, 0x00 }, FCML_OP_MODRM_M_8, FCML_NA, FCML_NA, FCML_NA },
	// 0F 18 /0 PREFETCHNTA m8 M Valid Valid Move data from m8 closer to the processor using NTA hint.
	{ "prefetchnta", 0x0001, 0x80D98000, { 0x0F, 0x18, 0x00 }, FCML_OP_MODRM_M_8, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSADBW[] = {
	// 0F F6 /r PSADBW mm1,mm2/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xF6, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F F6 /r PSADBW xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xF6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F6 /r VPSADBW xmm1,xmm2,xmm3/m128
	{ "vpsadbw", 0x10C0, 0x00D88000, { 0x0F, 0xF6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG F6 /r VPSADBW ymm1,ymm2,ymm3/m256
	{ "vpsadbw", 0x10A0, 0x00D88000, { 0x0F, 0xF6, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSHUFB[] = {
	// 0F 38 00 /r PSHUFB mm1,mm2/m64
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x38, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 00 /r PSHUFB xmm1,xmm2/m128
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x38, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 00 /r VPSHUFB xmm1,xmm2,xmm3/m128
	{ "vpshufb", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 00 /r VPSHUFB ymm1,ymm2,ymm3/m256
	{ "vpshufb", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }

};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSHUFD[] = {
	// 66 0F 70 /r ib PSHUFD xmm1,xmm2/m128,imm8
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F.WIG 70 /r ib VPSHUFD xmm1,xmm2/m128,imm8
	{ "vpshufd", 0x10C0, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.256.66.0F.WIG 70 /r ib VPSHUFD ymm1,ymm2/m256,imm8
	{ "vpshufd", 0x10A0, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSHUFHW[] = {
	// F3 0F 70 /r ib PSHUFHW xmm1,xmm2/m128,imm8
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.F3.0F.WIG 70 /r ib VPSHUFHW xmm1,xmm2/m128,imm8
	{ "vpshufhw", 0x40C0, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.256.F3.0F.WIG 70 /r ib VPSHUFHW ymm1,ymm2/m256,imm8
	{ "vpshufhw", 0x40A0, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSHUFLW[] = {
	// F2 0F 70 /r ib PSHUFLW xmm1,xmm2/m128,imm8
	{ NULL, 0x2000, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.F2.0F.WIG 70 /r ib VPSHUFLW xmm1,xmm2/m128,imm8
	{ "vpshuflw", 0x20C0, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.256.F2.0F.WIG 70 /r ib VPSHUFLW ymm1,ymm2/m256,imm8
	{ "vpshuflw", 0x20A0, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSHUFW[] = {
	// 0F 70 /r ib PSHUFW mm1,mm2/m64,imm8
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x70, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_OP_IB, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSIGN[] = {
	// 0F 38 08 /r PSIGNB mm1,mm2/m64
	{ "psignb", 0x0000, 0x00EC8000, { 0x0F, 0x38, 0x08 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 38 09 /r PSIGNW mm1,mm2/m64
	{ "psignw", 0x0000, 0x00EC8000, { 0x0F, 0x38, 0x09 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 38 0A /r PSIGND mm1,mm2/m64
	{ "psignd", 0x0000, 0x00EC8000, { 0x0F, 0x38, 0x0A }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 38 08 /r PSIGNB xmm1,xmm2/m128
	{ "psignb", 0x1000, 0x00EC8000, { 0x0F, 0x38, 0x08 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 38 09 /r PSIGNW xmm1,xmm2/m128
	{ "psignw", 0x1000, 0x00EC8000, { 0x0F, 0x38, 0x09 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 38 0A /r PSIGND xmm1,xmm2/m128
	{ "psignd", 0x1000, 0x00EC8000, { 0x0F, 0x38, 0x0A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 08 /r VPSIGNB xmm1,xmm2,xmm3/m128
	{ "vpsignb", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x08 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 09 /r VPSIGNW xmm1,xmm2,xmm3/m128
	{ "vpsignw", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x09 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F38.WIG 0A /r VPSIGND xmm1,xmm2,xmm3/m128
	{ "vpsignd", 0x10C0, 0x00EC8000, { 0x0F, 0x38, 0x0A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 08 /r VPSIGNB ymm1,ymm2,ymm3/m256
	{ "vpsignb", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x08 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 09 /r VPSIGNW ymm1,ymm2,ymm3/m256
	{ "vpsignw", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x09 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F38.WIG 0A /r VPSIGND ymm1,ymm2,ymm3/m256
	{ "vpsignd", 0x10A0, 0x00EC8000, { 0x0F, 0x38, 0x0A }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSLLDQ[] = {
	// 66 0F 73 /7 ib PSLLDQ xmm1,imm8
	{ NULL, 0x1000, 0x00DBB800, { 0x0F, 0x73, 0x00 }, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 73 /7 ib VPSLLDQ xmm1,xmm2,imm8
	{ "vpslldq", 0x10C0, 0x00DBB800, { 0x0F, 0x73, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.256.66.0F.WIG 73 /7 ib VPSLLDQ ymm1,ymm2,imm8
	{ "vpslldq", 0x10A0, 0x00DBB800, { 0x0F, 0x73, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_YWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSLL[] = {
	// 0F F1 /r1 PSLLW mm,mm/m64
	{ "psllw", 0x0000, 0x00D88000, { 0x0F, 0xF1, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F F2 /r1 PSLLD mm,mm/m64
	{ "pslld", 0x0000, 0x00D88000, { 0x0F, 0xF2, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F F3 /r1 PSLLQ mm,mm/m64
	{ "psllq", 0x0000, 0x00D88000, { 0x0F, 0xF3, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F F1 /r PSLLW xmm1,xmm2/m128
	{ "psllw", 0x1000, 0x00D88000, { 0x0F, 0xF1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F F2 /r PSLLD xmm1,xmm2/m128
	{ "pslld", 0x1000, 0x00D88000, { 0x0F, 0xF2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F F3 /r PSLLQ xmm1,xmm2/m128
	{ "psllq", 0x1000, 0x00D88000, { 0x0F, 0xF3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 0F 71 /6 ib PSLLW mm,imm8
	{ "psllw", 0x0000, 0x00DBB000, { 0x0F, 0x71, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 0F 72 /6 ib1 PSLLD mm,imm8
	{ "pslld", 0x0000, 0x00DBB000, { 0x0F, 0x72, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 0F 73 /6 ib1 PSLLQ mm,imm8
	{ "psllq", 0x0000, 0x00DBB000, { 0x0F, 0x73, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 71 /6 ib PSLLW xmm1,imm8
	{ "psllw", 0x1000, 0x00DBB000, { 0x0F, 0x71, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 72 /6 ib PSLLD xmm1,imm8
	{ "pslld", 0x1000, 0x00DBB000, { 0x0F, 0x72, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 73 /6 ib PSLLQ xmm1,imm8
	{ "psllq", 0x1000, 0x00DBB000, { 0x0F, 0x73, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F1 /r VPSLLW xmm1,xmm2,xmm3/m128
	{ "vpsllw", 0x10C0, 0x00D88000, { 0x0F, 0xF1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F2 /r VPSLLD xmm1,xmm2,xmm3/m128
	{ "vpslld", 0x10C0, 0x00D88000, { 0x0F, 0xF2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F3 /r VPSLLQ xmm1,xmm2,xmm3/m128
	{ "vpsllq", 0x10C0, 0x00D88000, { 0x0F, 0xF3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG F2 /r VPSLLD ymm1,ymm2,xmm3/m128
	{ "vpslld", 0x10A0, 0x00D88000, { 0x0F, 0xF2, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 71 /6 ib VPSLLW xmm1,xmm2,imm8
	{ "vpsllw", 0x10C0, 0x00DBB000, { 0x0F, 0x71, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 72 /6 ib VPSLLD xmm1,xmm2,imm8
	{ "vpslld", 0x10C0, 0x00DBB000, { 0x0F, 0x72, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 73 /6 ib VPSLLQ xmm1,xmm2,imm8
	{ "vpsllq", 0x10C0, 0x00DBB000, { 0x0F, 0x73, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.256.66.0F.WIG 71 /6 ib VPSLLW ymm1,ymm2,imm8
	{ "vpsllw", 0x10A0, 0x00DBB000, { 0x0F, 0x71, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_YWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSRA[] = {
	// 0F E1 /r1 PSRAW mm,mm/m64
	// 0F E2 /r1 PSRAD mm,mm/m64
	{ "psraw", 0x0000, 0x00D88000, { 0x0F, 0xE1, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	{ "psrad", 0x0000, 0x00D88000, { 0x0F, 0xE2, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F E1 /r PSRAW xmm1,xmm2/m128
	// 66 0F E2 /r PSRAD xmm1,xmm2/m128
	{ "psraw", 0x1000, 0x00D88000, { 0x0F, 0xE1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	{ "psrad", 0x1000, 0x00D88000, { 0x0F, 0xE2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E1 /r VPSRAW xmm1,xmm2,xmm3/m128
	// VEX.NDS.128.66.0F.WIG E2 /r VPSRAD xmm1,xmm2,xmm3/m128
	{ "vpsraw", 0x10C0, 0x00D88000, { 0x0F, 0xE1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	{ "vpsrad", 0x10C0, 0x00D88000, { 0x0F, 0xE2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E1 /r VPSRAW ymm1, ymm2, xmm3/m128
	// VEX.NDS.256.66.0F.WIG E2 /r VPSRAD ymm1, ymm2, xmm3/m128
	{ "vpsraw", 0x10A0, 0x00D88000, { 0x0F, 0xE1, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	{ "vpsrad", 0x10A0, 0x00D88000, { 0x0F, 0xE2, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// 0F 71 /4 ib1 PSRAW mm,imm8
	// 0F 72 /4 ib1 PSRAD mm,imm8
	{ "psraw", 0x0000, 0x00DBA000, { 0x0F, 0x71, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	{ "psrad", 0x0000, 0x00DBA000, { 0x0F, 0x72, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 71 /4 ib PSRAW xmm1,imm8
	// 66 0F 72 /4 ib PSRAD xmm1,imm8
	{ "psraw", 0x1000, 0x00DBA000, { 0x0F, 0x71, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	{ "psrad", 0x1000, 0x00DBA000, { 0x0F, 0x72, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 71 /4 ib VPSRAW xmm1,xmm2,imm8
	// VEX.NDD.128.66.0F.WIG 72 /4 ib VPSRAD xmm1,xmm2,imm8
	{ "vpsraw", 0x10C0, 0x00DBA000, { 0x0F, 0x71, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	{ "vpsrad", 0x10C0, 0x00DBA000, { 0x0F, 0x72, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.256.66.0F.WIG 71 /4 ib VPSRAW ymm1,ymm2,imm8
	// VEX.NDD.256.66.0F.WIG 72 /4 ib VPSRAD ymm1,ymm2,imm8
	{ "vpsraw", 0x10A0, 0x00DBA000, { 0x0F, 0x71, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_YWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	{ "vpsrad", 0x10A0, 0x00DBA000, { 0x0F, 0x72, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_YWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSRLDQ[] = {
	// 66 0F 73 /3 ib PSRLDQ xmm1,imm8
	{ NULL, 0x1000, 0x00DB9800, { 0x0F, 0x73, 0x00 }, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 73 /3 ib VPSRLDQ xmm1,xmm2,imm8
	{ "vpsrldq", 0x10C0, 0x00DB9800, { 0x0F, 0x73, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.256.66.0F.WIG 73 /3 ib VPSRLDQ ymm1,ymm2,imm8
	{ "vpsrldq", 0x10A0, 0x00DB9800, { 0x0F, 0x73, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_YWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSRL[] = {
	// 0F D1 /r PSRLW mm,mm/m64
	{ "psrlw", 0x0000, 0x00D88000, { 0x0F, 0xD1, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F D2 /r PSRLD mm,mm/m64
	{ "psrld", 0x0000, 0x00D88000, { 0x0F, 0xD2, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F D3 /r PSRLQ mm,mm/m64
	{ "psrlq", 0x0000, 0x00D88000, { 0x0F, 0xD3, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F D1 /r PSRLW xmm1,xmm2/m128
	{ "psrlw", 0x1000, 0x00D88000, { 0x0F, 0xD1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F D2 /r PSRLD xmm1,xmm2/m128
	{ "psrld", 0x1000, 0x00D88000, { 0x0F, 0xD2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F D3 /r PSRLQ xmm1,xmm2/m128
	{ "psrlq", 0x1000, 0x00D88000, { 0x0F, 0xD3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 0F 71 /2 ib PSRLW mm,imm8
	{ "psrlw", 0x0000, 0x00DB9000, { 0x0F, 0x71, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 0F 72 /2 ib PSRLD mm,imm8
	{ "psrld", 0x0000, 0x00DB9000, { 0x0F, 0x72, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 0F 73 /2 ib PSRLQ mm,imm8
	{ "psrlq", 0x0000, 0x00DB9000, { 0x0F, 0x73, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 71 /2 ib PSRLW xmm1,imm8
	{ "psrlw", 0x1000, 0x00DB9000, { 0x0F, 0x71, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 72 /2 ib PSRLD xmm1,imm8
	{ "psrld", 0x1000, 0x00DB9000, { 0x0F, 0x72, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 66 0F 73 /2 ib PSRLQ xmm1,imm8
	{ "psrlq", 0x1000, 0x00DB9000, { 0x0F, 0x73, 0x00 }, FCML_OP_RM(IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D1 /r VPSRLW xmm1,xmm2,xmm3/m128
	{ "vpsrlw", 0x10C0, 0x00D88000, { 0x0F, 0xD1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D2 /r VPSRLD xmm1,xmm2,xmm3/m128
	{ "vpsrld", 0x10C0, 0x00D88000, { 0x0F, 0xD2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D3 /r VPSRLQ xmm1,xmm2,xmm3/m128
	{ "vpsrlq", 0x10C0, 0x00D88000, { 0x0F, 0xD3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG D1 /r VPSRLW ymm1,ymm2,xmm3/m128
	{ "vpsrlw", 0x10A0, 0x00D88000, { 0x0F, 0xD1, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG D2 /r VPSRLD ymm1,ymm2,xmm3/m128
	{ "vpsrld", 0x10A0, 0x00D88000, { 0x0F, 0xD2, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 71 /2 ib VPSRLW xmm1,xmm2,imm8
	{ "vpsrlw", 0x10C0, 0x00DB9000, { 0x0F, 0x71, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 72 /2 ib VPSRLD xmm1,xmm2,imm8
	{ "vpsrld", 0x10C0, 0x00DB9000, { 0x0F, 0x72, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.128.66.0F.WIG 73 /2 ib VPSRLQ xmm1,xmm2,imm8
	{ "vpsrlq", 0x10C0, 0x00DB9000, { 0x0F, 0x73, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA },
	// VEX.NDD.256.66.0F.WIG 71 /2 ib VPSRLW ymm1,ymm2,imm8
	{ "vpsrlw", 0x10A0, 0x00DB9000, { 0x0F, 0x71, 0x00 }, FCML_OP_VEX_VVVV_SIMD_REG | FCML_OA_W, FCML_OP_RM( IRA_REG_SIMD, FCML_EOS_YWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSUB[] = {
	// 0F F8 /r PSUBB mm,mm/m64
	{ "psubb", 0x0000, 0x00D88000, { 0x0F, 0xF8, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F F9 /r PSUBW mm,mm/m64
	{ "psubw", 0x0000, 0x00D88000, { 0x0F, 0xF9, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F FA /r PSUBD mm,mm/m64
	{ "psubd", 0x0000, 0x00D88000, { 0x0F, 0xFA, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F F8 /r PSUBB xmm1,xmm2/m128
	{ "psubb", 0x1001, 0x00D88000, { 0x0F, 0xF8, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F F9 /r PSUBW xmm1,xmm2/m128
	{ "psubw", 0x1001, 0x00D88000, { 0x0F, 0xF9, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F FA /r PSUBD xmm1,xmm2/m128
	{ "psubd", 0x1001, 0x00D88000, { 0x0F, 0xFA, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F8 /r VPSUBB xmm1,xmm2,xmm3/m128
	{ "vpsubb", 0x10C0, 0x00D88000, { 0x0F, 0xF8, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG F9 /r VPSUBW xmm1,xmm2,xmm3/m128
	{ "vpsubw", 0x10C0, 0x00D88000, { 0x0F, 0xF9, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG FA /r VPSUBD xmm1,xmm2,xmm3/m128
	{ "vpsubd", 0x10C0, 0x00D88000, { 0x0F, 0xFA, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG F8 /r VPSUBB ymm1,ymm2,ymm3/m256
	{ "vpsubb", 0x10A0, 0x00D88000, { 0x0F, 0xF8, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG F9 /r VPSUBW ymm1,ymm2,ymm3/m256
	{ "vpsubw", 0x10A0, 0x00D88000, { 0x0F, 0xF9, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG FA /r VPSUBD ymm1,ymm2,ymm3/m256
	{ "vpsubd", 0x10A0, 0x00D88000, { 0x0F, 0xFA, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG FB /r VPSUBQ ymm1,ymm2,ymm3/m256
	{ "vpsubq", 0x10A0, 0x00D88000, { 0x0F, 0xFB, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSUBQ[] = {
	// 0F FB /r PSUBQ mm1,mm2/m64
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xFB, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F FB /r PSUBQ xmm1,xmm2/m128
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0xFB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG FB/r VPSUBQ xmm1,xmm2,xmm3/m128
	{ "vpsubq", 0x10C0, 0x00D88000, { 0x0F, 0xFB, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_128, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSUBS[] = {
	// 0F E8 /r PSUBSB mm,mm/m64
	{ "psubsb", 0x0000, 0x00D88000, { 0x0F, 0xE8, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F E9 /r PSUBSW mm,mm/m64
	{ "psubsw", 0x0000, 0x00D88000, { 0x0F, 0xE9, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F E8 /r PSUBSB xmm1,xmm2/m128
	{ "psubsb", 0x1000, 0x00D88000, { 0x0F, 0xE8, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F E9 /r PSUBSW xmm1,xmm2/m128
	{ "psubsw", 0x1000, 0x00D88000, { 0x0F, 0xE9, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E8 /r VPSUBSB xmm1,xmm2,xmm3/m128
	{ "vpsubsb", 0x10C0, 0x00D88000, { 0x0F, 0xE8, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG E9 /r VPSUBSW xmm1,xmm2,xmm3/m128
	{ "vpsubsw", 0x10C0, 0x00D88000, { 0x0F, 0xE9, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E8 /r VPSUBSB ymm1,ymm2,ymm3/m256
	{ "vpsubsb", 0x10A0, 0x00D88000, { 0x0F, 0xE8, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG E9 /r VPSUBSW ymm1,ymm2,ymm3/m256
	{ "vpsubsw", 0x10A0, 0x00D88000, { 0x0F, 0xE9, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSUBUS[] = {
	// 0F D8 /r PSUBUSB mm,mm/m64
	{ "psubusb", 0x0000, 0x00D88000, { 0x0F, 0xD8, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F D9 /r1 PSUBUSW mm,mm/m64
	{ "psubusw", 0x0000, 0x00D88000, { 0x0F, 0xD9, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F D8 /r PSUBUSB xmm1,xmm2/m128
	{ "psubusb", 0x1000, 0x00D88000, { 0x0F, 0xD8, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F D9 /r PSUBUSW xmm1,xmm2/m128
	{ "psubusw", 0x1000, 0x00D88000, { 0x0F, 0xD9, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D8 /r VPSUBUSB xmm1,xmm2,xmm3/m128
	{ "vpsubusb", 0x10C0, 0x00D88000, { 0x0F, 0xD8, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG D9 /r VPSUBUSW xmm1,xmm2,xmm3/m128
	{ "vpsubusw", 0x10C0, 0x00D88000, { 0x0F, 0xD9, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG D8 /r VPSUBUSB ymm1,ymm2,ymm3/m256
	{ "vpsubusb", 0x10A0, 0x00D88000, { 0x0F, 0xD8, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG D9 /r VPSUBUSW ymm1,ymm2,ymm3/m256
	{ "vpsubusw", 0x10A0, 0x00D88000, { 0x0F, 0xD9, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PTEST[] = {
	// 66 0F 38 17 /r PTEST xmm1,xmm2/m128
	{ "ptest", 0x1000, 0x00EC8000, { 0x0F, 0x38, 0x17 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F38.WIG 17 /r VPTEST xmm1,xmm2/m128
	// VEX.256.66.0F38.WIG 17 /r VPTEST ymm1,ymm2/m256
	{ "vptest", 0x1180, 0x00EC8000, { 0x0F, 0x38, 0x17 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PUNPCKL[] = {
	// 0F 60 /r PUNPCKLBW mm,mm/m32
	{ "punpcklbw", 0x0000, 0x00D88000, { 0x0F, 0x60, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX_32, FCML_NA, FCML_NA },
	// 0F 61 /r PUNPCKLWD mm,mm/m32
	{ "punpcklwd", 0x0000, 0x00D88000, { 0x0F, 0x61, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX_32, FCML_NA, FCML_NA },
	// 0F 62 /r PUNPCKLDQ mm,mm/m32
	{ "punpckldq", 0x0000, 0x00D88000, { 0x0F, 0x62, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX_32, FCML_NA, FCML_NA },
	// 66 0F 60 /r PUNPCKLBW xmm1,xmm2/m128
	{ "punpcklbw", 0x1000, 0x00D88000, { 0x0F, 0x60, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 61 /r PUNPCKLWD xmm1,xmm2/m128
	{ "punpcklwd", 0x1000, 0x00D88000, { 0x0F, 0x61, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 62 /r PUNPCKLDQ xmm1,xmm2/m128
	{ "punpckldq", 0x1000, 0x00D88000, { 0x0F, 0x62, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 6C /r PUNPCKLQDQ xmm1,xmm2/m128
	{ "punpcklqdq", 0x1000, 0x00D88000, { 0x0F, 0x6C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 60 /r VPUNPCKLBW xmm1,xmm2,xmm3/m128
	{ "vpunpcklbw", 0x10C0, 0x00D88000, { 0x0F, 0x60, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 61 /r VPUNPCKLWD xmm1,xmm2,xmm3/m128
	{ "vpunpcklwd", 0x10C0, 0x00D88000, { 0x0F, 0x61, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 62 /r VPUNPCKLDQ xmm1,xmm2,xmm3/m128
	{ "vpunpckldq", 0x10C0, 0x00D88000, { 0x0F, 0x62, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 6C /r VPUNPCKLQDQ xmm1,xmm2,xmm3/m128
	{ "vpunpcklqdq", 0x10C0, 0x00D88000, { 0x0F, 0x6C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 60 /r VPUNPCKLBW ymm1,ymm2,ymm3/m256
	{ "vpunpcklbw", 0x10A0, 0x00D88000, { 0x0F, 0x60, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 61 /r VPUNPCKLWD ymm1,ymm2,ymm3/m256
	{ "vpunpcklwd", 0x10A0, 0x00D88000, { 0x0F, 0x61, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 62 /r VPUNPCKLDQ ymm1,ymm2,ymm3/m256
	{ "vpunpckldq", 0x10A0, 0x00D88000, { 0x0F, 0x62, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 6C /r VPUNPCKLQDQ ymm1,ymm2,ymm3/m256
	{ "vpunpcklqdq", 0x10A0, 0x00D88000, { 0x0F, 0x6C, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PUNPCKH[] = {
	// 0F 68 /r PUNPCKHBW mm,mm/m64
	{ "punpckhbw", 0x0000, 0x00D88000, { 0x0F, 0x68, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 69 /r PUNPCKHWD mm,mm/m64
	{ "punpckhwd", 0x0000, 0x00D88000, { 0x0F, 0x69, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 0F 6A /r PUNPCKHDQ mm,mm/m64
	{ "punpckhdq", 0x0000, 0x00D88000, { 0x0F, 0x6A, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F 68 /r PUNPCKHBW xmm1,xmm2/m128
	{ "punpckhbw", 0x1000, 0x00D88000, { 0x0F, 0x68, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 69 /r PUNPCKHWD xmm1,xmm2/m128
	{ "punpckhwd", 0x1000, 0x00D88000, { 0x0F, 0x69, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 6A /r PUNPCKHDQ xmm1,xmm2/m128
	{ "punpckhdq", 0x1000, 0x00D88000, { 0x0F, 0x6A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// 66 0F 6D /r PUNPCKHQDQ xmm1,xmm2/m128
	{ "punpckhqdq", 0x1000, 0x00D88000, { 0x0F, 0x6D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 68 /r VPUNPCKHBW xmm1,xmm2,xmm3/m128
	{ "vpunpckhbw", 0x10C0, 0x00D88000, { 0x0F, 0x68, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 69 /r VPUNPCKHWD xmm1,xmm2,xmm3/m128
	{ "vpunpckhwd", 0x10C0, 0x00D88000, { 0x0F, 0x69, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 6A /r VPUNPCKHDQ xmm1,xmm2,xmm3/m128
	{ "vpunpckhdq", 0x10C0, 0x00D88000, { 0x0F, 0x6A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.128.66.0F.WIG 6D /r VPUNPCKHQDQ xmm1,xmm2,xmm3/m128
	{ "vpunpckhqdq", 0x10C0, 0x00D88000, { 0x0F, 0x6D, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 68 /r VPUNPCKHBW ymm1,ymm2,ymm3/m256
	{ "vpunpckhbw", 0x10A0, 0x00D88000, { 0x0F, 0x68, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 69 /r VPUNPCKHWD ymm1,ymm2,ymm3/m256
	{ "vpunpckhwd", 0x10A0, 0x00D88000, { 0x0F, 0x69, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 6A /r VPUNPCKHDQ ymm1,ymm2,ymm3/m256
	{ "vpunpckhdq", 0x10A0, 0x00D88000, { 0x0F, 0x6A, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA },
	// VEX.NDS.256.66.0F.WIG 6D /r VPUNPCKHQDQ ymm1,ymm2,ymm3/m256
	{ "vpunpckhqdq", 0x10A0, 0x00D88000, { 0x0F, 0x6D, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PUSH[] = {
	...
	{ NULL, 0x0001, 0x0045B000, { 0xFF, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x0185B000, { 0xFF, 0x00, 0x00 }, FCML_OP_MODRM_RM_16_W, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x0685B000, { 0xfF, 0x00, 0x00 }, FCML_OP_MODRM_RM_64_W, FCML_NA, FCML_NA, FCML_NA },
	// 50+rw PUSH r16 O Valid Valid Push r16.
	// 50+rd PUSH r32 O N.E. Valid Push r32.
	// 50+rd PUSH r64 O Valid N.E. Push r64.
	{ NULL, 0x0001, 0x00440000, { 0x50, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x01840000, { 0x50, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_WORD ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x06840000, { 0x50, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA, FCML_NA, FCML_NA },
	// 6A PUSH imm8 I Valid Valid Push imm8.
	{ NULL, 0x0001, 0x00C40000, { 0x6A, 0x00, 0x00 }, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA, FCML_NA },
	// 68 PUSH imm16 I Valid Valid Push imm16.
	{ NULL, 0x0001, 0x01C40000, { 0x68, 0x00, 0x00 }, FCML_OP_IW_EX_EOSA, FCML_NA, FCML_NA, FCML_NA },
	// 68 PUSH imm32 I Valid Valid Push imm32.
	{ NULL, 0x0001, 0x06C40000, { 0x68, 0x00, 0x00 }, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00440000, { 0x1E, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_DS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0x06, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_ES, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0x16, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_SS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x0001, 0x00440000, { 0x0E, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_CS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// 0F A0 PUSH FS NP Valid Valid Push FS.
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0xA0, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_FS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA },
	// 0F A8 PUSH GS NP Valid Valid Push GS.
	{ NULL, 0x0001, 0x00D80000, { 0x0F, 0xA8, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_SEG, _IRA_REG_GS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PUSHA[] = {
	...
	{ NULL, 0x0001, 0x01440000, { 0x60, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 60 PUSHAD NP Invalid Valid Push EAX, ECX, EDX, EBX, original ESP, EBP, ESI, and EDI.
	{ "pushad", 0x0001, 0x02440000, { 0x60, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PUSHF[] = {
	// 9C PUSHF NP Valid Valid Push lower 16 bits of EFLAGS.
	{ NULL, 0x0000, 0x01C40000, { 0x9C, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 9C PUSHFD NP N.E. Valid Push EFLAGS.
	{ "pushfd", 0x0000, 0x02440000, { 0x9C, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// 9C PUSHFQ NP Valid N.E. Push RFLAGS.
	{ "pushfq", 0x0000, 0x04840000, { 0x9C, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PXOR[] = {
	// 0F EF /r PXOR mm,mm/m64
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xEF, 0x00 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA },
	// 66 0F EF /r PXOR xmm1,xmm2/m128
	{ NULL, 0x1001, 0x00D88000, { 0x0F, 0xEF, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.NDS.128.66.0F.WIG EF /r VPXOR xmm1,xmm2,xmm3/m128
	{ "vpxor", 0x10C0, 0x00D88000, { 0x0F, 0xEF, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VEX.NDS.256.66.0F.WIG EF /r VPXOR ymm1,ymm2,ymm3/m256
	{ "vpxor", 0x10A0, 0x00D88000, { 0x0F, 0xEF, 0x00 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RCL[] = {
	// D0 /2 RCL r/m8, 1
	// REX + D0 /2 RCL r/m8, 1
	{ NULL, 0x0000, 0x00C59000, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D2 /2 RCL r/m8, CL
	// REX + D2 /2 RCL r/m8, CL
	{ NULL, 0x0000, 0x00C59000, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C0 /2 ib RCL r/m8, imm8
	// REX + C0 /2 ib RCL r/m8, imm8
	{ NULL, 0x0000, 0x00C59000, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// D1 /2 RCL r/m16, 1
	// D1 /2 RCL r/m32, 1
	// REX.W + D1 /2 RCL r/m64, 1
	{ NULL, 0x0000, 0x00C59000, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D3 /2 RCL r/m16, CL
	// D3 /2 RCL r/m32, CL
	// REX.W + D3 /2 RCL r/m64, CL
	{ NULL, 0x0000, 0x00C59000, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C1 /2 ib RCL r/m16, imm8
	// C1 /2 ib RCL r/m32, imm8
	// REX.W + C1 /2 ib RCL r/m64, imm8
	{ NULL, 0x0000, 0x00C59000, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RCR[] = {
	// D0 /3 RCR r/m8, 1
	// REX + D0 /3 RCR r/m8, 1
	{ NULL, 0x0000, 0x00C59800, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D2 /3 RCR r/m8, CL
	// REX + D2 /3 RCR r/m8, CL
	{ NULL, 0x0000, 0x00C59800, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C0 /3 ib RCR r/m8, imm8
	// REX + C0 /3 ib RCR r/m8, imm8
	{ NULL, 0x0000, 0x00C59800, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// D1 /3 RCR r/m16, 1
	// D1 /3 RCR r/m32, 1
	// REX.W + D1 /3 RCR r/m64, 1
	{ NULL, 0x0000, 0x00C59800, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D3 /3 RCR r/m16, CL
	// D3 /3 RCR r/m32, CL
	// REX.W + D3 /3 RCR r/m64, CL
	{ NULL, 0x0000, 0x00C59800, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C1 /3 ib RCR r/m16, imm8
	// C1 /3 ib RCR r/m32, imm8
	// REX.W + C1 /3 ib RCR r/m64, imm8
	{ NULL, 0x0000, 0x00C59800, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ROL[] = {
	// D0 /0 ROL r/m8, 1
	// REX + D0 /0 ROL r/m8, 1
	{ NULL, 0x0000, 0x00C58000, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D2 /0 ROL r/m8, CL
	// REX + D2 /0 ROL r/m8, CL
	{ NULL, 0x0000, 0x00C58000, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C0 /0 ib ROL r/m8, imm8
	// REX + C0 /0 ib ROL r/m8, imm8
	{ NULL, 0x0000, 0x00C58000, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// D1 /0 ROL r/m16, 1
	// D1 /0 ROL r/m32, 1
	// REX.W + D1 /0 ROL r/m64, 1
	{ NULL, 0x0000, 0x00C58000, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D3 /0 ROL r/m16, CL
	// D3 /0 ROL r/m32, CL
	// REX.W + D3 /0 ROL r/m64, CL
	{ NULL, 0x0000, 0x00C58000, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C1 /0 ib ROL r/m16, imm8
	// C1 /0 ib ROL r/m32, imm8
	// C1 /0 ib ROL r/m64, imm8
	{ NULL, 0x0000, 0x00C58000, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ROR[] = {
	// D0 /1 ROR r/m8, 1
	// REX + D0 /1 ROR r/m8, 1
	{ NULL, 0x0000, 0x00C58800, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D2 /1 ROR r/m8, CL
	// REX + D2 /1 ROR r/m8, CL
	{ NULL, 0x0000, 0x00C58800, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C0 /1 ib ROR r/m8, imm8
	// REX + C0 /1 ib ROR r/m8, imm8
	{ NULL, 0x0000, 0x00C58800, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// D1 /1 ROR r/m16, 1
	// D1 /1 ROR r/m32, 1
	// REX.W + D1 /1 ROR r/m64, 1
	{ NULL, 0x0000, 0x00C58800, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D3 /1 ROR r/m16, CL
	// D3 /1 ROR r/m32, CL
	// REX.W + D3 /1 ROR r/m64, CL
	{ NULL, 0x0000, 0x00C58800, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C1 /1 ib ROR r/m16, imm8
	// C1 /1 ib ROR r/m32, imm8
	// REX.W + C1 /1 ib ROR r/m64, imm8
	{ NULL, 0x0000, 0x00C58800, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

// XMMWORD
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RCPPS[] = {
	// 0F 53 /r RCPPS xmm1,xmm2/m128
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0x53, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.0F.WIG 53 /r VRCPPS xmm1,xmm2/m128
	// VEX.256.0F.WIG 53 /r VRCPPS ymm1,ymm2/m256
	{ "vrcpps", 0x0181, 0x00D88000, { 0x0F, 0x53, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RCPSS[] = {
	// F3 0F 53 /r RCPSS xmm1,xmm2/m32
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0x53, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.LIG.F3.0F.WIG 53 /r VRCPSS xmm1,xmm2,xmm3/m32
	{ "vrcpss", 0x40C0, 0x00D88000, { 0x0F, 0x53, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDFSBASE[] = {
	...
	{ NULL, 0x4000, 0x039B8000, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA },
	{ NULL, 0x4000, 0x049B8000, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA },
	// F3 0F AE /1 RDGSBASE r32
	// REX.W + F3 0F AE /1 RDGSBASE r64
	{ "rdgsbase", 0x4000, 0x039B8800, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA },
	{ "rdgsbase", 0x4000, 0x049B8800, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDRAND[] = {
	...
	{ NULL, 0x0000, 0x00DBB000, { 0x0F, 0xC7, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDTSCP[] = {
	// 0F 01 F9 RDTSCP
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xF9 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDTSC[] = {
	// 0F 31 RDTSC
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x31, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDPMC[] = {
	// 0F 33 RDPMC
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x33, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDMSR[] = {
	// 0F 32 RDMSR
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x32, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RET[] = {
	// C3 RET
	// CB RET
	{ NULL, 0x0000, 0x00C40000, { 0xC3, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	{ "retf", 0x0000, 0x00C40000, { 0xCB, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
	// C2 iw RET imm16
	// CA iw RET imm16
	{ NULL, 0x0000, 0x00C40000, { 0xC2, 0x00, 0x00 }, FCML_OP_IW, FCML_NA, FCML_NA, FCML_NA },
	{ "retf", 0x0000, 0x00C40000, { 0xCA, 0x00, 0x00 }, FCML_OP_IW, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ROUNDPD[] = {
	// 66 0F 3A 09 /r ib ROUNDPD xmm1,xmm2/m128,imm8
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x3A, 0x09 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG 09 /r ib VROUNDPD xmm1,xmm2/m128,imm8
	// VEX.256.66.0F3A.WIG 09 /r ib VROUNDPD ymm1,ymm2/m256,imm8
	{ "vroundpd", 0x1180, 0x00EC8000, { 0x0F, 0x3A, 0x09 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ROUNDPS[] = {
	// 66 0F 3A 08 /r ib ROUNDPS xmm1,xmm2/m128,imm8
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x3A, 0x08 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	// VEX.128.66.0F3A.WIG 08 /r ib VROUNDPS xmm1,xmm2/m128,imm8
	// VEX.256.66.0F3A.WIG 08 /r ib VROUNDPS ymm1,ymm2/m256,imm8
	{ "vroundps", 0x1180, 0x00EC8000, { 0x0F, 0x3A, 0x08 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ROUNDSD[] = {
	// 66 0F 3A 0B /r ib ROUNDSD xmm1,xmm2/m64,imm8
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x3A, 0x0B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_OP_IB, FCML_NA },
	// VEX.NDS.LIG.66.0F3A.WIG 0B /r ib VROUNDSD xmm1,xmm2,xmm3/m64,imm8
	{ "vroundsd", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x0B }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ROUNDSS[] = {
	// 66 0F 3A 0A /r ib ROUNDSS xmm1,xmm2/m32,imm8
	{ NULL, 0x1000, 0x00EC8000, { 0x0F, 0x3A, 0x0A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_OP_IB, FCML_NA },
	// VEX.NDS.LIG.66.0F3A.WIG 0A ib VROUNDSS xmm1,xmm2,xmm3/m32,imm8
	{ "vroundss", 0x10C0, 0x00EC8000, { 0x0F, 0x3A, 0x0A }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RSM[] = {
	...
	{ NULL, 0x0000, 0x00580000, { 0x0F, 0xAA, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RSQRTPS[] = {
	// 0F 52 /r RSQRTPS xmm1,xmm2/m128
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x52, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.0F.WIG 52 /r VRSQRTPS xmm1,xmm2/m128
	// VEX.256.0F.WIG 52 /r VRSQRTPS ymm1,ymm2/m256
	{ "vrsqrtps", 0x0180, 0x00D88000, { 0x0F, 0x52, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RSQRTSS[] = {
	// F3 0F 52 /r RSQRTSS xmm1,xmm2/m32
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0x52, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.LIG.F3.0F.WIG 52 /r VRSQRTSS xmm1,xmm2,xmm3/m32
	{ "vrsqrtss", 0x40C0, 0x00D88000, { 0x0F, 0x52, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SAHF[] = {
	...
	{ NULL, 0x0000, 0x00C40000, { 0x9E, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SAR[] = {
	// D0 /7 SAR r/m8, 1
	// REX + D0 /7 SAR r/m8
	{ NULL, 0x0000, 0x00C5B800, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C5B800, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C5B800, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C5B800, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C5B800, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C5B800, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHL[] = {
	// D0 /4 SHL r/m8,1
	// REX + D0 /4 SHL r/m8,1
	{ NULL, 0x0000, 0x00C5A000, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D2 /4 SHL r/m8,CL
	// REX + D2 /4 SHL r/m8,CL
	{ NULL, 0x0000, 0x00C5A000, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C0 /4 ib SHL r/m8,imm8
	// REX + C0 /4 ib SHL r/m8,imm8
	{ NULL, 0x0000, 0x00C5A000, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// D1 /4 SHL r/m16,1
	// D1 /4 SHL r/m32,1
	// REX.W + D1 /4 SHL r/m64,1
	{ NULL, 0x0000, 0x00C5A000, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D3 /4 SHL r/m16,CL
	// D3 /4 SHL r/m32,CL
	// REX.W + D3 /4 SHL r/m64,CL
	{ NULL, 0x0000, 0x00C5A000, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C1 /4 ib SHL r/m16,imm8
	// C1 /4 ib SHL r/m32,imm8
	// REX.W + C1 /4 ib SHL r/m64,imm8
	{ NULL, 0x0000, 0x00C5A000, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHR[] = {
	// D0 /5 SHR r/m8,1
	// REX + D0 /5 SHR r/m8,1
	{ NULL, 0x0000, 0x00C5A800, { 0xD0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D2 /5 SHR r/m8,CL
	// REX + D2 /5 SHR r/m8,CL
	{ NULL, 0x0000, 0x00C5A800, { 0xD2, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C0 /5 ib SHR r/m8,imm8
	// REX + C0 /5 ib SHR r/m8,imm8
	{ NULL, 0x0000, 0x00C5A800, { 0xC0, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// D1 /5 SHR r/m16,1
	// D1 /5 SHR r/m32,1
	// REX.W + D1 /5 SHR r/m64,1
	{ NULL, 0x0000, 0x00C5A800, { 0xD1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_IB(1), FCML_NA, FCML_NA },
	// D3 /5 SHR r/m16,CL
	// D3 /5 SHR r/m32,CL
	// REX.W + D3 /5 SHR r/m64,CL
	{ NULL, 0x0000, 0x00C5A800, { 0xD3, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA, FCML_NA },
	// C1 /5 ib SHR r/m16,imm8
	// C1 /5 ib SHR r/m32,imm8
	// REX.W + C1 /5 ib SHR r/m64,imm8
	{ NULL, 0x0000, 0x00C5A800, { 0xC1, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SBB[] = {
	// 1C ib SBB AL,imm8
	{ NULL, 0x0001, 0x00C40000, { 0x1C, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 1D iw SBB AX,imm16
	// 1D id SBB EAX,imm32
	{ NULL, 0x0001, 0x00C40000, { 0x1D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 1D id SBB RAX,imm32
	{ NULL, 0x0009, 0x00840000, { 0x1D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 80 /3 ib SBB r/m8,imm8
	// REX + 80 /3 ib SBB r/m8,imm8
	{ NULL, 0x0001, 0x00C59800, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// 81 /3 iw SBB r/m16,imm16
	// 81 /3 id SBB r/m32,imm32
	{ NULL, 0x0001, 0x00C59800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /3 id SBB r/m64,imm32
	{ NULL, 0x0009, 0x00859800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 83 /3 ib SBB r/m16,imm8
	// 83 /3 ib SBB r/m32,imm8
	{ NULL, 0x0001, 0x00C59800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /3 ib SBB r/m64,imm8
	{ NULL, 0x0009, 0x00859800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 18 /r SBB r/m8,r8
	// REX + 18 /r SBB r/m8,r8
	{ NULL, 0x0001, 0x00C48000, { 0x18, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	// 19 /r SBB r/m16,r16
	// 19 /r SBB r/m32,r32
	// REX.W + 19 /r SBB r/m64,r64
	{ NULL, 0x0001, 0x00C48000, { 0x19, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 1A /r SBB r8,r/m8
	// REX + 1A /r SBB r8,r/m8
	{ NULL, 0x0001, 0x00C48000, { 0x1A, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	// 1B /r SBB r16,r/m16
	// 1B /r SBB r32,r/m32
	// REX.W + 1B /r SBB r64,r/m64
	{ NULL, 0x0001, 0x00C48000, { 0x1B, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SETcc[] = {
	...
	// REX + 0F 97 SETA r/m8*
	{ NULL, 0x0001, 0x00D80040, { 0x0F, 0x97, 0x00 }, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SFENCE[] = {
	{ NULL, 0x0001, 0x00EC0000, { 0x0F, 0xAE, 0xF8 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SGDT[] = {
	// 0F 01 /0 SGDT m
	{ NULL, 0x0000, 0x00D98000, { 0x0F, 0x01, 0x00 }, FCML_OP_MODRM_M_UNDEF, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHLD[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xA4, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R,FCML_OP_IB, FCML_NA },
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xA5, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R,FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHRD[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xAC, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R,FCML_OP_IB, FCML_NA },
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xAD, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R,FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_CL, FCML_EOS_BYTE ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SKINIT[] = {
	...
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xDE }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_DWORD ), FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SLWPCB[] = {
	// SLWPCB reg32 8F RXB.09 0.1111.0.00 12 /1
	{ NULL, 0x0450, 0x00DB8800, { 0x09, 0x12, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA, FCML_NA },
	// SLWPCB reg64 8F RXB.09 1.1111.0.00 12 /1
	{ NULL, 0x0448, 0x00DB8800, { 0x09, 0x12, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHUFPD[] = {
	...
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0xC6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	...
	{ "vshufpd", 0x1080, 0x00D88000, { 0x0F, 0xC6, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHUFPS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0xC6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA },
	...
	{ "vshufps", 0x0080, 0x00D88000, { 0x0F, 0xC6, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SIDT[] = {
	// 0F 01 /1 SIDT m M Valid Valid Store IDTR to m.
	{ NULL, 0x0000, 0x80D98800, { 0x0F, 0x01, 0x00 }, FCML_OP_MODRM_M_UNDEF, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SLDT[] = {
	...
	{ NULL, 0x0010, 0x03D98000, { 0x0F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16_W, FCML_NA, FCML_NA, FCML_NA },
	// REX.W + 0F 00 /0 SLDT r64/m16 M Valid Valid Stores segment selector from LDTR in r64/m16.
	{ NULL, 0x0008, 0x04998000, { 0x0F, 0x00, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_WORD, FCML_RMF_RM ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SMSW[] = {
	...
	{ NULL, 0x0000, 0x00D9A000, { 0x0F, 0x01, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_WORD, FCML_RMF_RM ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SQRTPD[] = {
	// 66 0F 51 /r SQRTPD xmm1,xmm2/m128
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	// VEX.128.66.0F.WIG 51 /r VSQRTPD xmm1,xmm2/m128
	// VEX.256.66.0F.WIG 51 /r VSQRTPD ymm1,ymm2/m256
	{ "vsqrtpd", 0x1180, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SQRTPS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vsqrtps", 0x0180, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SQRTSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ "vsqrtsd", 0x20C0, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SQRTSS[] = {
	...
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	...
	{ "vsqrtss", 0x40C0, 0x00D88000, { 0x0F, 0x51, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STC[] = {
	// F9 STC NP Valid Valid Set CF flag.
	{ NULL, 0x0000, 0x00C40000, { 0xF9, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STD[] = {
	// FD STD NP Valid Valid Set DF flag.
	{ NULL, 0x0000, 0x00C40000, { 0xFD, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STGI[] = {
	// STGI 0F 01 DC Sets the global interrupt flag (GIF).
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xDC }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STI[] = {
	...
	{ NULL, 0x0000, 0x00C40000, { 0xFB, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STMXCSR[] = {
	...
	{ NULL, 0x0000, 0x80D99800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA },
	// VEX.LZ.0F.WIG AE /3 VSTMXCSR m32 M V/V AVX Store contents of MXCSR register to m32.
	{ "vstmxcsr", 0x01C0, 0x80D99800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_32, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STR[] = {
	...
	{ NULL, 0x0000, 0x00D98800, { 0x0F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16_W, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SUB[] = {
	// 2C ib SUB AL, imm8 I Valid Valid Subtract imm8 from AL.
	{ NULL, 0x0001, 0x00C40000, { 0x2C, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 2D iw SUB AX, imm16 I Valid Valid Subtract imm16 from AX.
	// 2D id SUB EAX, imm32 I Valid Valid Subtract imm32 from EAX.
	{ NULL, 0x0001, 0x00C40000, { 0x2D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 2D id SUB RAX, imm32 I Valid N.E. Subtract imm32 sign-extended to 64-bits from RAX.
	{ NULL, 0x0009, 0x00840000, { 0x2D, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5A800, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5A800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /5 id SUB r/m64, imm32 MI Valid N.E. Subtract imm32 sign-extended to 64-bits from r/m64.
	{ NULL, 0x0009, 0x0085A800, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C5A800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /5 ib SUB r/m64, imm8 MI Valid N.E. Subtract sign-extended imm8 from r/m64.
	{ NULL, 0x0009, 0x0085A800, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 28 /r SUB r/m8, r8 MR Valid Valid Subtract r8 from r/m8.
	// REX + 28 /r SUB r/m8*, r8* MR Valid N.E. Subtract r8 from r/m8.
	{ NULL, 0x0001, 0x00C48000, { 0x28, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x29, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 2A /r SUB r8, r/m8 RM Valid Valid Subtract r/m8 from r8.
	// REX + 2A /r SUB r8*, r/m8* RM Valid N.E. Subtract r/m8 from r8.
	{ NULL, 0x0001, 0x00C48000, { 0x2A, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x2B, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_T1MSKC[] = {
	// T1MSKC reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /7
	{ NULL, 0x0450, 0x00D9B800, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// T1MSKC reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /7
	{ NULL, 0x0448, 0x00D9B800, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SUBPD[] = {
	...
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vsubpd", 0x1080, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SUBPS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vsubps", 0x0080, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SUBSD[] = {
	...
	{ NULL, 0x2001, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ "vsubsd", 0x20C0, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_64, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SUBSS[] = {
	// F3 0F 5C /r SUBSS xmm1,xmm2/m32
	{ NULL, 0x4001, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	// VEX.NDS.LIG.F3.0F.WIG 5C /r VSUBSS xmm1,xmm2,xmm3/m32
	{ "vsubss", 0x40C0, 0x00D88000, { 0x0F, 0x5C, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L_32, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SWAPGS[] = {
	...
	{ NULL, 0x0000, 0x00AC0000, { 0x0F, 0x01, 0xF8 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SYSCALL[] = {
	...
	{ NULL, 0x0000, 0x00980000, { 0x0F, 0x05, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SYSENTER[] = {
	...
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x34, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SYSEXIT[] = {
	...
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x35, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SYSRET[] = {
	...
	{ NULL, 0x0000, 0x00980000, { 0x0F, 0x07, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_TEST[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA8, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C40000, { 0xA9, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + A9 id TEST RAX, imm32 I Valid N.E. AND imm32 sign-extended to 64-bits with RAX; set SF, ZF, PF according to result.
	{ NULL, 0x0009, 0x00840000, { 0xA9, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C58000, { 0xF6, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C58000, { 0xF7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0009, 0x00858000, { 0xF7, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x84, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x85, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UCOMISD[] = {
	...
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x2E, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ "vucomisd", 0x11C0, 0x00D88000, { 0x0F, 0x2E, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UCOMISS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x2E, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA },
	...
	{ "vucomiss", 0x01C0, 0x00D88000, { 0x0F, 0x2E, 0x00 }, FCML_OP_MODRM_R_XMM, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UD2[] = {
	// 0F 0B UD2 NP Valid Valid Raise invalid opcode exception.
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x0B, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UNPCKHPD[] = {
	...
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x15, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vunpckhpd", 0x1080, 0x00D88000, { 0x0F, 0x15, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UNPCKHPS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x15, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vunpckhps", 0x0080, 0x00D88000, { 0x0F, 0x15, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UNPCKLPD[] = {
	...
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x14, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vunpcklpd", 0x1080, 0x00D88000, { 0x0F, 0x14, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_UNPCKLPS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x14, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vunpcklps", 0x0080, 0x00D88000, { 0x0F, 0x14, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VCVTPH2PS[] = {
	...
	{ NULL, 0x11D0, 0x00EC8000, { 0x0F, 0x38, 0x13 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA },
	...
	{ NULL, 0x11B0, 0x00EC8000, { 0x0F, 0x38, 0x13 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VCVTPS2PH[] = {
	...
	{ NULL, 0x11D0, 0x00EC8000, { 0x0F, 0x3A, 0x1D }, FCML_OP_MODRM_RM_XMM_64_W, FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA },
	...
	{ NULL, 0x11B0, 0x00EC8000, { 0x0F, 0x3A, 0x1D }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_XMM, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VERR[] = {
	...
	{ NULL, 0x0000, 0x00D9A000, { 0x0F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VERW[] = {
	...
	{ NULL, 0x0000, 0x00D9A800, { 0x0F, 0x00, 0x00 }, FCML_OP_MODRM_RM_16, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VMLOAD[] = {
	// VMLOAD rAX 0F 01 DA Load additional state from VMCB.
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xDA }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_EASA ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VMMCALL[] = {
	...
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xD9 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VMRUN[] = {
	// VMRUN rAX 0F 01 D8 Performs a world-switch to guest.
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xD8 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_EASA ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VMSAVE[] = {
	...
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xDB }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_EASA ), FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERMILPD[] = {
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x0D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x05 },  FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERMILPS[] = {
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x0C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x04 },  FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSLLVD[] = {
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x47 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38.W1 47 /r VPSLLVQ xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F38.W1 47 /r VPSLLVQ ymm1,ymm2,ymm3/m256
	{ "vpsllvq", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x47 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSRLVD[] = {
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x45 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.NDS.128.66.0F38.W1 45 /r VPSRLVQ xmm1,xmm2,xmm3/m128
	// VEX.NDS.256.66.0F38.W1 45 /r VPSRLVQ ymm1,ymm2,ymm3/m256
	{ "vpsrlvq", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x45 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSRAVD[] = {
	...
	{ NULL, 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x46 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERMD[] = {
	...
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x38, 0x36 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERMPD[] = {
	...
	{ NULL, 0x11A8, 0x00EC8000, { 0x0F, 0x3A, 0x01 },  FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERMQ[] = {
	...
	{ NULL, 0x11A8, 0x00EC8000, { 0x0F, 0x3A, 0x00 },  FCML_OP_MODRM_R_YMM_W, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERMPS[] = {
	...
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x38, 0x16 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERM2F128[] = {
	...
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x3A, 0x06 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPERM2I128[] = {
	...
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x3A, 0x46 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VEXTRACTI128[] = {
	...
	{ NULL, 0x11B0, 0x00EC8000, { 0x0F, 0x3A, 0x39 }, FCML_OP_MODRM_RM_XMM_128_W, FCML_OP_MODRM_R_YMM, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VINSERTI128[] = {
	...
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x3A, 0x38 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_YMM_256, FCML_OP_IB }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VTESTPS[] = {
	...
	{ NULL, 0x1190, 0x00EC8000, { 0x0F, 0x38, 0x0E }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA },
	...
	{ "vtestpd", 0x1190, 0x00EC8000, { 0x0F, 0x38, 0x0F }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VGATHERDPD[] = {
	...
	{ NULL, 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x92 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_32), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 93 /r VGATHERQPD xmm1, vm64x, xmm2
	{ "vgatherqpd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0x93 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.256.66.0F38.W1 93 /r VGATHERQPD ymm1, vm64y, ymm2
	{ "vgatherqpd", 0x10A8, 0x00EC8000, { 0x0F, 0x38, 0x93 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VSIB(FCML_VSIB_YMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VGATHERDPS[] = {
	...
	{ NULL, 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x92 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_32), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.256.66.0F38.W0 92 /r VGATHERDPS ymm1,vm32y,ymm2
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x38, 0x92 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VSIB(FCML_VSIB_YMM,FCML_VSIB_IS_32), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 93 /r VGATHERQPS xmm1,vm64x,xmm2
	{ "vgatherqps", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x93 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.256.66.0F38.W0 93 /r VGATHERQPS xmm1,vm64y,xmm2
	{ "vgatherqps", 0x10B0, 0x00EC8000, { 0x0F, 0x38, 0x93 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VSIB(FCML_VSIB_YMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPGATHERDD[] = {
	...
	{ NULL, 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x90 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_32), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.256.66.0F38.W0 90 /r VPGATHERDD ymm1,vm32y,ymm2
	{ NULL, 0x10B0, 0x00EC8000, { 0x0F, 0x38, 0x90 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VSIB(FCML_VSIB_YMM,FCML_VSIB_IS_32), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 91 /r VPGATHERQD xmm1,vm64x,xmm2
	{ "vpgatherqd", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x91 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.256.66.0F38.W0 91 /r VPGATHERQD xmm1,vm64y,xmm2
	{ "vpgatherqd", 0x10B0, 0x00EC8000, { 0x0F, 0x38, 0x91 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VSIB(FCML_VSIB_YMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPGATHERDQ[] = {
	...
	{ NULL, 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x90 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_32), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 91 /r VPGATHERQQ xmm1,vm64x,xmm2
	{ "vpgatherqq", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0x91 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VSIB(FCML_VSIB_XMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA },
	// VEX.DDS.256.66.0F38.W1 91 /r VPGATHERQQ ymm1,vm64y,ymm2
	{ "vpgatherqq", 0x10A8, 0x00EC8000, { 0x0F, 0x38, 0x91 }, FCML_OP_MODRM_R_YMM_W, FCML_OP_VSIB(FCML_VSIB_YMM,FCML_VSIB_IS_64), FCML_OP_VEX_VVVV_SIMD_REG, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VZEROALL[] = {
	...
	{ NULL, 0x01A0, 0x00D80000, { 0x0F, 0x77, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VZEROUPPER[] = {
	...
	{ NULL, 0x01C0, 0x00D80000, { 0x0F, 0x77, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_WAIT[] = {
	...
	{ NULL, 0x0000, 0x00C40000, { 0x9B, 0x00, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_WBINVD[] = {
	...
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x09, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_WRFSBASE[] = {
	...
	{ NULL, 0x4010, 0x03DB9000, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA , FCML_NA, FCML_NA },
	// REX.W + F3 0F AE /2 WRFSBASE r64 M V/I FSGSBASE Load the FS base address with the 64-bit value in the source register.
	{ NULL, 0x4008, 0x049B9000, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA , FCML_NA, FCML_NA },
	// F3 0F AE /3 WRGSBASE r32 M V/I FSGSBASE Load the GS base address with the 32-bit value in the source register.
	{ "wrgsbase", 0x4010, 0x03DB9800, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_DWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA , FCML_NA, FCML_NA },
	// REX.W + F3 0F AE /3 WRGSBASE r64 M V/I FSGSBASE Load the GS base address with the 64-bit value in the source register.
	{ "wrgsbase", 0x4008, 0x049B9800, { 0x0F, 0xAE, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_QWORD, FCML_EOS_UNDEFINED, FCML_RMF_R ), FCML_NA , FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_WRMSR[] = {
	...
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x30, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XADD[] = {
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xC0, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00D88000, { 0x0F, 0xC1, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XCHG[] = {
	...
	{ NULL, 0x0000, 0x00C40001, { 0x90, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA) | FCML_OA_W, FCML_NA, FCML_NA },
	{ NULL, 0x0000, 0x00C40001, { 0x90, 0x00, 0x00 }, FCML_OP_OPCODE_REG( IRA_REG_GPR, FCML_EOS_EOSA) | FCML_OA_W, FCML_OP_EXPLICIT_REG( IRA_REG_GPR, _IRA_REG_EAX, FCML_EOS_EOSA ) | FCML_OA_W, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C48000, { 0x86, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8_W, FCML_NA, FCML_NA },
	{ NULL, 0x0000, 0x00C48000, { 0x86, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8_W, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0000, 0x00C48000, { 0x87, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R_W, FCML_NA, FCML_NA },
	{ NULL, 0x0000, 0x00C48000, { 0x87, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XGETBV[] = {
	...
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xD0 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XLAT[] = {
	...
	{ NULL, 0x0000, 0x00C40000, { 0xD7, 0x00, 0x00 },
			FCML_OP_EXPLICIT_GPS_REG_ADDRESSING( _IRA_REG_BX, FCML_EOS_BYTE, FCML_SEG_ENCODE_REGISTER( _IRA_REG_DS, FCML_SEG_ALLOW_OVERRIDE ) ),
			FCML_NA, FCML_NA, FCML_NA },
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XOR[] = {
	...
	{ NULL, 0x0001, 0x00C40000, { 0x34, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_BYTE ), FCML_OP_IB, FCML_NA, FCML_NA },
	// 35 iw XOR AX, imm16 I Valid Valid AX XOR imm16.
	// 35 id XOR EAX, imm32 I Valid Valid EAX XOR imm32.
	{ NULL, 0x0001, 0x03C40000, { 0x35, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 35 id XOR RAX, imm32 I Valid N.E. RAX XOR imm32 (sign-extended).
	{ NULL, 0x0001, 0x04840000, { 0x35, 0x00, 0x00 }, FCML_OP_EXPLICIT_REG( FCML_REG_GPR, FCML_REG_AL, FCML_EOS_EOSA ) | FCML_OA_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	// 80 /6 ib XOR r/m8, imm8 MI Valid Valid r/m8 XOR imm8.
	// REX + 80 /6 ib XOR r/m8*, imm8 MI Valid N.E. r/m8 XOR imm8.
	{ NULL, 0x0001, 0x00C5B000, { 0x80, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_IB, FCML_NA, FCML_NA },
	// 81 /6 iw XOR r/m16, imm16 MI Valid Valid r/m16 XOR imm16.
	// 81 /6 id XOR r/m32, imm32 MI Valid Valid r/m32 XOR imm32.
	{ NULL, 0x0001, 0x03C5B000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IMM_EOSA, FCML_NA, FCML_NA },
	// REX.W + 81 /6 id XOR r/m64, imm32 MI Valid N.E. r/m64 XOR imm32 (sign-extended).
	{ NULL, 0x0001, 0x0485B000, { 0x81, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x03C5B000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// REX.W + 83 /6 ib XOR r/m64, imm8 MI Valid N.E. r/m64 XOR imm8 (sign-extended).
	{ NULL, 0x0001, 0x0485B000, { 0x83, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA },
	// 30 /r XOR r/m8, r8 MR Valid Valid r/m8 XOR r8.
	// REX + 30 /r XOR r/m8*, r8* MR Valid N.E. r/m8 XOR r8.
	{ NULL, 0x0001, 0x00C48000, { 0x30, 0x00, 0x00 }, FCML_OP_MODRM_RM_8_W, FCML_OP_MODRM_R_8, FCML_NA, FCML_NA },
	// 31 /r XOR r/m16, r16 MR Valid Valid r/m16 XOR r16.
	// 31 /r XOR r/m32, r32 MR Valid Valid r/m32 XOR r32.
	// REX.W + 31 /r XOR r/m64, r64 MR Valid N.E. r/m64 XOR r64.
	{ NULL, 0x0001, 0x00C48000, { 0x31, 0x00, 0x00 }, FCML_OP_MODRM_RM_W, FCML_OP_MODRM_R, FCML_NA, FCML_NA },
	// 32 /r XOR r8, r/m8 RM Valid Valid r8 XOR r/m8.
	// REX + 32 /r XOR r8*, r/m8* RM Valid N.E. r8 XOR r/m8.
	{ NULL, 0x0001, 0x00C48000, { 0x32, 0x00, 0x00 }, FCML_OP_MODRM_R_8_W, FCML_OP_MODRM_RM_8, FCML_NA, FCML_NA },
	...
	{ NULL, 0x0001, 0x00C48000, { 0x33, 0x00, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XORPD[] = {
	...
	{ NULL, 0x1000, 0x00D88000, { 0x0F, 0x57, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vxorpd", 0x1080, 0x00D88000, { 0x0F, 0x57, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XORPS[] = {
	...
	{ NULL, 0x0000, 0x00D88000, { 0x0F, 0x57, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA },
	...
	{ "vxorps", 0x0080, 0x00D88000, { 0x0F, 0x57, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XRSTOR[] = {
	...
	{ NULL, 0x0010, 0x03D9A800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA },
	// REX.W+ 0F AE /5 XRSTOR64 mem M Valid N.E. Restore processor extended states from memory. The states are specified by EDX:EAX
	{ "xrstor64", 0x0008, 0x0499A800, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XSAVE[] = {
	...
	{ NULL, 0x0010, 0x03D9A000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA },
	// REX.W+ 0F AE /4 XSAVE64 mem M Valid N.E. Save processor extended states to memory. The states are specified by EDX:EAX
	{ "xsave64", 0x0008, 0x0499A000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_512B, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XSAVEOPT[] = {
	...
	{ NULL, 0x0010, 0x03D9B000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_UNDEF_W, FCML_NA, FCML_NA, FCML_NA },
	...
	{ "xsaveopt64", 0x0008, 0x0499B000, { 0x0F, 0xAE, 0x00 }, FCML_OP_MODRM_M_UNDEF_W, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XSETBV[] = {
	...
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xD1 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_FEMMS[] = {
	...
	{ NULL, 0x0000, 0x00D80000, { 0x0F, 0x0E, 0x00 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PAVGUSB[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xBF }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PF2ID[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x1D }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFACC[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xAE }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFADD[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x9E }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFCMPEQ[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xB0 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFCMPGE[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x90 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFCMPGT[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xA0 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFMAX[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xA4 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFMIN[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x94 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFMUL[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xB4 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFRCP[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x96 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFRCPIT1[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xA6 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFRCPIT2[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xB6 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFRSQIT1[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xA7 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFRSQRT[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x97 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFSUB[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x9A }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFSUBR[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xAA }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PI2FD[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x0D }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PMULHRW[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xB7 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PREFETCH[] = {
	...
	{ NULL, 0x0000, 0x80D98000, { 0x0F, 0x0D, 0x00 }, FCML_OP_MODRM_M_8, FCML_NA, FCML_NA, FCML_NA },
	// PREFETCHW mem8 0F 0Dh Prefetch processor cache line into L1 data cache (Dcache)
	{ "prefetchw", 0x0000, 0x80D98800, { 0x0F, 0x0D, 0x00 }, FCML_OP_MODRM_M_8, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PF2IW[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xC1 }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFNACC[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x8A }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PFPNACC[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x8E }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PI2FW[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0x0C }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PSWAPD[] = {
	...
	{ NULL, 0x0000, 0x00EC8000, { 0x0F, 0x0F, 0xBB }, FCML_OP_MODRM_R_MMX_W, FCML_OP_MODRM_RM_MMX, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMADDPD[] = {
	...
	{ "vfmadd132pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x98 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 A8 /r VFMADD213PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 A8 /r VFMADD213PD ymm0,ymm1,ymm2/m256
	{ "vfmadd213pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xA8 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 B8 /r VFMADD231PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 B8 /r VFMADD231PD ymm0,ymm1,ymm2/m256
	{ "vfmadd231pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xB8 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddpd", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x69 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmaddpd", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x69 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMADDPS[] = {
	...
	{ "vfmadd132ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x98 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 A8 /r VFMADD213PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 A8 /r VFMADD213PS ymm0,ymm1,ymm2/m256
	{ "vfmadd213ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xA8 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 B8 /r VFMADD231PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 B8 /r VFMADD231PS ymm0,ymm1,ymm2/m256
	{ "vfmadd231ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xB8 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddps", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x68 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmaddps", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x68 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMADDSD[] = {
	...
	{ "vfmadd132sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0x99 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 A9 /r VFMADD213SD xmm0,xmm1,xmm2/m64
	{ "vfmadd213sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xA9 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 B9 /r VFMADD231SD xmm0,xmm1,xmm2/m64
	{ "vfmadd231sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xB9 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VFMADDSD xmm1, xmm2, xmm3/mem128, xmm4 C4 RXB.00011 0.src.X.01 6B /r /is4
	{ "vfmaddsd", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x6B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 },
	// VFMADDSD xmm1, xmm2, xmm3, xmm4/mem128 C4 RXB.00011 1.src.X.01 6B /r /is4
	{ "vfmaddsd", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x6B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_128 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMADDSS[] = {
	...
	{ "vfmadd132ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x99 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 A9 /r VFMADD213SS xmm0,xmm1,xmm2/m32
	{ "vfmadd213ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xA9 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 B9 /r VFMADD231SS xmm0,xmm1,xmm2/m32
	{ "vfmadd231ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xB9 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VFMADDSS xmm1, xmm2, xmm3/mem32, xmm4 C4 RXB.00011 0.src.X.01 6A /r /is4
	{ "vfmaddss", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x6A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_32, FCML_OP_OPERAND_IS4 },
	// VFMADDSS xmm1, xmm2, xmm3, xmm4/mem32 C4 RXB.00011 1.src.X.01 6A /r /is4
	{ "vfmaddss", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x6A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_32 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMADDSUBPD[] = {
	...
	{ "vfmaddsub132pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x96 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddsub213pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xA6 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddsub231pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xB6 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddsubpd", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x5D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmaddsubpd", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x5D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMADDSUBPS[] = {
	...
	{ "vfmaddsub132ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x96 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddsub213ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xA6 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddsub231ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xB6 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmaddsubps", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x5C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmaddsubps", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x5C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMSUBADDPD[] = {
	...
	{ "vfmsubadd132pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x97 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubadd213pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xA7 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubadd231pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xB7 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubaddpd", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x5F }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmsubaddpd", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x5F }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMSUBADDPS[] = {
	...
	{ "vfmsubadd132ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x97 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubadd213ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xA7 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubadd231ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xB7 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubaddps", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x5E }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmsubaddps", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x5E }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMSUBPD[] = {
	...
	{ "vfmsub132pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x9A }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 AA /r VFMSUB213PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 AA /r VFMSUB213PD ymm0,ymm1,ymm2/m256
	{ "vfmsub213pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xAA }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 BA /r VFMSUB231PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 BA /r VFMSUB231PD ymm0,ymm1,ymm2/m256
	{ "vfmsub231pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xBA }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubpd", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x6D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmsubpd", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x6D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMSUBPS[] = {
	...
	{ "vfmsub132ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x9A }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 AA /r VFMSUB213PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 AA /r VFMSUB213PS ymm0,ymm1,ymm2/m256
	{ "vfmsub213ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xAA }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 BA /r VFMSUB231PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 BA /r VFMSUB231PS ymm0,ymm1,ymm2/m256
	{ "vfmsub231ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xBA }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfmsubps", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x6C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfmsubps", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x6C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMSUBSD[] = {
	...
	{ "vfmsub132sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0x9B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 AB /r VFMSUB213SD xmm0,xmm1,xmm2/m64
	{ "vfmsub213sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xAB }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 BB /r VFMSUB231SD xmm0,xmm1,xmm2/m64
	{ "vfmsub231sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xBB }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VFMSUBSD xmm1, xmm2, xmm3/mem64, xmm4 C4 RXB.00011 0.src.X.01 6F /r /is4
	{ "vfmsubsd", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x6F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_64, FCML_OP_OPERAND_IS4 },
	// VFMSUBSD xmm1, xmm2, xmm3, xmm4/mem64 C4 RXB.00011 1.src.X.01 6F /r /is4
	{ "vfmsubsd", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x6F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_64 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFMSUBSS[] = {
	...
	{ "vfmsub132ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x9B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 AB /r VFMSUB213SS xmm0,xmm1,xmm2/m32
	{ "vfmsub213ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xAB }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 BB /r VFMSUB231SS xmm0,xmm1,xmm2/m32
	{ "vfmsub231ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xBB }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VFMSUBSS xmm1, xmm2, xmm3/mem32, xmm4 C4 RXB.00011 0.src.X.01 6E /r /is4
	{ "vfmsubss", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x6E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_32, FCML_OP_OPERAND_IS4 },
	// VFMSUBSS xmm1, xmm2, xmm3, xmm4/mem32 C4 RXB.00011 1.src.X.01 6E /r /is4
	{ "vfmsubss", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x6E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_32 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMADDPD[] = {
	...
	{ "vfnmadd132pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x9C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 AC /r VFNMADD213PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 AC /r VFNMADD213PD ymm0,ymm1,ymm2/m256
	{ "vfnmadd213pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xAC }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 BC /r VFNMADD231PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 BC /r VFNMADD231PD ymm0,ymm1,ymm2/m256
	{ "vfnmadd231pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xBC }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfnmaddpd", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x79 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfnmaddpd", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x79 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMADDPS[] = {
	...
	{ "vfnmadd132ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x9C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 AC /r VFNMADD213PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 AC /r VFNMADD213PS ymm0,ymm1,ymm2/m256
	{ "vfnmadd213ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xAC }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 BC /r VFNMADD231PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 BC /r VFNMADD231PS ymm0,ymm1,ymm2/m256
	{ "vfnmadd231ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xBC }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfnmaddps", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x78 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfnmaddps", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x78 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMADDSD[] = {
	...
	{ "vfnmadd132sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0x9D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 AD /r VFNMADD213SD xmm0,xmm1,xmm2/m64
	{ "vfnmadd213sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xAD }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 BD /r VFNMADD231SD xmm0,xmm1,xmm2/m64
	{ "vfnmadd231sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xBD }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VFNMADDSD xmm1, xmm2, xmm3/mem64, xmm4 C4 RXB.00011 0.src.X.01 7B /r /is4
	{ "vfnmaddsd", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x7B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_64, FCML_OP_OPERAND_IS4 },
	// VFNMADDSD xmm1, xmm2, xmm3, xmm4/mem64 C4 RXB.00011 1.src.X.01 7B /r /is4
	{ "vfnmaddsd", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x7B }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_64 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMADDSS[] = {
	...
	{ "vfnmadd132ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x9D }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 AD /r VFNMADD213SS xmm0,xmm1,xmm2/m32
	{ "vfnmadd213ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xAD }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 BD /r VFNMADD231SS xmm0,xmm1,xmm2/m32
	{ "vfnmadd231ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xBD }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VFNMADDSS xmm1, xmm2, xmm3/mem32, xmm4 C4 RXB.00011 0.src.X.01 7A /r /is4
	{ "vfnmaddss", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x7A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_32, FCML_OP_OPERAND_IS4 },
	// VFNMADDSS xmm1, xmm2, xmm3, xmm4/mem32 C4 RXB.00011 1.src.X.01 7A /r /is4
	{ "vfnmaddss", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x7A }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_32 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMSUBPD[] = {
	...
	{ "vfnmsub132pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0x9E }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 AE /r VFNMSUB213PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 AE /r VFNMSUB213PD ymm0,ymm1,ymm2/m256
	{ "vfnmsub213pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xAE }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W1 BE /r VFNMSUB231PD xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W1 BE /r VFNMSUB231PD ymm0,ymm1,ymm2/m256
	{ "vfnmsub231pd", 0x1088, 0x00EC8000, { 0x0F, 0x38, 0xBE }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfnmsubpd", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x7D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfnmsubpd", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x7D }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMSUBPS[] = {
	...
	{ "vfnmsub132ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0x9E }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 AE /r VFNMSUB213PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 AE /r VFNMSUB213PS ymm0,ymm1,ymm2/m256
	{ "vfnmsub213ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xAE }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	// VEX.DDS.128.66.0F38.W0 BE /r VFNMSUB231PS xmm0,xmm1,xmm2/m128
	// VEX.DDS.256.66.0F38.W0 BE /r VFNMSUB231PS ymm0,ymm1,ymm2/m256
	{ "vfnmsub231ps", 0x1090, 0x00EC8000, { 0x0F, 0x38, 0xBE }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_NA },
	...
	{ "vfnmsubps", 0x1090, 0x00EC8000, { 0x0F, 0x3A, 0x7C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ "vfnmsubps", 0x1088, 0x00EC8000, { 0x0F, 0x3A, 0x7C }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMSUBSD[] = {
	...
	{ "vfnmsub132sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0x9F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 AF /r VFNMSUB213SD xmm0,xmm1,xmm2/m64
	{ "vfnmsub213sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xAF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W1 BF /r VFNMSUB231SD xmm0,xmm1,xmm2/m64
	{ "vfnmsub231sd", 0x10C8, 0x00EC8000, { 0x0F, 0x38, 0xBF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_64, FCML_NA },
	// VFNMSUBSD xmm1, xmm2, xmm3/mem64, xmm4 C4 RXB.00011 0.src.X.01 7F /r /is4
	{ "vfnmsubsd", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x7F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_64, FCML_OP_OPERAND_IS4 },
	// VFNMSUBSD xmm1, xmm2, xmm3, xmm4/mem64 C4 RXB.00011 1.src.X.01 7F /r /is4
	{ "vfnmsubsd", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x7F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_64 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFNMSUBSS[] = {
	...
	{ "vfnmsub132ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0x9F }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 AF /r VFNMSUB213SS xmm0,xmm1,xmm2/m32
	{ "vfnmsub213ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xAF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VEX.DDS.LIG.128.66.0F38.W0 BF /r VFNMSUB231SS xmm0,xmm1,xmm2/m32
	{ "vfnmsub231ss", 0x10D0, 0x00EC8000, { 0x0F, 0x38, 0xBF }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_XMM_32, FCML_NA },
	// VFNMSUBSS xmm1, xmm2, xmm3/mem32, xmm4 C4 RXB.00011 0.src.X.01 7E /r /is4
	{ "vfnmsubss", 0x10D0, 0x00EC8000, { 0x0F, 0x3A, 0x7E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_32, FCML_OP_OPERAND_IS4 },
	// VFNMSUBSS xmm1, xmm2, xmm3, xmm4/mem32 C4 RXB.00011 1.src.X.01 7E /r /is4
	{ "vfnmsubss", 0x10C8, 0x00EC8000, { 0x0F, 0x3A, 0x7E }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_32 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ANDN[] = {
	...
	{ NULL, 0x02D0, 0x00EC8000, { 0x0F, 0x38, 0xF2 }, FCML_OP_MODRM_R_32_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_OP_MODRM_RM_32, FCML_NA },
	// VEX.NDS.LZ.0F38.W1 F2 /r ANDN r64a, r64b, r/m64
	{ NULL, 0x02C8, 0x00EC8000, { 0x0F, 0x38, 0xF2 }, FCML_OP_MODRM_R_64_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_OP_MODRM_RM_64, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BEXR[] = {
	...
	{ NULL, 0x02D0, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_NA },
	// VEX.NDS1.LZ.0F38.W1 F7 /r BEXR r64a, r/m64, r64b
	{ NULL, 0x02C8, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BEXTR[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x0A, 0x10, 0x00 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_ID, FCML_NA },
	// BEXTR reg64, reg/mem64, imm32 8F RXB.0A 1.1111.0.00 10 /r /id
	{ NULL, 0x0548, 0x00D88000, { 0x0A, 0x10, 0x00 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_ID, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLCFILL[] = {
	// BLCFILL reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /1
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLCFILL reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /1
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLCI[] = {
	// BLCI reg32, reg/mem32 8F RXB.09 0.dest.0.00 02 /6
	{ NULL, 0x0450, 0x00D9B000, { 0x09, 0x02, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLCI reg64, reg/mem64 8F RXB.09 1.dest.0.00 02 /6
	{ NULL, 0x0448, 0x00D9B000, { 0x09, 0x02, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLCIC[] = {
	// BLCIC reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /5
	{ NULL, 0x0450, 0x00D9A800, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLCIC reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /5
	{ NULL, 0x0448, 0x00D9A800, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLCMSK[] = {
	// BLCMSK reg32, reg/mem32 8F RXB.09 0.dest.0.00 02 /1
	{ NULL, 0x0450, 0x00D98800, { 0x09, 0x02, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLCMSK reg64, reg/mem64 8F RXB.09 1.dest.0.00 02 /1
	{ NULL, 0x0448, 0x00D98800, { 0x09, 0x02, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLCS[] = {
	// BLCS reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /3
	{ NULL, 0x0450, 0x00D99800, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLCS reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /3
	{ NULL, 0x0448, 0x00D99800, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLSFILL[] = {
	// BLSFILL reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /2
	{ NULL, 0x0450, 0x00D99000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLSFILL reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /2
	{ NULL, 0x0448, 0x00D99000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLSI[] = {
	// VEX.NDD.LZ.0F38.W0 F3 /3 BLSI r32, r/m32
	{ NULL, 0x02D0, 0x00ED9800, { 0x0F, 0x38, 0xF3 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// VEX.NDD.LZ.0F38.W1 F3 /3 BLSI r64, r/m64
	{ NULL, 0x02C8, 0x00ED9800, { 0x0F, 0x38, 0xF3 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLSIC[] = {
	// BLSIC reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /6
	{ NULL, 0x0450, 0x00D9B000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// BLSIC reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /6
	{ NULL, 0x0448, 0x00D9B000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLSMSK[] = {
	// VEX.NDD.LZ.0F38.W0 F3 /2 BLSMSK r32, r/m32
	{ NULL, 0x02D0, 0x00ED9000, { 0x0F, 0x38, 0xF3 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// VEX.NDD.LZ.0F38.W1 F3 /2 BLSMSK r64, r/m64
	{ NULL, 0x02C8, 0x00ED9000, { 0x0F, 0x38, 0xF3 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BLSR[] = {
	// VEX.NDD.LZ.0F38.W0 F3 /1 BLSR r32, r/m32
	{ NULL, 0x02D0, 0x00ED8800, { 0x0F, 0x38, 0xF3 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// VEX.NDD.LZ.0F38.W1 F3 /1 BLSR r64, r/m64
	{ NULL, 0x02C8, 0x00ED8800, { 0x0F, 0x38, 0xF3 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_BZHI[] = {
	// VEX.NDS1.LZ.0F38.W0 F5 /r BZHI r32a, r/m32, r32b
	{ NULL, 0x02D0, 0x00EC8000, { 0x0F, 0x38, 0xF5 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_NA },
	// VEX.NDS1.LZ.0F38.W1 F5 /r BZHI r64a, r/m64, r64b
	{ NULL, 0x02C8, 0x00EC8000, { 0x0F, 0x38, 0xF5 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_LZCNT[] = {
	...
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0xBD, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_MULX[] = {
	// VEX.NDD.LZ.F2.0F38.W0 F6 /r MULX r32a, r32b, r/m32
	{ NULL, 0x22D0, 0x00EC8000, { 0x0F, 0x38, 0xF6 }, FCML_OP_MODRM_R_32_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_OP_MODRM_RM_32, FCML_NA },
	// VEX.NDD.LZ.F2.0F38.W1 F6 /r MULX r64a, r64b, r/m64
	{ NULL, 0x22C8, 0x00EC8000, { 0x0F, 0x38, 0xF6 }, FCML_OP_MODRM_R_64_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_OP_MODRM_RM_64, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PDEP[] = {
	// VEX.NDS.LZ.F2.0F38.W0 F5 /r PDEP r32a, r32b, r/m32
	{ NULL, 0x22D0, 0x00EC8000, { 0x0F, 0x38, 0xF5 }, FCML_OP_MODRM_R_32_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_OP_MODRM_RM_32, FCML_NA },
	// VEX.NDS.LZ.F2.0F38.W1 F5 /r PDEP r64a, r64b, r/m64
	{ NULL, 0x22C8, 0x00EC8000, { 0x0F, 0x38, 0xF5 }, FCML_OP_MODRM_R_64_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_OP_MODRM_RM_64, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_PEXT[] = {
	// VEX.NDS.LZ.F3.0F38.W0 F5 /r PEXT r32a, r32b, r/m32
	{ NULL, 0x42D0, 0x00EC8000, { 0x0F, 0x38, 0xF5 }, FCML_OP_MODRM_R_32_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_OP_MODRM_RM_32, FCML_NA },
	// VEX.NDS.LZ.F3.0F38.W1 F5 /r PEXT r64a, r64b, r/m64
	{ NULL, 0x42C8, 0x00EC8000, { 0x0F, 0x38, 0xF5 }, FCML_OP_MODRM_R_64_W, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_OP_MODRM_RM_64, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RORX[] = {
	// VEX.LZ.F2.0F3A.W0 F0 /r ib RORX r32, r/m32, imm8
	{ NULL, 0x22D0, 0x00EC8000, { 0x0F, 0x38, 0xF0 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_IB, FCML_NA },
	// VEX.LZ.F2.0F3A.W1 F0 /r ib RORX r64, r/m64, imm8
	{ NULL, 0x22C8, 0x00EC8000, { 0x0F, 0x38, 0xF0 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_IB, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHLX[] = {
	// VEX.NDS1.LZ.66.0F38.W0 F7 /r SHLX r32a, r/m32, r32b
	{ NULL, 0x12D0, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_NA },
	// VEX.NDS1.LZ.66.0F38.W1 F7 /r SHLX r64a, r/m64, r64b
	{ NULL, 0x12C8, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SHRX[] = {
	// VEX.NDS1.LZ.F2.0F38.W0 F7 /r SHRX r32a, r/m32, r32b
	{ NULL, 0x22D0, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_NA },
	// VEX.NDS1.LZ.F2.0F38.W1 F7 /r SHRX r64a, r/m64, r64b
	{ NULL, 0x22C8, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_SARX[] = {
	// VEX.NDS1.LZ.F3.0F38.W0 F7 /r SARX r32a, r/m32, r32b
	{ NULL, 0x42D0, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ), FCML_NA },
	// VEX.NDS1.LZ.F3.0F38.W1 F7 /r SARX r64a, r/m64, r64b
	{ NULL, 0x42C8, 0x00EC8000, { 0x0F, 0x38, 0xF7 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ), FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_TZCNT[] = {
	...
	{ NULL, 0x4000, 0x00D88000, { 0x0F, 0xBC, 0x00 }, FCML_OP_MODRM_R_W, FCML_OP_MODRM_RM, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_TZMSK[] = {
	// TZMSK reg32, reg/mem32 8F RXB.09 0.dest.0.00 01 /4
	{ NULL, 0x0450, 0x00D9A000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_DWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// TZMSK reg64, reg/mem64 8F RXB.09 1.dest.0.00 01 /4
	{ NULL, 0x0448, 0x00D9A000, { 0x09, 0x01, 0x00 }, FCML_OP_VEX_VVVV_REG( IRA_REG_GPR, FCML_EOS_QWORD ) | FCML_OA_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XABORT[] = {
	...
	{ NULL, 0x0000, 0x00D80000, { 0xC6, 0xF8, 0x00 }, FCML_OP_IB, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XBEGIN[] = {
	// C7 F8 XBEGIN rel16
	// C7 F8 XBEGIN rel32
	{ NULL, 0x0000, 0x00D80000, { 0xC7, 0xF8, 0x00 }, FCML_OP_IMMEDIATE_DIS_RELATIVE_EOSA, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XEND[] = {
	// 0F 01 D5 XEND
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xD5 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_XTEST[] = {
	// 0F 01 D6 XTEST
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xD6 }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADCX[] = {
	...
	{ NULL, 0x1010, 0x00EC8000, { 0x0F, 0x38, 0xF6 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// REX.W + 66 0F 38 F6 /r ADCX r64, r/m64
	{ NULL, 0x1008, 0x00EC8000, { 0x0F, 0x38, 0xF6 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_ADOX[] = {
	// F3 0F 38 F6 /r ADOX r32, r/m32
	{ NULL, 0x4010, 0x00EC8000, { 0x0F, 0x38, 0xF6 }, FCML_OP_MODRM_R_32_W, FCML_OP_MODRM_RM_32, FCML_NA, FCML_NA },
	// REX.w + F3 0F 38 F6 /r ADOX r64, r/m64
	{ NULL, 0x4008, 0x00EC8000, { 0x0F, 0x38, 0xF6 }, FCML_OP_MODRM_R_64_W, FCML_OP_MODRM_RM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_RDSEED[] = {
	...
	{ NULL, 0x0000, 0x00DBB800, { 0x0F, 0xC7, 0x00 }, FCML_OP_RM( IRA_REG_GPR, FCML_EOS_EOSA, FCML_EOS_UNDEFINED, FCML_RMF_R ) | FCML_OA_W, FCML_NA, FCML_NA, FCML_NA },
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_CLAC[] = {
	// 0F 01 CA CLAC
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xCA }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};

struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_STAC[] = {
	// 0F 01 CB STAC
	{ NULL, 0x0000, 0x00EC0000, { 0x0F, 0x01, 0xCB }, FCML_NA, FCML_NA, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFRCZPD[] = {
	...
	{ NULL, 0x0510, 0x00D88000, { 0x09, 0x81, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFRCZPS[] = {
	...
	{ NULL, 0x0510, 0x00D88000, { 0x09, 0x80, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_MODRM_RM_SIMD_L, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFRCZSD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0x83, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_64, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VFRCZSS[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0x82, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_32, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPCMOV[] = {
	...
	{ NULL, 0x0410, 0x00D88000, { 0x08, 0xA2, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_MODRM_RM_SIMD_L, FCML_OP_OPERAND_IS4 },
	...
	{ NULL, 0x0408, 0x00D88000, { 0x08, 0xA2, 0x00 }, FCML_OP_MODRM_R_SIMD_L_W, FCML_OP_VEX_VVVV_SIMD_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_SIMD_L }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPCOM[] = {
	...
	{ "vpcomb", 0x0450, 0x00D88000, { 0x08, 0xCC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VPCOMW xmm1, xmm2, xmm3/mem128, imm8 8F RXB.01000 0.src.0.00 CD /r ib
	{ "vpcomw", 0x0450, 0x00D88000, { 0x08, 0xCD, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VPCOMD xmm1, xmm2, xmm3/mem128, imm8 8F RXB.01000 0.src.0.00 CE /r ib
	{ "vpcomd", 0x0450, 0x00D88000, { 0x08, 0xCE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VPCOMQ xmm1, xmm2, xmm3/mem128, imm8 8F RXB.01000 0.src.0.00 CF /r ib
	{ "vpcomq", 0x0450, 0x00D88000, { 0x08, 0xCF, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB }
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPCOMU[] = {
	...
	{ "vpcomub", 0x0450, 0x00D88000, { 0x08, 0xEC, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VPCOMUW xmm1, xmm2, xmm3/mem128, imm8 8F RXB.01000 0.src.0.00 ED /r ib
	{ "vpcomuw", 0x0450, 0x00D88000, { 0x08, 0xED, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VPCOMUD xmm1, xmm2, xmm3/mem128, imm8 8F RXB.01000 0.src.0.00 EE /r ib
	{ "vpcomud", 0x0450, 0x00D88000, { 0x08, 0xEE, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB },
	// VPCOMUQ xmm1, xmm2, xmm3/mem128, imm8 8F RXB.01000 0.src.0.00 EF /r ib
	{ "vpcomuq", 0x0450, 0x00D88000, { 0x08, 0xEF, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB }
	// TODO: Obsluzyc mnemoniki warunkowe na podstawie imm8.
	// imm8[2:0] Comparison Mnemonic
	// 000 Less Than VPCOMLTB
	// 001 Less Than or Equal VPCOMLEB
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDBD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xC2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDBW[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xC1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDBQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xC3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDDQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xCB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDUBD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xD2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDUBQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xD3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDUBWD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xD1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDUDQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xDB, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDUWD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xD6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDUWQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xD7, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDWD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xC6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHADDWQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xC7, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHSUBBW[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xE1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHSUBDQ[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xE3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPHSUBWD[] = {
	...
	{ NULL, 0x0550, 0x00D88000, { 0x09, 0xE2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_NA, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSDD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x9E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSDQH[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x9F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSDQL[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x97, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSSDD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x8E, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSSDQH[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x8F, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSSDQL[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x87, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSSWD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x86, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSSWW[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x85, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSWD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x96, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMACSWW[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0x95, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMADCSSWD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0xA6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPMADCSWD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0xB6, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPPERM[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x08, 0xA3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_OP_OPERAND_IS4 },
	// VPPERM xmm1, xmm2, xmm3, xmm4/mem128 8F RXB.01000 1.src.0.00 A3 /r ib
	{ NULL, 0x0448, 0x00D88000, { 0x08, 0xA3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_OPERAND_IS4, FCML_OP_MODRM_RM_XMM_128 }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPROTD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x92, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPROTD xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 92 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x92, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VPROTD xmm1, xmm2/mem128, imm8 8F RXB.01000 0.1111.0.00 C2 /r ib
	{ NULL, 0x0550, 0x00D88000, { 0x08, 0xC2, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPROTB[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x90, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPROTB xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 90 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x90, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VPROTB xmm1, xmm2/mem128, imm8 8F RXB.01000 0.1111.0.00 C0 /r ib
	{ NULL, 0x0550, 0x00D88000, { 0x08, 0xC0, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPROTQ[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x93, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPROTQ xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 93 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x93, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VPROTQ xmm1, xmm2/mem128, imm8 8F RXB.01000 0.1111.0.00 C3 /r ib
	{ NULL, 0x0550, 0x00D88000, { 0x08, 0xC3, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPROTW[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x91, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPROTW xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 91 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x91, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
	// VPROTW xmm1, xmm2/mem128, imm8 8F RXB.01000 0.1111.0.00 C1 /r ib
	{ NULL, 0x0550, 0x00D88000, { 0x08, 0xC1, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_IB, FCML_NA }
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHAB[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x98, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHAB xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 98 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x98, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHAD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x9A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHAD xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 9A /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x9A, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHAQ[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x9B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHAQ xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 9B /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x9B, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHAW[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x99, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHAW xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 99 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x99, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHLB[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x94, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHLB xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 94 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x94, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHLD[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x96, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHLD xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 96 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x96, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHLQ[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x97, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHLQ xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 97 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x97, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
...
struct fcml_st_def_addr_mode_desc _fcml_st_def_addr_mode_desc_VPSHLW[] = {
	...
	{ NULL, 0x0450, 0x00D88000, { 0x09, 0x95, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_MODRM_RM_XMM_128, FCML_OP_VEX_VVVV_XMM_REG, FCML_NA },
	// VPSHLW xmm1, xmm2, xmm3/mem128 8F RXB.01001 1.src.0.00 95 /r
	{ NULL, 0x0448, 0x00D88000, { 0x09, 0x95, 0x00 }, FCML_OP_MODRM_R_XMM_W, FCML_OP_VEX_VVVV_XMM_REG, FCML_OP_MODRM_RM_XMM_128, FCML_NA },
};
