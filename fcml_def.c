...
struct fcml_st_def_addr_mode_desc fcml_st_def_addr_mode_desc_POP[] = {
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00C58080, { 0x8F, 0x00, 0x00 }, {FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_RMO },
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00C40081, { 0x58, 0x00, 0x00 }, {FCML_OP_OPCODE_REG( FCML_REG_GPR, FCML_EOS_EOSA), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_RO },
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00D80080, { 0x0F, 0xA1, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_FS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SR_FSGSO },
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00D80080, { 0x0F, 0xA9, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_GS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SR_FSGSO }
};
...
struct fcml_st_def_addr_mode_desc fcml_st_def_addr_mode_desc_PUSH[] = {
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00C5B080, { 0xFF, 0x00, 0x00 }, {FCML_OP_MODRM_RM_W, FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_RMO },
...
/*	{ NULL, FCML_AMT_GPI, 0x0000, 0x00440001, { 0x50, 0x00, 0x00 }, {FCML_OP_OPCODE_REG( FCML_REG_GPR, FCML_EOS_EOSA), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_AM_UNKNOWN },
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00C40081, { 0x50, 0x00, 0x00 }, {FCML_OP_OPCODE_REG( FCML_REG_GPR, FCML_EOS_EOSA), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_RO },
	// 6A PUSH imm8 I Valid Valid Push imm8.
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00C40004, { 0x6A, 0x00, 0x00 }, {FCML_OP_IB_EX_EOSA, FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_AM_IMM8 },
	// 68 PUSH imm16 I Valid Valid Push imm16.
	{ NULL, FCML_AMT_GPI, 0x0000, 0x01C40004, { 0x68, 0x00, 0x00 }, {FCML_OP_IW_EX_EOSA, FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_AM_IMMO },
	// 68 PUSH imm32 I Valid Valid Push imm32.
	{ NULL, FCML_AMT_GPI, 0x0000, 0x06C40004, { 0x68, 0x00, 0x00 }, {FCML_OP_ID_EX_EOSA, FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_AM_IMMO },
	...
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00440000, { 0x1E, 0x00, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_DS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SRO },
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00440000, { 0x06, 0x00, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_ES, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SRO },
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00440000, { 0x16, 0x00, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_SS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SRO },
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00440000, { 0x0E, 0x00, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_CS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SRO },
	// 0F A0 PUSH FS NP Valid Valid Push FS.
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00D80080, { 0x0F, 0xA0, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_FS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SR_FSGSO },
	// 0F A8 PUSH GS NP Valid Valid Push GS.
	{ NULL, FCML_AMT_GPI, 0x0000, 0x00D80080, { 0x0F, 0xA8, 0x00 }, {FCML_OP_EXPLICIT_REG( FCML_REG_SEG, FCML_REG_GS, FCML_EOS_UNDEFINED ), FCML_NA, FCML_NA, FCML_NA, FCML_NA}, FCML_SR_FSGSO },
};
