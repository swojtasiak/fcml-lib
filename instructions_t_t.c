...
void fcml_tf_instruction_TZMSK(void) {
    ...
    FCML_I32( "tzmsk rbx,qword ptr [eax]", 0x8F, 0xE9, 0xE0, 0x01, 0x20 );
    FCML_I32( "tzmsk rbx,rax", 0x8F, 0xE9, 0xE0, 0x01, 0xE0 );
}
...
void fcml_tf_instruction_T1MSKC(void) {
    ...
    FCML_I32( "t1mskc rbx,qword ptr [eax]", 0x8F, 0xE9, 0xE0, 0x01, 0x38 );
    FCML_I32( "t1mskc rbx,rax", 0x8F, 0xE9, 0xE0, 0x01, 0xF8 );
}
