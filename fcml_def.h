...
#define FCML_EOS_14_28		0xFD
#define FCML_EOS_94_108		0xFC
#define FCML_EOS_512B		0xFB
#define FCML_EOS_UNDEF		0xFA
...
#define _IRA_OPERAND_MODRM_R			_IRA_OPERAND_R(IRA_REG_GPR, FCML_OS_EOSA )
...
#define _IRA_OPERAND_MODRM_RM_SIMD		_IRA_OPERAND_RM(IRA_REG_SIMD, FCML_EOS_EOSA, FCML_EOS_EOSA, _IRA_RMF_RM )
...
#define _IRA_OPERAND_MODRM_R_SIMD		_IRA_OPERAND_R(IRA_REG_SIMD, FCML_OS_EOSA )
#define _IRA_OPERAND_MODRM_R_SIMD_W		( _IRA_OPERAND_MODRM_R_SIMD | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_M_SIMD		_IRA_OPERAND_RM(IRA_NO_REG, FCML_EOS_UNDEFINED, FCML_EOS_EOSA, _IRA_RMF_M )
