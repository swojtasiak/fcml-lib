...
#define FCML_OP_MODRM_OPRM				FCML_OP_RM(FCML_REG_GPR, FCML_EOS_EOSA, FCML_EOS_EOSA | FCML_EOS_OPT, FCML_RMF_RM )
#define FCML_OP_MODRM_OPRM_W			( FCML_OP_MODRM_OPRM | FCML_OA_W )
...
#define FCML_OP_MODRM_OPM               FCML_OP_RM(FCML_REG_UNDEFINED, FCML_EOS_UNDEFINED, FCML_EOS_EOSA | FCML_EOS_OPT, FCML_RMF_M )
...
#define FCML_OP_MODRM_M_OP32			FCML_OP_RM(FCML_REG_UNDEFINED, FCML_EOS_UNDEFINED, FCML_EOS_DWORD | FCML_EOS_OPT, FCML_RMF_M )
#define FCML_OP_MODRM_M_OP32_W			(FCML_OP_MODRM_M_OP32 | FCML_OA_W)
...
#define FCML_OP_MODRM_M_OPXMM           FCML_OP_RM(FCML_REG_SIMD, FCML_EOS_UNDEFINED, FCML_EOS_OWORD | FCML_EOS_OPT, FCML_RMF_M )
#define FCML_OP_MODRM_M_OPXMM_W         (FCML_OP_MODRM_M_OPXMM | FCML_OA_W)
...
#define FCML_OP_MODRM_M_OPFP			FCML_OP_RM(FCML_REG_UNDEFINED, FCML_EOS_UNDEFINED, FCML_EOS_FP | FCML_EOS_OPT, FCML_RMF_M )
#define FCML_OP_MODRM_M_OPFP_W		    (FCML_OP_MODRM_M_OPFP | FCML_OA_W)
...
#define FCML_OP_MODRM_RM_MMX_OP32       FCML_OP_RM(FCML_REG_SIMD, FCML_EOS_QWORD, FCML_EOS_DWORD | FCML_EOS_OPT, FCML_RMF_RM )
#define FCML_OP_MODRM_RM_MMX_OP32_W     ( FCML_OP_MODRM_RM_MMX_OP32 | FCML_OA_W )
...
#define FCML_OP_MODRM_RM_SIMD_OPL       FCML_OP_RM(FCML_REG_SIMD, FCML_EOS_L, FCML_EOS_L | FCML_EOS_OPT, FCML_RMF_RM )
#define FCML_OP_MODRM_RM_SIMD_OPL_W		( FCML_OP_MODRM_RM_SIMD_OPL | FCML_OA_W )
