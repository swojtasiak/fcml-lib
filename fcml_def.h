...
#define FCML_ADDRESING_MODES_SIZEOF(x)	( sizeof( x ) / sizeof( struct fcml_st_def_addr_mode_desc ) )

#define FCML_IA_INSTRUCTION(x,y) { x, _IRA_IT_IA, FCML_ADDRESING_MODES_SIZEOF(y), y }
...
#define _IRA_OPERAND_MODRM_RM_8			_IRA_OPERAND_RM(IRA_REG_GPR, _IRA_EOS_BYTE, _IRA_EOS_BYTE, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_8_W		( _IRA_OPERAND_MODRM_RM_8 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM_16		_IRA_OPERAND_RM(IRA_REG_GPR, _IRA_EOS_WORD, _IRA_EOS_WORD, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_16_W		( _IRA_OPERAND_MODRM_RM_16 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM_32		_IRA_OPERAND_RM(IRA_REG_GPR, _IRA_EOS_DWORD, _IRA_EOS_DWORD, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_32_W		( _IRA_OPERAND_MODRM_RM_32 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM_64		_IRA_OPERAND_RM(IRA_REG_GPR, _IRA_EOS_QWORD, _IRA_EOS_QWORD, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_64_W		( _IRA_OPERAND_MODRM_RM_64 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM			_IRA_OPERAND_RM(IRA_REG_GPR, _IRA_EOS_EOSA, _IRA_EOS_EOSA, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_W			( _IRA_OPERAND_MODRM_RM | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_R_8			_IRA_OPERAND_R(IRA_REG_GPR, _IRA_OS_BYTE )
#define _IRA_OPERAND_MODRM_R_8_W		( _IRA_OPERAND_MODRM_R_8 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_R_16			_IRA_OPERAND_R(IRA_REG_GPR, _IRA_OS_WORD )
#define _IRA_OPERAND_MODRM_R_16_W		( _IRA_OPERAND_MODRM_R_16 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_R_32			_IRA_OPERAND_R(IRA_REG_GPR, _IRA_OS_DWORD )
#define _IRA_OPERAND_MODRM_R_32_W		( _IRA_OPERAND_MODRM_R_32 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_R_64			_IRA_OPERAND_R(IRA_REG_GPR, _IRA_OS_QWORD )
#define _IRA_OPERAND_MODRM_R_64_W		( _IRA_OPERAND_MODRM_R_64 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_R			_IRA_OPERAND_R(IRA_REG_GPR, _IRA_OS_EOSA )
#define _IRA_OPERAND_MODRM_R_W			( _IRA_OPERAND_MODRM_R | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_M_8			_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, _IRA_EOS_BYTE, _IRA_RMF_M )
#define _IRA_OPERAND_MODRM_M_8_W		(_IRA_OPERAND_MODRM_M_8 | _IRA_WRITE)
#define _IRA_OPERAND_MODRM_M_16			_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, _IRA_EOS_WORD, _IRA_RMF_M )
#define _IRA_OPERAND_MODRM_M_16_W		(_IRA_OPERAND_MODRM_M_16 | _IRA_WRITE)
#define _IRA_OPERAND_MODRM_M_32			_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, _IRA_EOS_DWORD, _IRA_RMF_M )
#define _IRA_OPERAND_MODRM_M_32_W		(_IRA_OPERAND_MODRM_M_32 | _IRA_WRITE)
#define _IRA_OPERAND_MODRM_M_64			_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, _IRA_EOS_QWORD, _IRA_RMF_M )
#define _IRA_OPERAND_MODRM_M_64_W		(_IRA_OPERAND_MODRM_M_64 | _IRA_WRITE)
#define _IRA_OPERAND_MODRM_M_80			_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, _IRA_EOS_TBYTE, _IRA_RMF_M )
#define _IRA_OPERAND_MODRM_M_80_W		(_IRA_OPERAND_MODRM_M_80 | _IRA_WRITE)
#define _IRA_OPERAND_MODRM_M_128		_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, _IRA_EOS_OWORD, _IRA_RMF_M )
#define _IRA_OPERAND_MODRM_M_128_W		(_IRA_OPERAND_MODRM_M_128 | _IRA_WRITE)
#define _IRA_OPERAND_MODRM_M_256		_IRA_OPERAND_RM(IRA_NO_REG, _IRA_EOS_UNDEFINED, FCML_EOS_YWORD, _IRA_RMF_M )
...
#define _IRA_OPERAND_MODRM_RM_MMX_32	_IRA_OPERAND_RM(IRA_REG_SIMD, FCML_EOS_QWORD, _IRA_EOS_DWORD, _IRA_RMF_RM )
...
#define _IRA_OPERAND_MODRM_RM_XMM_64	_IRA_OPERAND_RM(IRA_REG_SIMD, FCML_EOS_OWORD, _IRA_EOS_QWORD, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_XMM_64_W	( _IRA_OPERAND_MODRM_RM_XMM_64 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM_XMM_32	_IRA_OPERAND_RM(IRA_REG_SIMD, FCML_EOS_OWORD, _IRA_EOS_DWORD, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_XMM_32_W	( _IRA_OPERAND_MODRM_RM_XMM_32 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM_XMM_16	_IRA_OPERAND_RM(IRA_REG_SIMD, FCML_EOS_OWORD, _IRA_EOS_WORD, _IRA_RMF_RM )
...
#define _IRA_OPERAND_MODRM_R_YMM		_IRA_OPERAND_R(IRA_REG_SIMD, _IRA_OS_YMMWORD )
...
#define _IRA_OPERAND_MODRM_RM_SIMD_16	_IRA_OPERAND_RM(IRA_REG_SIMD, _IRA_EOS_EOSA, _IRA_EOS_WORD, _IRA_RMF_RM )
#define _IRA_OPERAND_MODRM_RM_SIMD_16_W	( _IRA_OPERAND_MODRM_RM_SIMD_16 | _IRA_WRITE )
#define _IRA_OPERAND_MODRM_RM_SIMD_8	_IRA_OPERAND_RM(IRA_REG_SIMD, _IRA_EOS_EOSA, _IRA_EOS_BYTE, _IRA_RMF_RM )
