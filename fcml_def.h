...
#define FCML_OP_MODRM_RM_XMM_OP8        FCML_OP_RM(FCML_REG_SIMD, FCML_EOS_OWORD, FCML_EOS_BYTE | FCML_EOS_OPT, FCML_RMF_RM )
#define FCML_OP_MODRM_RM_XMM_OP8_W		( FCML_OP_MODRM_RM_XMM_OP8 | FCML_OA_W )
