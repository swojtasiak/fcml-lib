...
void fcml_tf_instruction_RORX(void) {
    ...
    FCML_I32_D( "rorx rax,qword ptr [eax],01h", 0xC4, 0xE2, 0xC3, 0xF0, 0x00, 0x01 );
    FCML_I32( "rorx rax,qword ptr [eax],01h", 0xc4, 0xe2, 0xfb, 0xf0, 0x00, 0x01 );
    FCML_I32_D( "rorx rax,rax,01h", 0xC4, 0xE2, 0xC3, 0xF0, 0xC0, 0x01 );
    FCML_I32( "rorx rax,rax,01h", 0xc4, 0xe2, 0xfb, 0xf0, 0xc0, 0x01 );
}
