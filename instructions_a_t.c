...
void fcml_tf_instruction_ADC(void) {
	...
	FCML_A3264_M( "adc $0x8042,%ax", 2, FCML_MI( 0x66, 0x15, 0x42, 0x80 ), FCML_MI( 0x66, 0x81, 0xd0, 0x42, 0x80 ) );
	...
	FCML_A64_M( "adc $0x42806521,%eax", 2, FCML_MI( 0x81, 0xd0, 0x21, 0x65, 0x80, 0x42 ), FCML_MI( 0x15, 0x21, 0x65, 0x80, 0x42 ) );
