...
void fcml_ifn_rend_print_prefixes_gas( fcml_st_memory_stream *output_stream, fcml_st_dasm_prefixes *prefixes, fcml_uint32_t flags ) {
...
fcml_ceh_error fcml_fn_rend_render_instruction_gas( fcml_st_dialect *dialect_context, fcml_st_memory_stream *output_stream, fcml_st_dasm_disassembler_result *result, fcml_uint32_t render_flags ) {
	...
	fcml_ifn_rend_print_prefixes_gas( output_stream, &(result->instruction_details.prefixes), render_flags );
