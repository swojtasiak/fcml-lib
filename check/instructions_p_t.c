...
void fcml_tf_instructions_p_suite_init(void) {
}

void fcml_tf_instructions_p_suite_cleanup(void) {
}
...
void fcml_tf_instruction_PUSH(void) {
    ...
    // It can not assemble to: 0x66, 0x68, 0xff, 0xff, because in case of 16 bit ASA 0ffffffffh can not be treated as -1.
