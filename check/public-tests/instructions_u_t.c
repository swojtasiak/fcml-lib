...
void fcml_tf_instruction_UNPCKLPS(void) {
    ...
    FCML_I32_M("vunpcklps xmm0,xmm6,xmmword ptr [eax]", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0x00), FCML_MI(0xc5, 0xc8, 0x14, 0x00));
    FCML_I32_M("vunpcklps xmm0,xmm6,xmm0", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0xc0), FCML_MI(0xc5, 0xc8, 0x14, 0xc0));
    FCML_I64_M("vunpcklps xmm0,xmm6,xmmword ptr [rax]", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0x00), FCML_MI(0xc5, 0xc8, 0x14, 0x00));
    FCML_A64_M("vunpcklps %xmm0,%xmm6,%xmm0", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0xc0), FCML_MI(0xc5, 0xc8, 0x14, 0xc0));
    FCML_A64_M("vunpcklps (%rax),%xmm6,%xmm0", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0x00), FCML_MI(0xc5, 0xc8, 0x14, 0x00));

    /* xmm1, xmm2, m128 */
    FCML_A64_M("vunpcklps (%rax),%xmm7,%xmm15", 2, FCML_MI(0x62, 0x71, 0x44, 0x08, 0x14, 0x38), FCML_MI(0xc5, 0x40, 0x14, 0x38));
    FCML_I64_M("vunpcklps xmm15,xmm7,xmmword ptr [rax]", 2, FCML_MI(0x62, 0x71, 0x44, 0x08, 0x14, 0x38), FCML_MI(0xc5, 0x40, 0x14, 0x38));
    FCML_A32_M("vunpcklps (%eax),%xmm6,%xmm7", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0x38), FCML_MI(0xc5, 0xc8, 0x14, 0x38));
    FCML_I32_M("vunpcklps xmm7,xmm6,xmmword ptr [eax]", 2, FCML_MI(0x62, 0xf1, 0x4c, 0x08, 0x14, 0x38), FCML_MI(0xc5, 0xc8, 0x14, 0x38));
    /* ymm1, ymm2, m256 */
    FCML_A64_M("vunpcklps (%rax),%ymm7,%ymm15", 2, FCML_MI(0x62, 0x71, 0x44, 0x28, 0x14, 0x38), FCML_MI(0xc5, 0x44, 0x14, 0x38));
    FCML_I64_M("vunpcklps ymm15,ymm7,ymmword ptr [rax]", 2, FCML_MI(0x62, 0x71, 0x44, 0x28, 0x14, 0x38), FCML_MI(0xc5, 0x44, 0x14, 0x38));
    FCML_A32_M("vunpcklps (%eax),%ymm5,%ymm7", 2, FCML_MI(0x62, 0xf1, 0x54, 0x28, 0x14, 0x38), FCML_MI(0xc5, 0xd4, 0x14, 0x38));
    FCML_I32_M("vunpcklps ymm7,ymm5,ymmword ptr [eax]", 2, FCML_MI(0x62, 0xf1, 0x54, 0x28, 0x14, 0x38), FCML_MI(0xc5, 0xd4, 0x14, 0x38));
    /* zmm1, zmm2, m512 */
    FCML_A64("vunpcklps (%rax),%zmm7,%zmm15", 0x62, 0x71, 0x44, 0x48, 0x14, 0x38);
    FCML_I64("vunpcklps zmm15,zmm7,zmmword ptr [rax]", 0x62, 0x71, 0x44, 0x48, 0x14, 0x38);
    FCML_A32("vunpcklps (%eax),%zmm3,%zmm7", 0x62, 0xf1, 0x64, 0x48, 0x14, 0x38);
    FCML_I32("vunpcklps zmm7,zmm3,zmmword ptr [eax]", 0x62, 0xf1, 0x64, 0x48, 0x14, 0x38);
    /* xmm1, xmm2, xmm3 */
    FCML_A64_M("vunpcklps %xmm1,%xmm7,%xmm15", 2, FCML_MI(0x62, 0x71, 0x44, 0x08, 0x14, 0xf9), FCML_MI(0xc5, 0x40, 0x14, 0xf9));
    FCML_I64_M("vunpcklps xmm15,xmm7,xmm1", 2, FCML_MI(0x62, 0x71, 0x44, 0x08, 0x14, 0xf9), FCML_MI(0xc5, 0x40, 0x14, 0xf9));
    FCML_A32_M("vunpcklps %xmm1,%xmm2,%xmm7", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x08, 0x14, 0xf9), FCML_MI(0xc5, 0xe8, 0x14, 0xf9));
    FCML_I32_M("vunpcklps xmm7,xmm2,xmm1", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x08, 0x14, 0xf9), FCML_MI(0xc5, 0xe8, 0x14, 0xf9));
    /* ymm1, ymm2, ymm3 */
    FCML_A64_M("vunpcklps %ymm6,%ymm7,%ymm14", 2, FCML_MI(0x62, 0x71, 0x44, 0x28, 0x14, 0xf6), FCML_MI(0xc5, 0x44, 0x14, 0xf6));
    FCML_I64_M("vunpcklps ymm14,ymm7,ymm6", 2, FCML_MI(0x62, 0x71, 0x44, 0x28, 0x14, 0xf6), FCML_MI(0xc5, 0x44, 0x14, 0xf6));
    FCML_A32_M("vunpcklps %ymm5,%ymm3,%ymm6", 2, FCML_MI(0x62, 0xf1, 0x64, 0x28, 0x14, 0xf5), FCML_MI(0xc5, 0xe4, 0x14, 0xf5));
    FCML_I32_M("vunpcklps ymm6,ymm3,ymm5", 2, FCML_MI(0x62, 0xf1, 0x64, 0x28, 0x14, 0xf5), FCML_MI(0xc5, 0xe4, 0x14, 0xf5));
    /* zmm1, zmm2, zmm3 */
    FCML_A64("vunpcklps %zmm4,%zmm15,%zmm6", 0x62, 0xf1, 0x04, 0x48, 0x14, 0xf4);
    FCML_I64("vunpcklps zmm6,zmm15,zmm4", 0x62, 0xf1, 0x04, 0x48, 0x14, 0xf4);
    FCML_A32("vunpcklps %zmm4,%zmm6,%zmm6", 0x62, 0xf1, 0x4c, 0x48, 0x14, 0xf4);
    FCML_I32("vunpcklps zmm6,zmm6,zmm4", 0x62, 0xf1, 0x4c, 0x48, 0x14, 0xf4);
    /* disp8 */
    FCML_I32("vunpcklps zmm1,zmm2,zmmword ptr [esp+00000200h]", 0x62, 0xf1, 0x6c, 0x48, 0x14, 0x4c, 0x24, 0x08);
    FCML_A32("vunpcklps 0x00000200(%esp),%zmm2,%zmm1", 0x62, 0xf1, 0x6c, 0x48, 0x14, 0x4c, 0x24, 0x08);
    FCML_I64("vunpcklps zmm1,zmm2,zmmword ptr [rsp+0000000000000200h]", 0x62, 0xf1, 0x6c, 0x48, 0x14, 0x4c, 0x24, 0x08);
    FCML_A64("vunpcklps 0x0000000000000200(%rsp),%zmm2,%zmm1", 0x62, 0xf1, 0x6c, 0x48, 0x14, 0x4c, 0x24, 0x08);
    FCML_I32_M("vunpcklps ymm1,ymm2,ymmword ptr [esp+00000100h]", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x28, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xec, 0x14, 0x8c, 0x24, 0x00, 0x01, 0x00, 0x00));
    FCML_A32_M("vunpcklps 0x00000100(%esp),%ymm2,%ymm1", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x28, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xec, 0x14, 0x8c, 0x24, 0x00, 0x01, 0x00, 0x00));
    FCML_I64_M("vunpcklps ymm1,ymm2,ymmword ptr [rsp+0000000000000100h]", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x28, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xec, 0x14, 0x8c, 0x24, 0x00, 0x01, 0x00, 0x00));
    FCML_A64_M("vunpcklps 0x0000000000000100(%rsp),%ymm2,%ymm1", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x28, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xec, 0x14, 0x8c, 0x24, 0x00, 0x01, 0x00, 0x00));
    FCML_I32_M("vunpcklps xmm1,xmm2,xmmword ptr [esp+00000080h]", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x08, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xe8, 0x14, 0x8c, 0x24, 0x80, 0x00, 0x00, 0x00));
    FCML_A32_M("vunpcklps 0x00000080(%esp),%xmm2,%xmm1", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x08, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xe8, 0x14, 0x8c, 0x24, 0x80, 0x00, 0x00, 0x00));
    FCML_I64_M("vunpcklps xmm1,xmm2,xmmword ptr [rsp+0000000000000080h]", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x08, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xe8, 0x14, 0x8c, 0x24, 0x80, 0x00, 0x00, 0x00));
    FCML_A64_M("vunpcklps 0x0000000000000080(%rsp),%xmm2,%xmm1", 2, FCML_MI(0x62, 0xf1, 0x6c, 0x08, 0x14, 0x4c, 0x24, 0x08), FCML_MI(0xc5, 0xe8, 0x14, 0x8c, 0x24, 0x80, 0x00, 0x00, 0x00));
    /* {k}{z} */
    FCML_A64("vunpcklps (%r9,%r8),%xmm14,%xmm10{%k4}{z}", 0x62, 0x11, 0x0c, 0x8c, 0x14, 0x14, 0x01);
    FCML_I64("vunpcklps xmm10{k4}{z},xmm14,xmmword ptr [r9+r8]", 0x62, 0x11, 0x0c, 0x8c, 0x14, 0x14, 0x01);
    FCML_A32("vunpcklps (%ecx,%eax),%xmm7,%xmm2{%k5}{z}", 0x62, 0xf1, 0x44, 0x8d, 0x14, 0x14, 0x01);
    FCML_I32("vunpcklps xmm2{k5}{z},xmm7,xmmword ptr [ecx+eax]", 0x62, 0xf1, 0x44, 0x8d, 0x14, 0x14, 0x01);
    FCML_A64("vunpcklps (%r9,%r8),%ymm14,%ymm10{%k4}{z}", 0x62, 0x11, 0x0c, 0xac, 0x14, 0x14, 0x01);
    FCML_I64("vunpcklps ymm10{k4}{z},ymm14,ymmword ptr [r9+r8]", 0x62, 0x11, 0x0c, 0xac, 0x14, 0x14, 0x01);
    FCML_A32("vunpcklps (%ecx,%eax),%ymm7,%ymm2{%k5}{z}", 0x62, 0xf1, 0x44, 0xad, 0x14, 0x14, 0x01);
    FCML_I32("vunpcklps ymm2{k5}{z},ymm7,ymmword ptr [ecx+eax]", 0x62, 0xf1, 0x44, 0xad, 0x14, 0x14, 0x01);
    FCML_A64("vunpcklps (%r9,%r8),%zmm14,%zmm10{%k4}{z}", 0x62, 0x11, 0x0c, 0xcc, 0x14, 0x14, 0x01);
    FCML_I64("vunpcklps zmm10{k4}{z},zmm14,zmmword ptr [r9+r8]", 0x62, 0x11, 0x0c, 0xcc, 0x14, 0x14, 0x01);
    FCML_A32("vunpcklps (%ecx,%eax),%zmm7,%zmm2{%k5}{z}", 0x62, 0xf1, 0x44, 0xcd, 0x14, 0x14, 0x01);
    FCML_I32("vunpcklps zmm2{k5}{z},zmm7,zmmword ptr [ecx+eax]", 0x62, 0xf1, 0x44, 0xcd, 0x14, 0x14, 0x01);
    /* {k} */
    FCML_A64("vunpcklps (%r9,%r8),%xmm14,%xmm10{%k4}", 0x62, 0x11, 0x0c, 0x0c, 0x14, 0x14, 0x01);
    FCML_I64("vunpcklps xmm10{k4},xmm14,xmmword ptr [r9+r8]", 0x62, 0x11, 0x0c, 0x0c, 0x14, 0x14, 0x01);
    FCML_A32("vunpcklps (%ecx,%eax),%xmm7,%xmm2{%k5}", 0x62, 0xf1, 0x44, 0x0d, 0x14, 0x14, 0x01);
    FCML_I32("vunpcklps xmm2{k5},xmm7,xmmword ptr [ecx+eax]", 0x62, 0xf1, 0x44, 0x0d, 0x14, 0x14, 0x01);
    FCML_A64("vunpcklps (%r9,%r8),%ymm14,%ymm10{%k4}", 0x62, 0x11, 0x0c, 0x2c, 0x14, 0x14, 0x01);
    FCML_I64("vunpcklps ymm10{k4},ymm14,ymmword ptr [r9+r8]", 0x62, 0x11, 0x0c, 0x2c, 0x14, 0x14, 0x01);
    FCML_A32("vunpcklps (%ecx,%eax),%ymm7,%ymm2{%k5}", 0x62, 0xf1, 0x44, 0x2d, 0x14, 0x14, 0x01);
    FCML_I32("vunpcklps ymm2{k5},ymm7,ymmword ptr [ecx+eax]", 0x62, 0xf1, 0x44, 0x2d, 0x14, 0x14, 0x01);
    FCML_A64("vunpcklps (%r9,%r8),%zmm14,%zmm10{%k4}", 0x62, 0x11, 0x0c, 0x4c, 0x14, 0x14, 0x01);
    FCML_I64("vunpcklps zmm10{k4},zmm14,zmmword ptr [r9+r8]", 0x62, 0x11, 0x0c, 0x4c, 0x14, 0x14, 0x01);
    FCML_A32("vunpcklps (%ecx,%eax),%zmm7,%zmm2{%k5}", 0x62, 0xf1, 0x44, 0x4d, 0x14, 0x14, 0x01);
    FCML_I32("vunpcklps zmm2{k5},zmm7,zmmword ptr [ecx+eax]", 0x62, 0xf1, 0x44, 0x4d, 0x14, 0x14, 0x01);
    /* bcast */
    FCML_I64("vunpcklps zmm31,zmm21,dword ptr [rsi]{1to16}", 0x62, 0x61, 0x54, 0x50, 0x14, 0x3e);
    FCML_A64("vunpcklps (%rsi){1to16},%zmm21,%zmm31", 0x62, 0x61, 0x54, 0x50, 0x14, 0x3e);
    FCML_I64("vunpcklps ymm31,ymm21,dword ptr [rsi]{1to8}", 0x62, 0x61, 0x54, 0x30, 0x14, 0x3e);
    FCML_A64("vunpcklps (%rsi){1to8},%ymm21,%ymm31", 0x62, 0x61, 0x54, 0x30, 0x14, 0x3e);
    FCML_I64("vunpcklps xmm31,xmm21,dword ptr [rsi]{1to4}", 0x62, 0x61, 0x54, 0x10, 0x14, 0x3e);
    FCML_A64("vunpcklps (%rsi){1to4},%xmm21,%xmm31", 0x62, 0x61, 0x54, 0x10, 0x14, 0x3e);
    FCML_A32("vunpcklps (%esi){1to16},%zmm2,%zmm1", 0x62, 0xf1, 0x6c, 0x58, 0x14, 0x0e);
    FCML_I32("vunpcklps zmm1,zmm2,dword ptr [esi]{1to16}", 0x62, 0xf1, 0x6c, 0x58, 0x14, 0x0e);
    /* {k}{z}{bcast} */
    FCML_A64("vunpcklps (%rsi){1to8},%ymm21,%ymm31{%k7}{z}", 0x62, 0x61, 0x54, 0xb7, 0x14, 0x3e);
    FCML_I64("vunpcklps ymm31{k7}{z},ymm21,dword ptr [rsi]{1to8}", 0x62, 0x61, 0x54, 0xb7, 0x14, 0x3e);
    /* {bcast} disp8 */
    FCML_I32("vunpcklps zmm1,zmm2,dword ptr [esp+00000020h]{1to16}", 0x62, 0xf1, 0x6c, 0x58, 0x14, 0x4c, 0x24, 0x08);
    FCML_A32("vunpcklps 0x00000020(%esp){1to16},%zmm2,%zmm1", 0x62, 0xf1, 0x6c, 0x58, 0x14, 0x4c, 0x24, 0x08);
    FCML_I64("vunpcklps zmm1,zmm2,dword ptr [rsp+0000000000000020h]{1to16}", 0x62, 0xf1, 0x6c, 0x58, 0x14, 0x4c, 0x24, 0x08);
    FCML_A64("vunpcklps 0x0000000000000020(%rsp){1to16},%zmm2,%zmm1", 0x62, 0xf1, 0x6c, 0x58, 0x14, 0x4c, 0x24, 0x08);
    FCML_I32("vunpcklps ymm1,ymm2,dword ptr [esp+00000020h]{1to8}", 0x62, 0xf1, 0x6c, 0x38, 0x14, 0x4c, 0x24, 0x08);
    FCML_A32("vunpcklps 0x00000020(%esp){1to8},%ymm2,%ymm1", 0x62, 0xf1, 0x6c, 0x38, 0x14, 0x4c, 0x24, 0x08);
    FCML_I64("vunpcklps ymm1,ymm2,dword ptr [rsp+0000000000000020h]{1to8}", 0x62, 0xf1, 0x6c, 0x38, 0x14, 0x4c, 0x24, 0x08);
    FCML_A64("vunpcklps 0x0000000000000020(%rsp){1to8},%ymm2,%ymm1", 0x62, 0xf1, 0x6c, 0x38, 0x14, 0x4c, 0x24, 0x08);
    FCML_I32("vunpcklps xmm1,xmm2,dword ptr [esp+00000020h]{1to4}", 0x62, 0xf1, 0x6c, 0x18, 0x14, 0x4c, 0x24, 0x08);
    FCML_A32("vunpcklps 0x00000020(%esp){1to4},%xmm2,%xmm1", 0x62, 0xf1, 0x6c, 0x18, 0x14, 0x4c, 0x24, 0x08);
    FCML_I64("vunpcklps xmm1,xmm2,dword ptr [rsp+0000000000000020h]{1to4}", 0x62, 0xf1, 0x6c, 0x18, 0x14, 0x4c, 0x24, 0x08);
    FCML_A64("vunpcklps 0x0000000000000020(%rsp){1to4},%xmm2,%xmm1", 0x62, 0xf1, 0x6c, 0x18, 0x14, 0x4c, 0x24, 0x08);
}
