...
void fcml_tf_instruction_VPTESTMB(void) {
    /* xmm1, xmm2, m128 */
    FCML_A64("vptestmb $0xff,(%rax),%xmm7,%k0", 0x62, 0xf2, 0x45, 0x08, 0x26, 0x00, 0xff);
    FCML_I64("vptestmb k7,xmm7,xmmword ptr [rax],14h", 0x62, 0xf2, 0x45, 0x08, 0x26, 0x38, 0x14);
    /* ymm1, ymm2, m256 */
    FCML_A64("vptestmb $0xff,(%rax),%ymm7,%k0", 0x62, 0xf2, 0x45, 0x28, 0x26, 0x00, 0xff);
    FCML_I64("vptestmb k0,ymm7,ymmword ptr [rax],14h", 0x62, 0xf2, 0x45, 0x28, 0x26, 0x00, 0x14);
    /* zmm1, zmm2, m512 */
    FCML_A64("vptestmb $0xff,(%rax),%zmm7,%k7", 0x62, 0xf2, 0x45, 0x48, 0x26, 0x38, 0xff);
    FCML_I64("vptestmb k7,zmm7,zmmword ptr [rax],14h", 0x62, 0xf2, 0x45, 0x48, 0x26, 0x38, 0x14);
    /* xmm1, xmm2, xmm3 */
    FCML_A64("vptestmb $0xff,%xmm1,%xmm7,%k3", 0x62, 0xf2, 0x45, 0x08, 0x26, 0xd9, 0xff);
    FCML_I64("vptestmb k3,xmm7,xmm1,14h", 0x62, 0xf2, 0x45, 0x08, 0x26, 0xd9, 0x14);
    /* ymm1, ymm2, ymm3 */
    FCML_A64("vptestmb $0xff,%ymm6,%ymm7,%k1", 0x62, 0xf2, 0x45, 0x28, 0x26, 0xce, 0xff);
    FCML_I64("vptestmb k1,ymm7,ymm6,14h", 0x62, 0xf2, 0x45, 0x28, 0x26, 0xce, 0x14);
    /* zmm1, zmm2, zmm3 */
    FCML_A64("vptestmb $0xff,%zmm4,%zmm15,%k2", 0x62, 0xf2, 0x05, 0x48, 0x26, 0xd4, 0xff);
    FCML_I64("vptestmb k2,zmm15,zmm4,14h", 0x62, 0xf2, 0x05, 0x48, 0x26, 0xd4, 0x14);
    /* disp8 */
    FCML_I32("vptestmb k0,zmm2,zmmword ptr [esp+00000200h],14h", 0x62, 0xf2, 0x6d, 0x48, 0x26, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmb $0xff,0x00000200(%esp),%zmm2,%k2", 0x62, 0xf2, 0x6d, 0x48, 0x26, 0x54, 0x24, 0x08, 0xff);
    FCML_I32("vptestmb k1,ymm2,ymmword ptr [esp+00000100h],14h", 0x62, 0xf2, 0x6d, 0x28, 0x26, 0x4c, 0x24, 0x08, 0x14);
    FCML_A32("vptestmb $0xff,0x00000100(%esp),%ymm2,%k4", 0x62, 0xf2, 0x6d, 0x28, 0x26, 0x64, 0x24, 0x08, 0xff);
    FCML_I32("vptestmb k0,xmm2,xmmword ptr [esp+00000080h],14h", 0x62, 0xf2, 0x6d, 0x08, 0x26, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmb $0xff,0x00000080(%esp),%xmm2,%k3", 0x62, 0xf2, 0x6d, 0x08, 0x26, 0x5c, 0x24, 0x08, 0xff);
    /* {k} */
    FCML_A64("vptestmb $0xff,(%r9,%r8),%xmm14,%k1{%k4}", 0x62, 0x92, 0x0d, 0x0c, 0x26, 0x0c, 0x01, 0xff);
    FCML_I64("vptestmb k0{k4},xmm14,xmmword ptr [r9+r8],14h", 0x62, 0x92, 0x0d, 0x0c, 0x26, 0x04, 0x01, 0x14);
    FCML_A64("vptestmb $0xff,(%r9,%r8),%ymm14,%k0{%k4}", 0x62, 0x92, 0x0d, 0x2c, 0x26, 0x04, 0x01, 0xff);
    FCML_I64("vptestmb k1{k4},ymm14,ymmword ptr [r9+r8],14h", 0x62, 0x92, 0x0d, 0x2c, 0x26, 0x0c, 0x01, 0x14);
    FCML_A64("vptestmb $0xff,(%r9,%r8),%zmm14,%k2{%k4}", 0x62, 0x92, 0x0d, 0x4c, 0x26, 0x14, 0x01, 0xff);
    FCML_I64("vptestmb k7{k4},zmm14,zmmword ptr [r9+r8],14h", 0x62, 0x92, 0x0d, 0x4c, 0x26, 0x3c, 0x01, 0x14);
}

void fcml_tf_instruction_VPTESTMW(void) {
    /* xmm1, xmm2, m128 */
    FCML_A64("vptestmw $0xff,(%rax),%xmm7,%k0", 0x62, 0xf2, 0xC5, 0x08, 0x26, 0x00, 0xff);
    FCML_I64("vptestmw k7,xmm7,xmmword ptr [rax],14h", 0x62, 0xf2, 0xC5, 0x08, 0x26, 0x38, 0x14);
    /* ymm1, ymm2, m256 */
    FCML_A64("vptestmw $0xff,(%rax),%ymm7,%k0", 0x62, 0xf2, 0xC5, 0x28, 0x26, 0x00, 0xff);
    FCML_I64("vptestmw k0,ymm7,ymmword ptr [rax],14h", 0x62, 0xf2, 0xC5, 0x28, 0x26, 0x00, 0x14);
    /* zmm1, zmm2, m512 */
    FCML_A64("vptestmw $0xff,(%rax),%zmm7,%k7", 0x62, 0xf2, 0xC5, 0x48, 0x26, 0x38, 0xff);
    FCML_I64("vptestmw k7,zmm7,zmmword ptr [rax],14h", 0x62, 0xf2, 0xC5, 0x48, 0x26, 0x38, 0x14);
    /* xmm1, xmm2, xmm3 */
    FCML_A64("vptestmw $0xff,%xmm1,%xmm7,%k3", 0x62, 0xf2, 0xC5, 0x08, 0x26, 0xd9, 0xff);
    FCML_I64("vptestmw k3,xmm7,xmm1,14h", 0x62, 0xf2, 0xC5, 0x08, 0x26, 0xd9, 0x14);
    /* ymm1, ymm2, ymm3 */
    FCML_A64("vptestmw $0xff,%ymm6,%ymm7,%k1", 0x62, 0xf2, 0xC5, 0x28, 0x26, 0xce, 0xff);
    FCML_I64("vptestmw k1,ymm7,ymm6,14h", 0x62, 0xf2, 0xC5, 0x28, 0x26, 0xce, 0x14);
    /* zmm1, zmm2, zmm3 */
    FCML_A64("vptestmw $0xff,%zmm4,%zmm15,%k2", 0x62, 0xf2, 0x85, 0x48, 0x26, 0xd4, 0xff);
    FCML_I64("vptestmw k2,zmm15,zmm4,14h", 0x62, 0xf2, 0x85, 0x48, 0x26, 0xd4, 0x14);
    /* disp8 */
    FCML_I32("vptestmw k0,zmm2,zmmword ptr [esp+00000200h],14h", 0x62, 0xf2, 0xED, 0x48, 0x26, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmw $0xff,0x00000200(%esp),%zmm2,%k2", 0x62, 0xf2, 0xED, 0x48, 0x26, 0x54, 0x24, 0x08, 0xff);
    FCML_I32("vptestmw k1,ymm2,ymmword ptr [esp+00000100h],14h", 0x62, 0xf2, 0xED, 0x28, 0x26, 0x4c, 0x24, 0x08, 0x14);
    FCML_A32("vptestmw $0xff,0x00000100(%esp),%ymm2,%k4", 0x62, 0xf2, 0xED, 0x28, 0x26, 0x64, 0x24, 0x08, 0xff);
    FCML_I32("vptestmw k0,xmm2,xmmword ptr [esp+00000080h],14h", 0x62, 0xf2, 0xED, 0x08, 0x26, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmw $0xff,0x00000080(%esp),%xmm2,%k3", 0x62, 0xf2, 0xED, 0x08, 0x26, 0x5c, 0x24, 0x08, 0xff);
    /* {k} */
    FCML_A64("vptestmw $0xff,(%r9,%r8),%xmm14,%k1{%k4}", 0x62, 0x92, 0x8D, 0x0c, 0x26, 0x0c, 0x01, 0xff);
    FCML_I64("vptestmw k0{k4},xmm14,xmmword ptr [r9+r8],14h", 0x62, 0x92, 0x8D, 0x0c, 0x26, 0x04, 0x01, 0x14);
    FCML_A64("vptestmw $0xff,(%r9,%r8),%ymm14,%k0{%k4}", 0x62, 0x92, 0x8D, 0x2c, 0x26, 0x04, 0x01, 0xff);
    FCML_I64("vptestmw k1{k4},ymm14,ymmword ptr [r9+r8],14h", 0x62, 0x92, 0x8D, 0x2c, 0x26, 0x0c, 0x01, 0x14);
    FCML_A64("vptestmw $0xff,(%r9,%r8),%zmm14,%k2{%k4}", 0x62, 0x92, 0x8D, 0x4c, 0x26, 0x14, 0x01, 0xff);
    FCML_I64("vptestmw k7{k4},zmm14,zmmword ptr [r9+r8],14h", 0x62, 0x92, 0x8D, 0x4c, 0x26, 0x3c, 0x01, 0x14);
}

void fcml_tf_instruction_VPTESTMD(void) {
    /* xmm1, xmm2, m128 */
    FCML_A64("vptestmd $0xff,(%rax),%xmm7,%k0", 0x62, 0xf2, 0x45, 0x08, 0x27, 0x00, 0xff);
    FCML_I64("vptestmd k7,xmm7,xmmword ptr [rax],14h", 0x62, 0xf2, 0x45, 0x08, 0x27, 0x38, 0x14);
    /* ymm1, ymm2, m256 */
    FCML_A64("vptestmd $0xff,(%rax),%ymm7,%k0", 0x62, 0xf2, 0x45, 0x28, 0x27, 0x00, 0xff);
    FCML_I64("vptestmd k0,ymm7,ymmword ptr [rax],14h", 0x62, 0xf2, 0x45, 0x28, 0x27, 0x00, 0x14);
    /* zmm1, zmm2, m512 */
    FCML_A64("vptestmd $0xff,(%rax),%zmm7,%k7", 0x62, 0xf2, 0x45, 0x48, 0x27, 0x38, 0xff);
    FCML_I64("vptestmd k7,zmm7,zmmword ptr [rax],14h", 0x62, 0xf2, 0x45, 0x48, 0x27, 0x38, 0x14);
    /* xmm1, xmm2, xmm3 */
    FCML_A64("vptestmd $0xff,%xmm1,%xmm7,%k3", 0x62, 0xf2, 0x45, 0x08, 0x27, 0xd9, 0xff);
    FCML_I64("vptestmd k3,xmm7,xmm1,14h", 0x62, 0xf2, 0x45, 0x08, 0x27, 0xd9, 0x14);
    /* ymm1, ymm2, ymm3 */
    FCML_A64("vptestmd $0xff,%ymm6,%ymm7,%k1", 0x62, 0xf2, 0x45, 0x28, 0x27, 0xce, 0xff);
    FCML_I64("vptestmd k1,ymm7,ymm6,14h", 0x62, 0xf2, 0x45, 0x28, 0x27, 0xce, 0x14);
    /* zmm1, zmm2, zmm3 */
    FCML_A64("vptestmd $0xff,%zmm4,%zmm15,%k2", 0x62, 0xf2, 0x05, 0x48, 0x27, 0xd4, 0xff);
    FCML_I64("vptestmd k2,zmm15,zmm4,14h", 0x62, 0xf2, 0x05, 0x48, 0x27, 0xd4, 0x14);
    /* disp8 */
    FCML_I32("vptestmd k0,zmm2,zmmword ptr [esp+00000200h],14h", 0x62, 0xf2, 0x6d, 0x48, 0x27, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmd $0xff,0x00000200(%esp),%zmm2,%k2", 0x62, 0xf2, 0x6d, 0x48, 0x27, 0x54, 0x24, 0x08, 0xff);
    FCML_I32("vptestmd k1,ymm2,ymmword ptr [esp+00000100h],14h", 0x62, 0xf2, 0x6d, 0x28, 0x27, 0x4c, 0x24, 0x08, 0x14);
    FCML_A32("vptestmd $0xff,0x00000100(%esp),%ymm2,%k4", 0x62, 0xf2, 0x6d, 0x28, 0x27, 0x64, 0x24, 0x08, 0xff);
    FCML_I32("vptestmd k0,xmm2,xmmword ptr [esp+00000080h],14h", 0x62, 0xf2, 0x6d, 0x08, 0x27, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmd $0xff,0x00000080(%esp),%xmm2,%k3", 0x62, 0xf2, 0x6d, 0x08, 0x27, 0x5c, 0x24, 0x08, 0xff);
    /* {k} */
    FCML_A64("vptestmd $0xff,(%r9,%r8),%xmm14,%k1{%k4}", 0x62, 0x92, 0x0d, 0x0c, 0x27, 0x0c, 0x01, 0xff);
    FCML_I64("vptestmd k0{k4},xmm14,xmmword ptr [r9+r8],14h", 0x62, 0x92, 0x0d, 0x0c, 0x27, 0x04, 0x01, 0x14);
    FCML_A64("vptestmd $0xff,(%r9,%r8),%ymm14,%k0{%k4}", 0x62, 0x92, 0x0d, 0x2c, 0x27, 0x04, 0x01, 0xff);
    FCML_I64("vptestmd k1{k4},ymm14,ymmword ptr [r9+r8],14h", 0x62, 0x92, 0x0d, 0x2c, 0x27, 0x0c, 0x01, 0x14);
    FCML_A64("vptestmd $0xff,(%r9,%r8),%zmm14,%k2{%k4}", 0x62, 0x92, 0x0d, 0x4c, 0x27, 0x14, 0x01, 0xff);
    FCML_I64("vptestmd k7{k4},zmm14,zmmword ptr [r9+r8],14h", 0x62, 0x92, 0x0d, 0x4c, 0x27, 0x3c, 0x01, 0x14);
    /* bcast */
    FCML_I32("vptestmd k0,xmm2,dword ptr [esp+00000080h]{1to4},14h", 0x62, 0xf2, 0x6d, 0x18, 0x27, 0x44, 0x24, 0x20, 0x14);
}

void fcml_tf_instruction_VPTESTMQ(void) {
    /* xmm1, xmm2, m128 */
    FCML_A64("vptestmq $0xff,(%rax),%xmm7,%k0", 0x62, 0xf2, 0xC5, 0x08, 0x27, 0x00, 0xff);
    FCML_I64("vptestmq k7,xmm7,xmmword ptr [rax],14h", 0x62, 0xf2, 0xC5, 0x08, 0x27, 0x38, 0x14);
    /* ymm1, ymm2, m256 */
    FCML_A64("vptestmq $0xff,(%rax),%ymm7,%k0", 0x62, 0xf2, 0xC5, 0x28, 0x27, 0x00, 0xff);
    FCML_I64("vptestmq k0,ymm7,ymmword ptr [rax],14h", 0x62, 0xf2, 0xC5, 0x28, 0x27, 0x00, 0x14);
    /* zmm1, zmm2, m512 */
    FCML_A64("vptestmq $0xff,(%rax),%zmm7,%k7", 0x62, 0xf2, 0xC5, 0x48, 0x27, 0x38, 0xff);
    FCML_I64("vptestmq k7,zmm7,zmmword ptr [rax],14h", 0x62, 0xf2, 0xC5, 0x48, 0x27, 0x38, 0x14);
    /* xmm1, xmm2, xmm3 */
    FCML_A64("vptestmq $0xff,%xmm1,%xmm7,%k3", 0x62, 0xf2, 0xC5, 0x08, 0x27, 0xd9, 0xff);
    FCML_I64("vptestmq k3,xmm7,xmm1,14h", 0x62, 0xf2, 0xC5, 0x08, 0x27, 0xd9, 0x14);
    /* ymm1, ymm2, ymm3 */
    FCML_A64("vptestmq $0xff,%ymm6,%ymm7,%k1", 0x62, 0xf2, 0xC5, 0x28, 0x27, 0xce, 0xff);
    FCML_I64("vptestmq k1,ymm7,ymm6,14h", 0x62, 0xf2, 0xC5, 0x28, 0x27, 0xce, 0x14);
    /* zmm1, zmm2, zmm3 */
    FCML_A64("vptestmq $0xff,%zmm4,%zmm15,%k2", 0x62, 0xf2, 0x85, 0x48, 0x27, 0xd4, 0xff);
    FCML_I64("vptestmq k2,zmm15,zmm4,14h", 0x62, 0xf2, 0x85, 0x48, 0x27, 0xd4, 0x14);
    /* disp8 */
    FCML_I32("vptestmq k0,zmm2,zmmword ptr [esp+00000200h],14h", 0x62, 0xf2, 0xED, 0x48, 0x27, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmq $0xff,0x00000200(%esp),%zmm2,%k2", 0x62, 0xf2, 0xED, 0x48, 0x27, 0x54, 0x24, 0x08, 0xff);
    FCML_I32("vptestmq k1,ymm2,ymmword ptr [esp+00000100h],14h", 0x62, 0xf2, 0xED, 0x28, 0x27, 0x4c, 0x24, 0x08, 0x14);
    FCML_A32("vptestmq $0xff,0x00000100(%esp),%ymm2,%k4", 0x62, 0xf2, 0xED, 0x28, 0x27, 0x64, 0x24, 0x08, 0xff);
    FCML_I32("vptestmq k0,xmm2,xmmword ptr [esp+00000080h],14h", 0x62, 0xf2, 0xED, 0x08, 0x27, 0x44, 0x24, 0x08, 0x14);
    FCML_A32("vptestmq $0xff,0x00000080(%esp),%xmm2,%k3", 0x62, 0xf2, 0xED, 0x08, 0x27, 0x5c, 0x24, 0x08, 0xff);
    /* {k} */
    FCML_A64("vptestmq $0xff,(%r9,%r8),%xmm14,%k1{%k4}", 0x62, 0x92, 0x8D, 0x0c, 0x27, 0x0c, 0x01, 0xff);
    FCML_I64("vptestmq k0{k4},xmm14,xmmword ptr [r9+r8],14h", 0x62, 0x92, 0x8D, 0x0c, 0x27, 0x04, 0x01, 0x14);
    FCML_A64("vptestmq $0xff,(%r9,%r8),%ymm14,%k0{%k4}", 0x62, 0x92, 0x8D, 0x2c, 0x27, 0x04, 0x01, 0xff);
    FCML_I64("vptestmq k1{k4},ymm14,ymmword ptr [r9+r8],14h", 0x62, 0x92, 0x8D, 0x2c, 0x27, 0x0c, 0x01, 0x14);
    FCML_A64("vptestmq $0xff,(%r9,%r8),%zmm14,%k2{%k4}", 0x62, 0x92, 0x8D, 0x4c, 0x27, 0x14, 0x01, 0xff);
    FCML_I64("vptestmq k7{k4},zmm14,zmmword ptr [r9+r8],14h", 0x62, 0x92, 0x8D, 0x4c, 0x27, 0x3c, 0x01, 0x14);
    /* bcast */
    FCML_I32("vptestmq k0,xmm2,mmword ptr [esp+00000080h]{1to2},14h", 0x62, 0xf2, 0xed, 0x18, 0x27, 0x44, 0x24, 0x10, 0x14);
}
