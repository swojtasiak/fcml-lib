...
void fcml_tf_instruction_VRCP14PD(void) {
    ...
    FCML_I64("vrcp14pd zmm31{k7}{z},zmm4,{sae}", 0x62, 0x62, 0xfd, 0x9f, 0x4c, 0xfc);
...
void fcml_tf_instruction_VRCP14PS(void) {
    ...
    FCML_I64("vrcp14ps zmm31{k7}{z},zmm4,{sae}", 0x62, 0x62, 0x7d, 0x9f, 0x4c, 0xfc);
...
void fcml_tf_instruction_VRCP14SD(void) {
    ...
    FCML_I64("vrcp14sd xmm31{k7}{z},xmm4,xmm6,{sae}", 0x62, 0x62, 0xdd, 0x9f, 0x4d, 0xfe);
}
...
void fcml_tf_instruction_VRCP14SS(void) {
    ...
    FCML_I64("vrcp14ss xmm31{k7}{z},xmm4,xmm6,{sae}", 0x62, 0x62, 0x5d, 0x9f, 0x4d, 0xfe);
}
