...
void fcml_tf_instruction_V4FMADDPS(void) {
    FCML_I64_D("v4fmaddps zmm2,zmm4,oword ptr [rax]", 0x62, 0xf2, 0x5f, 0x48, 0x9a, 0x10);
    FCML_I64_D("v4fmaddps zmm2,zmm4,oword ptr [rax+0000000000000040h]", 0x62, 0xf2, 0x5f, 0x48, 0x9a, 0x50, 0x04);
    FCML_A64_A("v4fmaddps (%rax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0x9a, 0x10);
    FCML_A64_A("v4fmaddps (%rax),%zmm4,%zmm2{%k2}", 0x62, 0xf2, 0x5f, 0x4a, 0x9a, 0x10);
    FCML_A64_A("v4fmaddps (%rax),%zmm4,%zmm2{%k1}{z}", 0x62, 0xf2, 0x5f, 0xc9, 0x9a, 0x10);
    FCML_A64_A("v4fmaddps 0x40(%rax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0x9a, 0x50, 0x04);
    FCML_A32_A("v4fmaddps (%eax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0x9a, 0x10);
    FCML_A32_A("v4fmaddps (%eax),%zmm4,%zmm2{%k2}", 0x62, 0xf2, 0x5f, 0x4a, 0x9a, 0x10);
    FCML_A32_A("v4fmaddps (%eax),%zmm4,%zmm2{%k1}{z}", 0x62, 0xf2, 0x5f, 0xc9, 0x9a, 0x10);
    FCML_A32_A("v4fmaddps 0x40(%eax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0x9a, 0x50, 0x04);
}

void fcml_tf_instruction_V4FNMADDPS(void) {
    FCML_I64_D("v4fnmaddps zmm2,zmm4,oword ptr [rax]", 0x62, 0xf2, 0x5f, 0x48, 0xaa, 0x10);
    FCML_I64_D("v4fnmaddps zmm2,zmm4,oword ptr [rax+0000000000000040h]", 0x62, 0xf2, 0x5f, 0x48, 0xaa, 0x50, 0x04);
    FCML_A64_A("v4fnmaddps (%rax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0xaa, 0x10);
    FCML_A64_A("v4fnmaddps (%rax),%zmm4,%zmm2{%k2}", 0x62, 0xf2, 0x5f, 0x4a, 0xaa, 0x10);
    FCML_A64_A("v4fnmaddps (%rax),%zmm4,%zmm2{%k1}{z}", 0x62, 0xf2, 0x5f, 0xc9, 0xaa, 0x10);
    FCML_A64_A("v4fnmaddps 0x40(%rax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0xaa, 0x50, 0x04);
    FCML_A32_A("v4fnmaddps (%eax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0xaa, 0x10);
    FCML_A32_A("v4fnmaddps (%eax),%zmm4,%zmm2{%k2}", 0x62, 0xf2, 0x5f, 0x4a, 0xaa, 0x10);
    FCML_A32_A("v4fnmaddps (%eax),%zmm4,%zmm2{%k1}{z}", 0x62, 0xf2, 0x5f, 0xc9, 0xaa, 0x10);
    FCML_A32_A("v4fnmaddps 0x40(%eax),%zmm4,%zmm2", 0x62, 0xf2, 0x5f, 0x48, 0xaa, 0x50, 0x04);
}
