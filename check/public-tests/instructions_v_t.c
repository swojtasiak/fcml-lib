...
void fcml_tf_instruction_VCVTTPS2QQ(void) {
    FCML_I32("vcvttps2qq xmm0,xmmword ptr [eax]", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0x00);
    FCML_I32("vcvttps2qq xmm0,xmm0", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0xc0);

    FCML_I32("vcvttps2qq xmm0,ymmword ptr [eax]", 0x62, 0xf1, 0x7d, 0x28, 0x78, 0x00);
    FCML_I64("vcvttps2qq xmm0,ymm0", 0x62, 0xf1, 0x7d, 0x28, 0x78, 0xc0);

    FCML_A64("vcvttps2qq (%rax),%xmm0", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0x00);
    FCML_A64("vcvttps2qq %xmm0,%xmm0", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0xc0);
    FCML_A64("vcvttps2qq (%rax),%xmm0", 0x62, 0xf1, 0x7d, 0x28, 0x78, 0x00);
    FCML_A64("vcvttps2qq %ymm0,%xmm0", 0x62, 0xf1, 0x7d, 0x28, 0x78, 0xc0);

    FCML_I64("vcvttps2qq xmm3,xmm0", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0xd8);
    FCML_I32("vcvttps2qq xmm3,xmm0", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0xd8);
    FCML_A64("vcvttps2qq %xmm0,%xmm3", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0xd8);
    FCML_A64("vcvttps2qq %xmm0,%xmm3", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0xd8);
    FCML_A64("vcvttps2qq (%rax),%xmm0", 0x62, 0xf1, 0x7d, 0x08, 0x78, 0x00);

    FCML_I64("vcvttps2qq xmm10{k1},xmmword ptr [r9+r8]", 0x62, 0x11, 0x7d, 0x09, 0x78, 0x14, 0x01);
    FCML_A64("vcvttps2qq (%r9,%r8),%xmm10{%k1}", 0x62, 0x11, 0x7d, 0x09, 0x78, 0x14, 0x01);
    FCML_I64("vcvttps2qq xmm10{k1},ymmword ptr [r9+r8]", 0x62, 0x11, 0x7d, 0x29, 0x78, 0x14, 0x01);
    FCML_A64("vcvttps2qq (%r9,%r8),%xmm10{%k1}", 0x62, 0x11, 0x7d, 0x29, 0x78, 0x14, 0x01);
    FCML_I64("vcvttps2qq ymm1{k1},zmmword ptr [r9+r8]", 0x62, 0x91, 0x7d, 0x49, 0x78, 0x0c, 0x01);
    FCML_A64("vcvttps2qq (%r9,%r8),%ymm1{%k1}", 0x62, 0x91, 0x7d, 0x49, 0x78, 0x0c, 0x01);

    FCML_I64("vcvttps2qq zmm31{k7}{z},ymm4,{sae}", 0x62, 0x61, 0x7d, 0x9f, 0x78, 0xfc);

    FCML_I64("vcvttps2qq xmm1{k4}{z},xmmword ptr [rsp+0000000000000040h]", 0x62, 0xf1, 0x7d, 0x8c, 0x78, 0x4c, 0x24, 0x04);
    FCML_I64("vcvttps2qq xmm1{k4}{z},dword ptr [rsp+0000000000000020h]{1to4}", 0x62, 0xf1, 0x7d, 0x9c, 0x78, 0x4c, 0x24, 0x08);
}
