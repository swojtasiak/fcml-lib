...
void fcml_tf_instruction_VFMADDSD(void) {
    ...
    FCML_I64("vfmadd132sd ymm31{k7}{z},ymm21,mmword ptr [rsi]{1to4}", 0x62, 0x62, 0xd5, 0xb7, 0x99, 0x3e);
    FCML_I64("vfmadd213sd ymm31{k7}{z},ymm21,mmword ptr [rsi]{1to4}", 0x62, 0x62, 0xd5, 0xb7, 0xa9, 0x3e);
    FCML_I64("vfmadd231sd ymm31{k7}{z},ymm21,mmword ptr [rsi]{1to4}", 0x62, 0x62, 0xd5, 0xb7, 0xb9, 0x3e);

    FCML_I64("vfmadd132sd xmm1,xmm5,xmmword ptr [rsp+0000000000000010h]", 0x62, 0xf2, 0xd5, 0x08, 0x99, 0x4c, 0x24, 0x02);
    FCML_I64("vfmadd213sd xmm1,xmm5,xmmword ptr [rsp+0000000000000010h]", 0x62, 0xf2, 0xd5, 0x08, 0xa9, 0x4c, 0x24, 0x02);
    FCML_I64("vfmadd231sd xmm1{k4},xmm5,xmmword ptr [rsp+0000000000000010h]", 0x62, 0xf2, 0xd5, 0x0c, 0xb9, 0x4c, 0x24, 0x02);
}
