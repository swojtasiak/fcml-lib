...
void fcml_tf_instruction_VPERMIL2PS(void) {
    ...
    FCML_I64_A_FAILED( "vpermil2ps zmm0,zmm4,zmm7,zmmword ptr [rcx],01h", 0xC4, 0xE3, 0xDD, 0x49, 0x01, 0x71 );
}

void fcml_tf_instruction_VPERMIL2PD(void) {
    FCML_I64_A_FAILED( "vpermil2pd zmm0,zmm4,zmm7,zmmword ptr [rcx],01h", 0xC4, 0xE3, 0xDD, 0x49, 0x01, 0x71 );
