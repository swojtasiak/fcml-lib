...
void fcml_tf_instruction_MOVSHDUP(void) {
    ...
    FCML_A64_M("vmovshdup 0x0000000000000040(%rax),%zmm0", 2, FCML_MI(0x62, 0xf1, 0x7e, 0x48, 0x16, 0x40, 0x01), FCML_MI(0xc5, 0xfa, 0x16, 0x40, 0x40));
...
void fcml_tf_instruction_MOVSLDUP(void) {
    ...
    FCML_A64_M("vmovsldup 0x0000000000000040(%rax),%zmm0", 2, FCML_MI(0x62, 0xf1, 0x7e, 0x48, 0x12, 0x40, 0x01), FCML_MI(0xc5, 0xfa, 0x12, 0x40, 0x40));
