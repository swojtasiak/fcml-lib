...
void fcml_tf_instruction_INSERTPS(void) {
    ...
    FCML_I64_M("vinsertps xmm8,xmm14,dword ptr [r8],20h", 2, FCML_MI(0x62, 0x53, 0x0d, 0x08, 0x21, 0x00, 0x20), FCML_MI(0xc4, 0x43, 0x09, 0x21, 0x00, 0x20));
    FCML_I32_M("vinsertps xmm0,xmm6,dword ptr [eax],20h", 2, FCML_MI(0x62, 0xf3, 0x4d, 0x08, 0x21, 0x00, 0x20), FCML_MI(0xc4, 0xe3, 0x49, 0x21, 0x00, 0x20));
    FCML_I32_M("vinsertps xmm0,xmm6,xmm0,20h", 2, FCML_MI(0x62, 0xf3, 0x4d, 0x08, 0x21, 0xc0, 0x20), FCML_MI(0xc4, 0xe3, 0x49, 0x21, 0xc0, 0x20));
    FCML_A64_M("vinsertps $0x20,(%r8),%xmm14,%xmm8", 2, FCML_MI(0x62, 0x53, 0x0d, 0x08, 0x21, 0x00, 0x20), FCML_MI(0xc4, 0x43, 0x09, 0x21, 0x00, 0x20));
}
