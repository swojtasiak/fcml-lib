...
void fcml_tf_instruction_CVTPD2DQ(void) {
    ...
    FCML_I64_A_FAILED("vcvtpd2dq xmm10{k1},ymm30,{ru-sae}", 0x62, 0x11, 0xFF, 0x59, 0x5B, 0xD6);
    FCML_I64_A_FAILED("vcvtpd2dq xmm10{k1},xmm30,{ru-sae}", 0x62, 0x11, 0xFF, 0x59, 0x5B, 0xD6);
}
