...
void fcml_tf_instruction_JMP(void) {
    ...
    // There are no hints, so due to ambiguity instruction can be assembled as near and far indirect jump.
    // But anyway default chooser will choose the shorter near indirect jump.
