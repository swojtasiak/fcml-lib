...
void fcml_tf_instruction_SUBPD(void) {
    ...
    FCML_I32("vsubpd xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xf1, 0xf5, 0x09, 0x5c, 0x4d, 0x00);
    ...
    FCML_I32("vsubpd xmm1{k1}{z},xmm1,xmmword ptr [ebp]", 0x62, 0xf1, 0xf5, 0x89, 0x5c, 0x4d, 0x00);
