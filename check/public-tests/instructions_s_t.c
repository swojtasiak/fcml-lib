...
void fcml_tf_instruction_SUBSD(void) {
    ...
    FCML_I32_A_FAILED("vsubsd ymm1,ymm6,ymm4,{rn-sae}", 0x62, 0xF1, 0xCF, 0x18, 0x5c, 0xCC);
    FCML_I32_A_FAILED("vsubsd zmm1,zmm6,zmm4,{rn-sae}", 0x62, 0xF1, 0xCF, 0x18, 0x5c, 0xCC);
    FCML_I64_A_FAILED("vsubsd ymm1,ymm6,ymm4,{rn-sae}", 0x62, 0xF1, 0xCF, 0x18, 0x5c, 0xCC);
    FCML_I64_A_FAILED("vsubsd zmm1,zmm6,zmm4,{rn-sae}", 0x62, 0xF1, 0xCF, 0x18, 0x5c, 0xCC);
}
