...
void fcml_tf_instruction_PSLL(void) {
    ...
    FCML_I64_M("vpsllq xmm0,xmm0,xmmword ptr [rax]", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x08, 0xf3, 0x00), FCML_MI(0xc5, 0xf9, 0xf3, 0x00));
    FCML_I64_M("vpsllq ymm0,ymm0,xmmword ptr [rax]", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x28, 0xf3, 0x00), FCML_MI(0xc5, 0xfd, 0xf3, 0x00));
    FCML_I32_M("vpsllq xmm0,xmm0,xmm1", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x08, 0xf3, 0xc1), FCML_MI(0xc5, 0xf9, 0xf3, 0xc1));
    FCML_I32_M("vpsllq ymm0,ymm0,xmm1", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x28, 0xf3, 0xc1), FCML_MI(0xc5, 0xfd, 0xf3, 0xc1));

    FCML_I32_M("vpsllq xmm3,xmm0,0ffh", 2, FCML_MI(0x62, 0xf1, 0x65, 0x08, 0x73, 0xf0, 0xff), FCML_MI(0xc5, 0xe1, 0x73, 0xf0, 0xff));
    FCML_I64_M("vpsllq xmm3,xmm0,0ffh", 2, FCML_MI(0x62, 0xf1, 0x65, 0x08, 0x73, 0xf0, 0xff), FCML_MI(0xc5, 0xe1, 0x73, 0xf0, 0xff));
    FCML_I32_M("vpsllq ymm3,ymm0,0ffh", 2, FCML_MI(0x62, 0xf1, 0x65, 0x28, 0x73, 0xf0, 0xff), FCML_MI(0xc5, 0xe5, 0x73, 0xf0, 0xff));
    FCML_I64_M("vpsllq ymm3,ymm0,0ffh", 2, FCML_MI(0x62, 0xf1, 0x65, 0x28, 0x73, 0xf0, 0xff), FCML_MI(0xc5, 0xe5, 0x73, 0xf0, 0xff));
    ...
    FCML_A64_M("vpsllq (%rax),%xmm0,%xmm0", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x08, 0xf3, 0x00), FCML_MI(0xc5, 0xf9, 0xf3, 0x00));
    FCML_A64_M("vpsllq (%rax),%ymm0,%ymm0", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x28, 0xf3, 0x00), FCML_MI(0xc5, 0xfd, 0xf3, 0x00));
    FCML_A64_M("vpsllq %xmm1,%xmm0,%xmm0", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x08, 0xf3, 0xc1), FCML_MI(0xc5, 0xf9, 0xf3, 0xc1));
    FCML_A64_M("vpsllq %xmm1,%ymm0,%ymm0", 2, FCML_MI(0x62, 0xf1, 0x7d, 0x28, 0xf3, 0xc1), FCML_MI(0xc5, 0xfd, 0xf3, 0xc1));
    ...
    FCML_A64_M("vpslld $0xff,%ymm0,%ymm3", 2, FCML_MI(0x62, 0xf1, 0x65, 0x28, 0x72, 0xf0, 0xff), FCML_MI(0xc5, 0xe5, 0x72, 0xf0, 0xff));
    FCML_A64_M("vpsllq $0xff,%ymm0,%ymm3", 2, FCML_MI(0x62, 0xf1, 0x65, 0x28, 0x73, 0xf0, 0xff), FCML_MI(0xc5, 0xe5, 0x73, 0xf0, 0xff));
    ...
    FCML_A64("vpsllq $0x00,(%rsi){1to8},%zmm6{%k2}", 0x62, 0xf1, 0x4d, 0x5a, 0x73, 0x36, 0x00);
    FCML_A64("vpsllq $0x00,(%rsi),%zmm6{%k2}", 0x62, 0xf1, 0x4d, 0x4a, 0x73, 0x36, 0x00);
    FCML_A64("vpsllq $0x00,%zmm2,%zmm6{%k2}", 0x62, 0xf1, 0x4d, 0x4a, 0x73, 0xf2, 0x00);
    FCML_A64("vpsllq $0x00,%ymm2,%ymm6{%k2}", 0x62, 0xf1, 0x4d, 0x2a, 0x73, 0xf2, 0x00);
    FCML_A64("vpsllq $0x00,%xmm2,%xmm6{%k2}{z}", 0x62, 0xf1, 0x4d, 0x8a, 0x73, 0xf2, 0x00);
