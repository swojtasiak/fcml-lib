...
void fcml_tf_instruction_PMOVZX(void) {
    ...
    FCML_I32("vpmovzxwq ymm0,mmword ptr [eax]", 0xc4, 0xe2, 0x7d, 0x34, 0x00);
    FCML_I64("vpmovzxwq ymm0,xmm1", 0xc4, 0xe2, 0x7d, 0x34, 0xc1);

    FCML_I32( "vpmovzxdq xmm0,mmword ptr [eax]", 0xC4, 0xE2, 0x79, 0x35, 0x00 );
    FCML_I64( "vpmovzxdq xmm0,xmm1", 0xC4, 0xE2, 0x79, 0x35, 0xC1 );
    FCML_I32("vpmovzxdq ymm0,xmmword ptr [eax]", 0xc4, 0xe2, 0x7d, 0x35, 0x00);
    FCML_I64("vpmovzxdq ymm0,xmm1", 0xc4, 0xe2, 0x7d, 0x35, 0xc1);
