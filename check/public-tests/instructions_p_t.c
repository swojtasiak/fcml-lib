...
void fcml_tf_instruction_PSRLDQ(void) {
    ...
    FCML_A64("vpsrldq $0xff,%xmm0,%xmm3", 0xc5, 0xe1, 0x73, 0xd8, 0xff);
    FCML_A64("vpsrldq $0xff,%ymm0,%ymm3", 0xc5, 0xe5, 0x73, 0xd8, 0xff);
    FCML_I32("vpsrldq xmm3,xmm0,0ffh", 0xc5, 0xe1, 0x73, 0xd8, 0xff);
    FCML_I32("vpsrldq ymm3,ymm0,0ffh", 0xc5, 0xe5, 0x73, 0xd8, 0xff);
}
