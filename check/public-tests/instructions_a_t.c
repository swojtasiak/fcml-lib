...
void fcml_tf_instruction_ADD(void) {
    ...
    FCML_A32( "addl $0x04030201,(%ebp)", 0x81, 0x45, 0x00, 0x01, 0x02, 0x03, 0x04 );
...
void fcml_tf_instruction_ADDPD_VADDPD(void) {
    ...
    FCML_I32("vaddpd xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0xF5, 0x09, 0x58, 0x4D, 0x00);
    ...
    FCML_I32("vaddpd xmm1{k1}{z},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0xF5, 0x89, 0x58, 0x4D, 0x00);
...
void fcml_tf_instruction_ADDPS_VADDPS(void) {
    ...
    FCML_I32("vaddps xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0x74, 0x09, 0x58, 0x4D, 0x00);
    ...
    FCML_I32("vaddps xmm1{k1}{z},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0x74, 0x89, 0x58, 0x4D, 0x00);
...
void fcml_tf_instruction_ANDPD_VANDPD(void) {
    ...
    FCML_I32("vandpd xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0xF5, 0x09, 0x54, 0x4D, 0x00);
...
void fcml_tf_instruction_ANDPS_VANDPS(void) {
    ...
    FCML_I32("vandps xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0x74, 0x09, 0x54, 0x4D, 0x00);
    ...
    FCML_I32("vandps xmm1{k1}{z},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0x74, 0x89, 0x54, 0x4D, 0x00);
    FCML_I32_A("vandps xmm1{k1}{z},xmm1,xmmword ptr [ebp+00000000h]", 0x62, 0xF1, 0x74, 0x89, 0x54, 0x4D, 0x00);
...
void fcml_tf_instruction_ANDNPD_VANDNPD(void) {
    ...
    FCML_I32("vandnpd xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0xF5, 0x09, 0x55, 0x4D, 0x00);
...
void fcml_tf_instruction_ANDNPS_VANDNPS(void) {
    ...
    FCML_I32("vandnps xmm1{k1},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0x74, 0x09, 0x55, 0x4D, 0x00);
    ...
    FCML_I32("vandnps xmm1{k1}{z},xmm1,xmmword ptr [ebp]", 0x62, 0xF1, 0x74, 0x89, 0x55, 0x4D, 0x00);
