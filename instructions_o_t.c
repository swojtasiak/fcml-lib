...
void fcml_tf_instruction_OR(void) {
    ...
    FCML_I32( "or byte ptr [04030201h],0ffh", 0x80, 0x0d, 0x01, 0x02, 0x03, 0x04, 0xff );
    ...
    FCML_I32_M( "or dword ptr [esi],00000001h", 2, FCML_MI( 0x83, 0x0e, 0x01 ), FCML_MI( 0x81, 0x0e, 0x01, 0x00, 0x00, 0x00 ) );
    ...
    FCML_I32( "or byte ptr [ebp+04030201h],ah", 0x08, 0xa5, 0x01, 0x02, 0x03, 04 );
    ...
    FCML_I32( "or dword ptr [ebp+04030201h],esp", 0x09, 0xa5, 0x01, 0x02, 0x03, 04 );
