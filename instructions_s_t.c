...
void fcml_tf_instruction_SBB(void) {
    ...
    FCML_I32( "sbb byte ptr [eax],0ffh", 0x80, 0x18, 0xff );
    ...
    FCML_I32_M( "sbb dword ptr [eax],0ffffffffh", 2, FCML_MI( 0x83, 0x18, 0xff ), FCML_MI( 0x81, 0x18, 0xff, 0xff, 0xff, 0xff ) );
    ...
    FCML_I64_M( "sbb qword ptr [rdi+0000000004030201h],0000000000000005h", 2, FCML_MI( 0x48, 0x83, 0x9f, 0x01, 0x02, 0x03, 0x04, 0x05 ), FCML_MI( 0x48, 0x81, 0x9f, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x00, 0x00 ) );
    ...
    FCML_I32( "sbb dword ptr [ebp+04030201h],esp", 0x19, 0xa5, 0x01, 0x02, 0x03, 04 );
...
void fcml_tf_instruction_SUB(void) {
    ...
    FCML_I32( "sub byte ptr [04030201h],0ffh", 0x80, 0x2D, 0x01, 0x02, 0x03, 0x04, 0xff );
    ...
    FCML_I32_M( "sub dword ptr [esi],00000001h", 2, FCML_MI( 0x83, 0x2e, 0x01 ), FCML_MI( 0x81, 0x2e, 0x01, 0x00, 0x00, 0x00 ) );
    ...
    FCML_I64_M( "sub qword ptr [rdi+0000000004030201h],0000000000000005h", 2, FCML_MI( 0x48, 0x83, 0xaf, 0x01, 0x02, 0x03, 0x04, 0x05 ), FCML_MI( 0x48, 0x81, 0xaf, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x00, 0x00 ) );
    ...
    FCML_I32( "sub byte ptr [ebp+04030201h],ah", 0x28, 0xa5, 0x01, 0x02, 0x03, 04 );
    ...
    FCML_I32( "sub dword ptr [ebp+04030201h],esp", 0x29, 0xa5, 0x01, 0x02, 0x03, 04 );
