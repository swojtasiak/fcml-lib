...
fcml_st_dialect_mnemonic fcml_arr_dialect_att_mnemonics[] = {
	...
	{ FCML_TEXT("inc;incb[sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_INC, FCML_RM8 ), 0 },
	{ FCML_TEXT("inc;incw[sf,ow];incl[sf,od];incq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_INC, FCML_RMO ), 0 },
	{ FCML_TEXT("inc"), FCML_ASM_DIALECT_INSTRUCTION( F_INC, FCML_AM_ALL ), 0 },
	{ FCML_TEXT("insb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_INS, FCML_M8 ), 0 },
	{ FCML_TEXT("insw[tb,sf,ow]"), FCML_ASM_DIALECT_INSTRUCTION( F_INS, FCML_M16 ), 0 },
	{ FCML_TEXT("insl[tb,sf,od]"), FCML_ASM_DIALECT_INSTRUCTION( F_INS, FCML_M32 ), 0 },
	...
	{ FCML_TEXT("lods;lodsb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION( F_LODS, FCML_RM8 ), 0 },
	{ FCML_TEXT("lods;lodsw[tb,sf,ow];lodsl[tb,sf,od];lodsq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION( F_LODS, FCML_RMO ), 0 },
